<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_OTP.aspx.cs" Inherits="Bill_Sys_OTP" %>
                                                    ...
                                                    <table border="0"  cellpadding="3" cellspacing="0" style="width: 100%;" >
                                                        <tr>
                                                            ...
                                                            <td style="width: 50%; text-align: left;" colspan="2" >
                                                                ...
                                                                <tr class="userRow">
                                                                <td style="padding:3px" >   <asp:Label  CssClass="LabelCSS" runat="server" ID="Label1">OTP</asp:Label></td>
                                                                  <td>    <asp:TextBox ID="txtotp" runat="server" placeholder="OTP"></asp:TextBox></td>
                                                                </tr>
                                                               ...
                                                               <asp:Button ID="btnSubmit" runat="server" CssClass="loginButtonCSS" Text="Submit" onclick="btnSubmit_Click"/>
                                                                </td>
