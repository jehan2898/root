...
public partial class Bill_Sys_ProviderReports : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            extddlProvider.Flag_ID = ((Bill_Sys_BillingCompanyObject)Session["BILLING_COMPANY_OBJECT"]).SZ_COMPANY_ID;
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("Bill_Sys_ProviderReports.aspx");
        }
        #endregion
        //Method End
        using (Utils utility = new Utils())
