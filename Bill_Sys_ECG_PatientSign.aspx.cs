...
public partial class Bill_Sys_ECG_PatientSign : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("Bill_Sys_ECG_PatientSign.aspx");
        }
        #endregion
    }
    ...
    protected void btnSumbit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            _objcheckOut.SaveECGPatientSignPath(sz_EventID, DoctorImagePath);
    ...
    public string FillPDFValue(string EventID, string sz_CompanyID, string sz_CompanyName)
    {
        ...
        {
            Bill_Sys_NF3_Template objNF3Template = new Bill_Sys_NF3_Template();
            string xmlpath = ConfigurationManager.AppSettings["MST_ECG_XML_Path"].ToString();
            string pdfpath = ConfigurationManager.AppSettings["MST_ECG_PDF_Path"].ToString();
