...
using System.Text;
using System.IO;
public partial class Bill_Sys_followupReport : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("Bill_Sys_followupReport.aspx");
        }
        #endregion
        //Method End
        using (Utils utility = new Utils())
    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            ds = _bill_Sys_Visit_BO.getFollowUpVisitReport(objAL);
