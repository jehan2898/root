...
public partial class Refering_provider_Default2 : PageBase
{
    ...
    protected void ASPxCallback1_Callback(object sender, CallbackEventArgs e)
    {
        ...
        string sFile = ReferringProvider.utils.ReferringProviderUtils.GetExportPhysicalPath(sUserName, ReferringProvider.utils.ReferringProviderExportTypes.VISIT_LIST, out sFileName);
