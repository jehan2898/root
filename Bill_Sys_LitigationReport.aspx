<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"  CodeFile="Bill_Sys_LitigationReport.aspx.cs" Inherits="Bill_Sys_LitigationReport" %>
...
<table id="First" border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
  ...
  <%--                              <asp:ButtonColumn CommandName="Select" Text="Select" ItemStyle-CssClass="grid-item-left">
                                ...
                                <asp:BoundColumn DataField="INSURANCE_COMPANY" HeaderText="Insurance Name"></asp:BoundColumn>
                                <asp:BoundColumn DataField="BILL_AMOUNT" HeaderText="Bill Amount"  DataFormatString="{0:0.00}"></asp:BoundColumn>
                                <asp:BoundColumn DataField="PAID_AMOUNT" HeaderText="Paid Amount" DataFormatString="{0:0.00}"></asp:BoundColumn>
                                <asp:BoundColumn DataField="LITIGATION_AMOUNT" HeaderText="Litigation Amount" DataFormatString="{0:0.00}"></asp:BoundColumn>                               
