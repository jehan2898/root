<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_ProviderReports.aspx.cs" Inherits="Bill_Sys_ProviderReports" %>
...
- Provider Reports
                                            ...
                                            <tr valign="top">
                                                ...
                                                <extddl:ExtendedDropDownList ID="extddlProvider" width="200px" runat="server" Connection_Key="Connection_String" Procedure_Name="SP_MST_PROVIDER" Flag_Key_Value="PROVIDER_LIST" Selected_Text="--- Select ---" /></td> 
