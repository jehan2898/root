<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bill_Sys_Supplies.aspx.cs" Inherits="Bill_Sys_Supplies" Title="Untitled Page" %>
                                    ...
                                    <td style="width: 100%" class="TDPart">
                                        <asp:DataGrid ID="grdCaseStatusList" CssClass="GridTable" Width="100%" runat="server"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="SZ_SUPPLIES_NAME" HeaderText="Supplies Name"></asp:BoundColumn>
