...
public partial class Bill_Sys_AC_Accu_Initial_Doctor_sign : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("Bill_Sys_AC_Accu_Initial_Doctor_sign.aspx");
        }
        #endregion
    }
    ...
    //    string sz_CaseID = Session["AC_Initial_CaseID"].ToString();
    ...
    //    {
    //        Bill_Sys_NF3_Template objNF3Template = new Bill_Sys_NF3_Template();
    //        string xmlpath = ConfigurationManager.AppSettings["Accu_Initial_XML_Path"].ToString();
    //        string pdfpath = ConfigurationManager.AppSettings["Accu_Initial_PDF_Path"].ToString();
    ...
    //        String szDestinationDir = ((Bill_Sys_BillingCompanyObject)Session["BILLING_COMPANY_OBJECT"]).SZ_COMPANY_NAME + "/" + sz_CaseID + "/No Fault File/Medicals/ACCU_INITIAL/";
