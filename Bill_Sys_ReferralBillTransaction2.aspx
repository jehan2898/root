<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_ReferralBillTransaction2.aspx.cs" Inherits="Bill_Sys_ReferralBillTransaction" %>
                                                 ...
                                                 <%--   0--%>
                                                   ...
                                                   <%-- 4--%>
                                                    ...
                                                    <asp:BoundColumn DataField="SZ_PATIENT_TREATMENT_ID" HeaderText="I_EVENT_PROCID"
                                                      ...
                                                      <%-- 15--%>
                                                    <asp:BoundColumn DataField="SZ_STUDY_NUMBER" HeaderText="SZ_STUDY_NUMBER"
                                                        Visible="False">
                                                        <HeaderStyle HorizontalAlign="Right" />
                                                    </asp:BoundColumn>
                                                </Columns>
                                    ...
                                    <td style="width: 100%" class="TDPart">
                                        <asp:DataGrid ID="grdLatestBillTransaction" runat="server" OnSelectedIndexChanged="grdLatestBillTransaction_SelectedIndexChanged"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateColumn HeaderText="Generate bill">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkTemplateManager" runat="server" Text="Add Bills" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.SZ_CASE_ID")%>' CommandName="Generate bill" OnClientClick='<%#"return checkExistingBills(" +Eval("SZ_BILL_COUNT") + ",\"" + Eval("SZ_CASE_TYPE") + "\",\"" + Eval("SZ_BILL_NUMBER") + "\",\"" + Eval("GP")+"\", \"" + ((Bill_Sys_BillingCompanyObject)Session["BILLING_COMPANY_OBJECT"]).BT_REFERRING_FACILITY + "\");" %>'> <img src="Images/grid-doc-mng.gif" style="border:none;" /></asp:LinkButton>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateColumn>
