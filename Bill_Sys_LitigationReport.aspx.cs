...
using System.Text;
using System.IO;
public partial class Bill_Sys_LitigationReport : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!IsPostBack)
            {
                lblHeader.Text = "Reports - Litigation By Month";
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("Bill_Sys_LitigationReport.aspx");
        }
        #endregion
        //Method End
        using (Utils utility = new Utils())
    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            {
                grdAllReports.DataSource = _reportBO.GetAllReports("SP_REPORT_GET_LITIGATIONS", txtFromDate.Text, txtToDate.Text, txtCompanyID.Text, extddlLocation.Text);
                grdAllReports.DataBind();

                grdForReport.DataSource = _reportBO.GetAllReports("SP_REPORT_GET_LITIGATIONS", txtFromDate.Text, txtToDate.Text, txtCompanyID.Text, extddlLocation.Text);
                grdForReport.DataBind();
            }
            else
            {
                grdAllReports.DataSource = _reportBO.GetAllReports("SP_REPORT_GET_LITIGATIONS", txtFromDate.Text, txtToDate.Text, txtCompanyID.Text);
                grdAllReports.DataBind();

                grdForReport.DataSource = _reportBO.GetAllReports("SP_REPORT_GET_LITIGATIONS", txtFromDate.Text, txtToDate.Text, txtCompanyID.Text);
                grdForReport.DataBind();
            }
