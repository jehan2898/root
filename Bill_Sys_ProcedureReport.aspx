<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_ProcedureReport.aspx.cs" Inherits="Bill_Sys_ProcedureReport" %>
                                    ...
                                    <td style="width: 100%" class="TDPart">
                                        <asp:DataGrid ID="grdAllReports" runat="server" Width="100%" CssClass="GridTable"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="DT_DATE_OF_SERVICE" HeaderText="Date Of Service" DataFormatString="{0:MM/dd/yyyy}">
                                                </asp:BoundColumn>
