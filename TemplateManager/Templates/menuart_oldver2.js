...
//                                              //
// GENERATED: 12/24/2002 - 3:19:15 PM           //
// -------------------------------------------- //
//  Config: Local                               //
//   AddIn: FadeIn                              //
// JS Name: menuart                             //
//////////////////////////////////////////////////
	...
	nTCode[1]="cFrame.execURL('DataEntry.asp?qry=addclaim&screen=dentry&alphabet=All&ins=All&clientis=All', 'this');";
	nTCode[2]="cFrame.execURL('editMatter.asp?qry=em&screen=dentry&alphabet=All&ins=All&clientis=All', 'this');";
	nTCode[3]="cFrame.execURL('clientEntry.asp?qry=ac&screen=dentry', 'this');";
	nTCode[4]="cFrame.execURL('clientEdit.asp?qry=ec&screen=dentry&alphabet=All', 'this');";
	nTCode[5]="cFrame.execURL('insurerEntry.asp?qry=addins&screen=dentry', 'this');";
	nTCode[6]="cFrame.execURL('insurerEdit.asp?qry=editIns&screen=dentry&alphabet=All', 'this');";
	nTCode[7]="cFrame.execURL('addFirm.asp?qry=addFirm&screen=dentry', 'this');";
	nTCode[8]="cFrame.execURL('editFirm.asp?qry=ef&screen=dentry&alphabet=All', 'this');";
	nTCode[9]="cFrame.execURL('ClaimRepEntry.asp?qry=rep&screen=dentry', 'this');";
	nTCode[10]="cFrame.execURL('editClaimRep.asp?qry=editclaimrep&screen=dentry&alphabet=All', 'this');";
	nTCode[11]="cFrame.execURL('attorneyEntry.asp?qry=addattorney&screen=dentry', 'this');";
	nTCode[12]="cFrame.execURL('attorneyEdit.asp?qry=editAttorney&screen=dentry', 'this');";
	nTCode[13]="cFrame.execURL('reqletter.asp?qry=notes&page=rl', 'this');";
	nTCode[14]="cFrame.execURL('relatedCases.asp?qry=notes&page=rc', 'this');";
	nTCode[15]="cFrame.execURL('postings.asp?qry=notes&page=postings', 'this');";
	nTCode[16]="cFrame.execURL('settlements.asp?qry=notes', 'this');";
	nTCode[17]="cFrame.execURL('hearing.asp?qry=notes', 'this');";
	nTCode[18]="cFrame.execURL('addStatus.asp?qry=addstatus&screen=config', 'this');";
	nTCode[19]="cFrame.execURL('adddesk.asp?qry=adddesk&screen=config', 'this');";
	nTCode[20]="cFrame.execURL('addFeeType.asp?qry=addfeetype&screen=config', 'this');";
	nTCode[21]="cFrame.execURL('manageUsers.asp?qry=users&screen=config', 'this');";
	nTCode[22]="cFrame.execURL('manageDocs.asp?qry=docs&screen=config', 'this');";
	nTCode[23]="cFrame.execURL('deskAssign.asp?qry=desk&screen=config', 'this');";
	...
	function DoFadeIn() {
		...
		for(var i=1; i<=nOM; i++) {
			...
			if(m.op<100) {
				f = true;
				m.op += 30;
				m.filter = "alpha(opacity=" + m.op + ")";
			}
		}
		if(f) window.setTimeout("DoFadeIn()", 1);
	}

	if(IE)
		with(document) {
			open();
			write(xrep("<div id=\"grpDentry\" style=\"position: absolute; top:0px; left:0px;; width:130px; height:295px; filter: dropShadow(offX=5,offY=5,color=#B3B3B3);; z-index: 1000; visibility: hidden\"><div id=\"grpDentryfrmt\" style=\"position: absolute; top:0px; left:0px; width: 125px; height: 290px; background-color: #C0C0C0; \"><div nowrap style=\"position: absolute;; top: 1px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=0 OnMouseOver=\"cFrame.HoverSel(0,\'Add_MatterLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'DataEntry.asp?qry=addclaim&screen=dentry&alphabet=All&ins=All&clientis=All\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Add_MatterLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Add Matter</div></span></div><div nowrap style=\"position: absolute;; top: 25px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=1 OnMouseOver=\"cFrame.HoverSel(0,\'Edit_MatterLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'editMatter.asp?qry=em&screen=dentry&alphabet=All&ins=All&clientis=All\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Edit_MatterLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Edit Matter</div></span></div><div nowrap style=\"position: absolute;; top: 49px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=2 OnMouseOver=\"cFrame.HoverSel(0,\'Add_ClientLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'clientEntry.asp?qry=ac&screen=dentry\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Add_ClientLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Add Client</div></span></div><div nowrap style=\"position: absolute;; top: 73px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=3 OnMouseOver=\"cFrame.HoverSel(0,\'View_Edit_ClientLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'clientEdit.asp?qry=ec&screen=dentry&alphabet=All\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=View_Edit_ClientLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>View/Edit Client</div></span></div><div nowrap style=\"position: absolute;; top: 97px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=4 OnMouseOver=\"cFrame.HoverSel(0,\'Add_InsurerLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'insurerEntry.asp?qry=addins&screen=dentry\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Add_InsurerLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Add Insurer</div></span></div><div nowrap style=\"position: absolute;; top: 121px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=5 OnMouseOver=\"cFrame.HoverSel(0,\'Edit_InsurerLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'insurerEdit.asp?qry=editIns&screen=dentry&alphabet=A\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Edit_InsurerLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Edit Insurer</div></span></div><div nowrap style=\"position: absolute;; top: 145px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=6 OnMouseOver=\"cFrame.HoverSel(0,\'Add_FirmLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'addFirm.asp?qry=addFirm&screen=dentry\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Add_FirmLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Add Firm</div></span></div><div nowrap style=\"position: absolute;; top: 169px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=7 OnMouseOver=\"cFrame.HoverSel(0,\'Edit_FirmLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'editFirm.asp?qry=ef&screen=dentry&alphabet=A\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Edit_FirmLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Edit Firm</div></span></div><div nowrap style=\"position: absolute;; top: 193px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=8 OnMouseOver=\"cFrame.HoverSel(0,\'Add_Claim_RepLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'ClaimRepEntry.asp?qry=rep&screen=dentry\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Add_Claim_RepLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Add Claim Rep</div></span></div><div nowrap style=\"position: absolute;; top: 217px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=9 OnMouseOver=\"cFrame.HoverSel(0,\'Edit_Claim_RepLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'editClaimRep.asp?qry=editclaimrep&screen=dentry&alphabet=A\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Edit_Claim_RepLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Edit Claim Rep</div></span></div><div nowrap style=\"position: absolute;; top: 241px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=10 OnMouseOver=\"cFrame.HoverSel(0,\'Add_AttorneyLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'attorneyEntry.asp?qry=addattorney&screen=dentry\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Add_AttorneyLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Add Attorney</div></span></div><div nowrap style=\"position: absolute;; top: 265px; left: 1px; width: 123px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=11 OnMouseOver=\"cFrame.HoverSel(0,\'Edit_AttorneyLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'attorneyEdit.asp?qry=editAttorney&screen=dentry\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 107px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Edit_AttorneyLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:87px; left:20px;\" align=left>Edit Attorney</div></span></div></div></div><div id=\"grpWArea\" style=\"position: absolute; top:0px; left:0px;; width:127px; height:127px; filter: dropShadow(offX=5,offY=5,color=#B3B3B3);; z-index: 1000; visibility: hidden\"><div id=\"grpWAreafrmt\" style=\"position: absolute; top:0px; left:0px; width: 122px; height: 122px; background-color: #C0C0C0; \"><div nowrap style=\"position: absolute;; top: 1px; left: 1px; width: 120px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=12 OnMouseOver=\"cFrame.HoverSel(0,\'Request_LetterLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'reqletter.asp?qry=notes&page=rl\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 104px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Request_LetterLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:84px; left:20px;\" align=left>Request Letter</div></span></div><div nowrap style=\"position: absolute;; top: 25px; left: 1px; width: 120px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=13 OnMouseOver=\"cFrame.HoverSel(0,\'Related_CasesLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'relatedCases.asp?qry=notes&page=rc\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 104px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Related_CasesLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:84px; left:20px;\" align=left>Related Cases</div></span></div><div nowrap style=\"position: absolute;; top: 49px; left: 1px; width: 120px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=14 OnMouseOver=\"cFrame.HoverSel(0,\'PostingsLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'postings.asp?qry=notes&page=postings\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 104px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=PostingsLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:84px; left:20px;\" align=left>Postings</div></span></div><div nowrap style=\"position: absolute;; top: 73px; left: 1px; width: 120px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=15 OnMouseOver=\"cFrame.HoverSel(0,\'SettlementsLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'settlements.asp?qry=notes\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 104px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=SettlementsLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:84px; left:20px;\" align=left>Settlements</div></span></div><div nowrap style=\"position: absolute;; top: 97px; left: 1px; width: 120px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=16 OnMouseOver=\"cFrame.HoverSel(0,\'HearingsLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'hearing.asp?qry=notes\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 104px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=HearingsLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:84px; left:20px;\" align=left>Hearings</div></span></div></div></div><div id=\"grpConfig\" style=\"position: absolute; top:0px; left:0px;; width:125px; height:151px; filter: dropShadow(offX=5,offY=5,color=#B3B3B3);; z-index: 1000; visibility: hidden\"><div id=\"grpConfigfrmt\" style=\"position: absolute; top:0px; left:0px; width: 120px; height: 146px; background-color: #C0C0C0; \"><div nowrap style=\"position: absolute;; top: 1px; left: 1px; width: 118px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=17 OnMouseOver=\"cFrame.HoverSel(0,\'Add_StatusLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'addStatus.asp?qry=addstatus&screen=config\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 102px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Add_StatusLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:82px; left:20px;\" align=left>Add Status</div></span></div><div nowrap style=\"position: absolute;; top: 25px; left: 1px; width: 118px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=18 OnMouseOver=\"cFrame.HoverSel(0,\'Add_DeskLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'adddesk.asp?qry=adddesk&screen=config\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 102px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Add_DeskLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:82px; left:20px;\" align=left>Add Desk</div></span></div><div nowrap style=\"position: absolute;; top: 49px; left: 1px; width: 118px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=19 OnMouseOver=\"cFrame.HoverSel(0,\'Add_FeetypeLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'addFeeType.asp?qry=addfeetype&screen=config\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 102px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Add_FeetypeLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:82px; left:20px;\" align=left>Add Feetype</div></span></div><div nowrap style=\"position: absolute;; top: 73px; left: 1px; width: 118px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=20 OnMouseOver=\"cFrame.HoverSel(0,\'Manage_UsersLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'manageUsers.asp?qry=users&screen=config\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 102px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Manage_UsersLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:82px; left:20px;\" align=left>Manage Users</div></span></div><div nowrap style=\"position: absolute;; top: 97px; left: 1px; width: 118px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=21 OnMouseOver=\"cFrame.HoverSel(0,\'Manage_DocsLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'manageDocs.asp?qry=docs&screen=config\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 102px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Manage_DocsLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:82px; left:20px;\" align=left>Manage Docs</div></span></div><div nowrap style=\"position: absolute;; top: 121px; left: 1px; width: 118px; height: 24px; font-family: Arial; font-size: 12px; font-weight: bold; font-style: normal; text-decoration: none; color: #999999; background-image: url(%%REL%%oxpback.jpg); background-color: #FFFFFF; cursor: help;\" id=22 OnMouseOver=\"cFrame.HoverSel(0,\'Assign_DeskLImg\',\'\',this);status=\'\';\" OnClick=\"cFrame.execURL(\'deskAssign.asp?qry=desk&screen=config\', \'this\');\"><span style=\"position:absolute; top: 4px; left: 8px; width: 102px; height: 16px;\"><span style=\"position:absolute; top:0px; left:0px;\"><img name=Assign_DeskLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></span><div style=\"position:absolute; top:0px; width:82px; left:20px;\" align=left>Assign Desk</div></span></div></div></div>", '%' + '%REL%%', rimPath));
			close();
		}
	if(NS)
		with(document) {
			open();
			write(xrep(FixPointSize("<layer name=grpDentry top=0 left=0 width=125 height=290 z-index=1000 bgColor=#E0E0E0 visibility=hidden><layer bgColor=#C0C0C0 left=0 top=0 width=125 height=290 z-index=1001><layer name=MC1EH1 left=1 top=1 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC1N left=1 top=1 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_MatterLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Matter</div></layer></layer></font></b></ilayer></layer><layer name=MC1O left=1 top=1 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_MatterLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Matter</div></layer></layer></font></b></ilayer></layer><layer name=MC2EH2 left=1 top=25 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC2N left=1 top=25 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Edit_MatterLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Edit Matter</div></layer></layer></font></b></ilayer></layer><layer name=MC2O left=1 top=25 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Edit_MatterLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Edit Matter</div></layer></layer></font></b></ilayer></layer><layer name=MC3EH3 left=1 top=49 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC3N left=1 top=49 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_ClientLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Client</div></layer></layer></font></b></ilayer></layer><layer name=MC3O left=1 top=49 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_ClientLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Client</div></layer></layer></font></b></ilayer></layer><layer name=MC4EH4 left=1 top=73 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC4N left=1 top=73 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=View_Edit_ClientLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>View/Edit Client</div></layer></layer></font></b></ilayer></layer><layer name=MC4O left=1 top=73 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=View_Edit_ClientLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>View/Edit Client</div></layer></layer></font></b></ilayer></layer><layer name=MC5EH5 left=1 top=97 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC5N left=1 top=97 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_InsurerLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Insurer</div></layer></layer></font></b></ilayer></layer><layer name=MC5O left=1 top=97 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_InsurerLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Insurer</div></layer></layer></font></b></ilayer></layer><layer name=MC6EH6 left=1 top=121 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC6N left=1 top=121 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Edit_InsurerLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Edit Insurer</div></layer></layer></font></b></ilayer></layer><layer name=MC6O left=1 top=121 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Edit_InsurerLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Edit Insurer</div></layer></layer></font></b></ilayer></layer><layer name=MC7EH7 left=1 top=145 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC7N left=1 top=145 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_FirmLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Firm</div></layer></layer></font></b></ilayer></layer><layer name=MC7O left=1 top=145 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_FirmLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Firm</div></layer></layer></font></b></ilayer></layer><layer name=MC8EH8 left=1 top=169 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC8N left=1 top=169 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Edit_FirmLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Edit Firm</div></layer></layer></font></b></ilayer></layer><layer name=MC8O left=1 top=169 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Edit_FirmLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Edit Firm</div></layer></layer></font></b></ilayer></layer><layer name=MC9EH9 left=1 top=193 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC9N left=1 top=193 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_Claim_RepLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Claim Rep</div></layer></layer></font></b></ilayer></layer><layer name=MC9O left=1 top=193 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_Claim_RepLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Claim Rep</div></layer></layer></font></b></ilayer></layer><layer name=MC10EH10 left=1 top=217 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC10N left=1 top=217 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Edit_Claim_RepLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Edit Claim Rep</div></layer></layer></font></b></ilayer></layer><layer name=MC10O left=1 top=217 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Edit_Claim_RepLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Edit Claim Rep</div></layer></layer></font></b></ilayer></layer><layer name=MC11EH11 left=1 top=241 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC11N left=1 top=241 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_AttorneyLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Attorney</div></layer></layer></font></b></ilayer></layer><layer name=MC11O left=1 top=241 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Add_AttorneyLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Add Attorney</div></layer></layer></font></b></ilayer></layer><layer name=MC12EH12 left=1 top=265 width=123 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC12N left=1 top=265 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Edit_AttorneyLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Edit Attorney</div></layer></layer></font></b></ilayer></layer><layer name=MC12O left=1 top=265 width=123 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=107 height=16><layer top=0 left=0><img name=Edit_AttorneyLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=87 left=20><div align=left>Edit Attorney</div></layer></layer></font></b></ilayer></layer></layer></layer><layer name=grpWArea top=0 left=0 width=122 height=122 z-index=1000 bgColor=#E0E0E0 visibility=hidden><layer bgColor=#C0C0C0 left=0 top=0 width=122 height=122 z-index=1001><layer name=MC13EH13 left=1 top=1 width=120 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC13N left=1 top=1 width=120 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=104 height=16><layer top=0 left=0><img name=Request_LetterLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=84 left=20><div align=left>Request Letter</div></layer></layer></font></b></ilayer></layer><layer name=MC13O left=1 top=1 width=120 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=104 height=16><layer top=0 left=0><img name=Request_LetterLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=84 left=20><div align=left>Request Letter</div></layer></layer></font></b></ilayer></layer><layer name=MC14EH14 left=1 top=25 width=120 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC14N left=1 top=25 width=120 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=104 height=16><layer top=0 left=0><img name=Related_CasesLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=84 left=20><div align=left>Related Cases</div></layer></layer></font></b></ilayer></layer><layer name=MC14O left=1 top=25 width=120 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=104 height=16><layer top=0 left=0><img name=Related_CasesLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=84 left=20><div align=left>Related Cases</div></layer></layer></font></b></ilayer></layer><layer name=MC15EH15 left=1 top=49 width=120 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC15N left=1 top=49 width=120 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=104 height=16><layer top=0 left=0><img name=PostingsLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=84 left=20><div align=left>Postings</div></layer></layer></font></b></ilayer></layer><layer name=MC15O left=1 top=49 width=120 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=104 height=16><layer top=0 left=0><img name=PostingsLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=84 left=20><div align=left>Postings</div></layer></layer></font></b></ilayer></layer><layer name=MC16EH16 left=1 top=73 width=120 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC16N left=1 top=73 width=120 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=104 height=16><layer top=0 left=0><img name=SettlementsLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=84 left=20><div align=left>Settlements</div></layer></layer></font></b></ilayer></layer><layer name=MC16O left=1 top=73 width=120 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=104 height=16><layer top=0 left=0><img name=SettlementsLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=84 left=20><div align=left>Settlements</div></layer></layer></font></b></ilayer></layer><layer name=MC17EH17 left=1 top=97 width=120 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC17N left=1 top=97 width=120 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=104 height=16><layer top=0 left=0><img name=HearingsLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=84 left=20><div align=left>Hearings</div></layer></layer></font></b></ilayer></layer><layer name=MC17O left=1 top=97 width=120 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=104 height=16><layer top=0 left=0><img name=HearingsLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=84 left=20><div align=left>Hearings</div></layer></layer></font></b></ilayer></layer></layer></layer><layer name=grpConfig top=0 left=0 width=120 height=146 z-index=1000 bgColor=#E0E0E0 visibility=hidden><layer bgColor=#C0C0C0 left=0 top=0 width=120 height=146 z-index=1001><layer name=MC18EH18 left=1 top=1 width=118 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC18N left=1 top=1 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Add_StatusLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Add Status</div></layer></layer></font></b></ilayer></layer><layer name=MC18O left=1 top=1 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Add_StatusLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Add Status</div></layer></layer></font></b></ilayer></layer><layer name=MC19EH19 left=1 top=25 width=118 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC19N left=1 top=25 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Add_DeskLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Add Desk</div></layer></layer></font></b></ilayer></layer><layer name=MC19O left=1 top=25 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Add_DeskLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Add Desk</div></layer></layer></font></b></ilayer></layer><layer name=MC20EH20 left=1 top=49 width=118 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC20N left=1 top=49 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Add_FeetypeLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Add Feetype</div></layer></layer></font></b></ilayer></layer><layer name=MC20O left=1 top=49 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Add_FeetypeLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Add Feetype</div></layer></layer></font></b></ilayer></layer><layer name=MC21EH21 left=1 top=73 width=118 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC21N left=1 top=73 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Manage_UsersLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Manage Users</div></layer></layer></font></b></ilayer></layer><layer name=MC21O left=1 top=73 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Manage_UsersLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Manage Users</div></layer></layer></font></b></ilayer></layer><layer name=MC22EH22 left=1 top=97 width=118 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC22N left=1 top=97 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Manage_DocsLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Manage Docs</div></layer></layer></font></b></ilayer></layer><layer name=MC22O left=1 top=97 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Manage_DocsLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Manage Docs</div></layer></layer></font></b></ilayer></layer><layer name=MC23EH23 left=1 top=121 width=118 height=24 z-index=1003 OnMouseOver=\"cFrame.NSHoverSel(0,this);status=\'\';\"></layer><layer name=MC23N left=1 top=121 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#999999><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Assign_DeskLImg src=\"%%REL%%folder_closed.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Assign Desk</div></layer></layer></font></b></ilayer></layer><layer name=MC23O left=1 top=121 width=118 height=24 z-index=1002 background=%%REL%%oxpback.jpg bgColor=#FFFFFF visibility=hide><ilayer left=8 top=4><b><font face=Arial point-size=9 color=#00287B><layer left=0 top=0 width=102 height=16><layer top=0 left=0><img name=Assign_DeskLImg src=\"%%REL%%folder_open.gif\" width=16 height=16></layer><layer top=0 width=82 left=20><div align=left>Assign Desk</div></layer></layer></font></b></ilayer></layer></layer></layer>"), '%' + '%REL%%', rimPath));
			close();
		}
SetUpEvents();
