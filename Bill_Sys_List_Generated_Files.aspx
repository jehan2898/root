<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_List_Generated_Files.aspx.cs" Inherits="Bill_Sys_List_Generated_Files" %>
    ...
    <form id="frmBillingInformation" runat="server">
        <div align="center">
            <table class="lcss_maintable" cellpadding="0px" cellspacing="0px">
                ...
                <tr>
                    <td colspan="6" style="height: 650px">
                        <table width="100%" id="content_table" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                
                                  <td width="69%" scope="col" style="height:100%;">
						<div class="blocktitle" style="height:100%;">
                        	List Of Generated Files
                        <div class="div_blockcontent" id="divGeneratedFiles" runat="server"  style="height:100%;">
