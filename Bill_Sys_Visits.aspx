<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_Visits.aspx.cs" Inherits="Bill_Sys_Visits" %>
						...
						<tr>
						  <td scope="col" width="98%">
							<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
						  		<div class="blocktitle">Visit types
										...
										<table width="100%" style="line-height:normal;">
											<tr>
												...
												<ajaxToolkit:TabContainer ID="tabcontainerPatientTreatment" runat="Server" ActiveTabIndex="0">
													...
													<HeaderTemplate>
														<div style="width: 80px;height:200px;" class="lbl">Visit</div>
													</HeaderTemplate>
													<ContentTemplate>
														<div>
														<table width="100%" border="0" cellspacing="0" cellpadding="0">
															...
															<tr>
															  <td colspan="2" align="left">
																<asp:DataGrid ID="grdVisits" runat="Server" AutoGenerateColumns="False">
																	<Columns>
																		<asp:BoundColumn DataField="SZ_TREATMENT_NAME" HeaderText="Visit" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
												...
												<ajaxToolkit:TabPanel runat="server" ID="tabpnlAddVisitPrice" TabIndex="1" HeaderText="Anywya">
													<HeaderTemplate>
														<div style="width: 80px;" class="lbl">Visit prices</div>
													</HeaderTemplate>
													<ContentTemplate>
														<div>
														<table width="100%" border="0" cellspacing="0" cellpadding="0">
															...
															<tr>
																...
																<td width="95%">
																	<span class="tablecellControl" style="padding:1px;">
																		<asp:ListBox ID="lbProcedures" runat="server" CssClass="text-box" Width="98%" Height="120px"></asp:ListBox>
																	</span>
																</td>
															</tr>
															...
															<tr>
															  <td colspan="2" align="center">
																<span class="tablecellControl" style="width:100%">
																	<asp:Button ID="btnSaveVisitPrices" runat="server" Text="Add" Width="80px" cssclass="btn-gray"/>
																	<asp:Button ID="btnCloseFromVPrices" runat="server" Text="Close" Width="80px" cssclass="btn-gray"/>
																</span>											  
															  </td>
														  </tr>
															<tr>
															  <td colspan="2" align="left">
																<asp:DataGrid ID="grdVisitPrices" runat="Server" AutoGenerateColumns="False" visible="false">
																	<Columns>
																		<asp:BoundColumn DataField="SZ_TREATMENT_NAME" HeaderText="Visit" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
																		<asp:BoundColumn DataField="SZ_TREATMENT_DESCRIPTION" HeaderText="Description" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
																		<asp:BoundColumn DataField="SZ_PROCEDURE" HeaderText="Code" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
