<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_InsuranceCompany.aspx.cs" Inherits="Bill_Sys_InsuranceCompany" %>
                                                                                        ...
                                                                                        <div style="overflow: scroll; height: 150px; width: 97%">
                                                                                            <asp:DataGrid ID="grdInsuranceAddress" CssClass="GridTable" runat="server" AutoGenerateColumns="False"
                                                                                                ...
                                                                                                <Columns>
                                                                                                    ...
                                                                                                    <asp:BoundColumn DataField="SZ_INS_ADDRESS_ID" HeaderText="Address ID" Visible="False">
                                                                                                    </asp:BoundColumn>
                                                                                                    <asp:BoundColumn HeaderText="Address" DataField="SZ_INSURANCE_ADDRESS"></asp:BoundColumn>
                                                                                                    <asp:BoundColumn HeaderText="Street" DataField="SZ_INSURANCE_STREET"></asp:BoundColumn>
                                                                                                    <asp:BoundColumn HeaderText="City" DataField="SZ_INSURANCE_CITY"></asp:BoundColumn>
                                                                                                    <asp:BoundColumn HeaderText="StateName" DataField="SZ_INSURANCE_STATE"></asp:BoundColumn>
                                                                                                    <asp:BoundColumn HeaderText="Zip" DataField="SZ_INSURANCE_ZIP"></asp:BoundColumn>
                                                                                                    <asp:BoundColumn HeaderText="Unique ID" DataField="I_UNIQUE_ID" Visible="false">
                                                                                                    </asp:BoundColumn>
                                                                                                    <asp:BoundColumn HeaderText="StateID" DataField="SZ_INSURANCE_STATE_ID" Visible="false">
                                                                                                    </asp:BoundColumn>
                                                                                                    <asp:TemplateColumn>
                                                                                                        <ItemTemplate>
                                ...
                                <tr>
                                    <td style="width: 100%" class="TDPart">
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:DataGrid ID="grdInsuranceCompanyList" runat="server" Width="100%" CssClass="GridTable"
                                                        AutoGenerateColumns="false" AllowPaging="true" PageSize="100" PagerStyle-Mode="NumericPages"
                                                        OnDeleteCommand="grdInsuranceCompanyList_DeleteCommand" OnPageIndexChanged="grdInsuranceCompanyList_PageIndexChanged"
                                                        OnSelectedIndexChanged="grdInsuranceCompanyList_SelectedIndexChanged" OnItemCommand="grdInsuranceCompanyList_ItemCommand">
                                                        <ItemStyle CssClass="GridRow" />
                                                        <Columns>
                                                            <asp:ButtonColumn CommandName="Select" Text="Select"></asp:ButtonColumn>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="Name">
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="lnlName" runat="server" CommandName="NameSearch" CommandArgument="SZ_INSURANCE_NAME"
                                                            ...
                                                            <asp:TemplateColumn HeaderText="Insurance Code">
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="lnlInsCompanycode" runat="server" CommandName="InsuranceCodeSearch"
                                                                        CommandArgument="SZ_INSURANCE_COMPANY_CODE" Font-Bold="true" Font-Size="12px">Insurance Code</asp:LinkButton>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <%# DataBinder.Eval(Container, "DataItem.SZ_INSURANCE_COMPANY_CODE")%>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:TemplateColumn HeaderText="Address">
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="lnlInsCompanyAddress" runat="server" CommandName="AddressSearch"
                                                                        CommandArgument="SZ_INSURANCE_ADDRESS" Font-Bold="true" Font-Size="12px">Address</asp:LinkButton>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                ...
                                                <asp:BoundColumn DataField="SZ_INSURANCE_ADDRESS" HeaderText="Address"></asp:BoundColumn>--%>
                                                            <asp:BoundColumn DataField="SZ_INSURANCE_STREET" HeaderText="Street" Visible="false">
                                                            </asp:BoundColumn>
                                                            <asp:TemplateColumn HeaderText="City">
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="lnlInsCompanyCity" runat="server" CommandName="CitySearch" CommandArgument="SZ_INSURANCE_CITY"
                                                  ...
                                                  <asp:BoundColumn DataField="SZ_INSURANCE_STATE" HeaderText="State" ></asp:BoundColumn>--%>
                                                            <asp:TemplateColumn HeaderText="State">
                                                                <HeaderTemplate>
                                                                    <asp:LinkButton ID="lnlInsCompanyState" runat="server" CommandName="StateSearch"
                                                                        CommandArgument="SZ_INSURANCE_STATE" Font-Bold="true" Font-Size="12px">State</asp:LinkButton>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <%# DataBinder.Eval(Container, "DataItem.SZ_INSURANCE_STATE")%>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:BoundColumn DataField="SZ_INSURANCE_ZIP" HeaderText="Zip" Visible="false"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="SZ_INSURANCE_PHONE" HeaderText="Phone"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="SZ_INSURANCE_EMAIL" HeaderText="Email"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="SZ_INSURANCE_NAME" HeaderText="Name" Visible="false">
                                                            </asp:BoundColumn>
                                                            ...
                                                            <asp:BoundColumn DataField="SZ_INSURANCE_COMPANY_CODE" HeaderText="Insurance Code"
