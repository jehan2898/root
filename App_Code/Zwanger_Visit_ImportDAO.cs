...
/// <summary>
/// Summary description for Zwanger_Visit_ImportDAO
/// </summary>
public class Zwanger_Visit_ImportDAO
{
    public Zwanger_Visit_ImportDAO()
    {
        //
    ...
    public string InsuranceState
    {
        ...
        set { _InsuranceState = value; }
    }

    private string _InsuranceZip;
    public string InsuranceZip
    {
        get { return _InsuranceZip; }
        set { _InsuranceZip = value; }
    }
    ...
    public string InsurancePolicyNumber
    {
        ...
        set { _InsurancePolicyNumber = value; }
    }

    private string _ReferringDoctor;
    public string ReferringDoctor
    {
        get { return _ReferringDoctor; }
        set { _ReferringDoctor = value; }
    }

    private string _ReadingDoctor;
    public string ReadingDoctor
    {
        get { return _ReadingDoctor; }
        set { _ReadingDoctor = value; }
    }
