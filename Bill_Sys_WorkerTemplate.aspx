<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_WorkerTemplate.aspx.cs"
    Inherits="Bill_Sys_WorkerTemplate" %>
                                                        ...
                                                        <asp:Panel ID="pnlEmployerInfo" runat="server" >
                                                                ...
                                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="tablecellControl">
                                                                            <cc1:ExtendedDropDownList id="extddlEmployerState" runat="server" Width="90%" Connection_Key="Connection_String" Procedure_Name="SP_MST_STATE" Flag_Key_Value="GET_STATE_LIST" Selected_Text="--- Select ---">
