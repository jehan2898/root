...
function initMessageBox(bNeebBack) {
    ...
    objString += "<div style='text-align:left; width:580px; background-color:#FFFFFF;display:block'>";
...
//    objString += "Message:<br />"
    objString += "<div id='DWTemessage' style='width:580px;height:80px; visibility:hidden; overflow:scroll; background-color:#ffffff; border:1px #303030; border-style:solid; text-align:left; position:relative' >";
    objString += "</div></div>";
...
function initCustomScan() {
    ...
    ObjString += "<label id ='lblShowUI' for = 'ShowUI' style='display: none;'><input type='checkbox' id='ShowUI' style='display: none;'/>Show UI&nbsp;</label>";
    ObjString += "<label for = 'ADF' style='display: none;'><input type='checkbox' id='ADF' style='display: none;'/>AutoFeeder&nbsp;</label>";
    ...
    ObjString += "<label for='BW' style='display: none;'><input type='radio' id='BW' name='PixelType' style='display: none;'/>B&amp;W </label>";
    ObjString += "<label for='Gray' style='display: none;'><input type='radio' id='Gray' name='PixelType' style='display: none;'/>Gray</label>";
    ObjString += "<label for='RGB' style='display: none;'><input type='radio' id='RGB' name='PixelType' style='display: none;'/>Color</label></li>";
    ObjString += "<li style='padding-left:15px;'>";
    ObjString += "<label for='Resolution' style='display: none;'>Resolution:<select size='1' id='Resolution'><option value = ''></option></select></label></li>";
    ObjString += "</ul>";
...
function setDefaultValue() {
    ...
    var sname= document.getElementById("uploadFilename");
    var _strDefaultSaveImageName = sname.value;
    var _txtFileNameforSave = document.getElementById("txt_fileNameforSave");
    _txtFileNameforSave.value = _strDefaultSaveImageName;

    var _txtFileName = document.getElementById("txtEnterFileName");
