<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_CM_CurrentComplainNEW.aspx.cs" Inherits="Bill_Sys_CM_CurrentComplainNEW"
    Title="Untitled Page" %>
            ...
            <td width="100%" class="TDPart">
                <table width="100%">
                    <tr>
                        ...
                        <td width="40%">
                            <asp:TextBox ID="TXT_PATIENT_NAME" runat="server" Width="90%" Enabled="true" BackColor="Transparent" BorderColor="Transparent" BorderStyle="None" ForeColor="Black" ReadOnly="true"></asp:TextBox>
                        </td>
                        <td width="10%" class="lbl">
                            Date of accident
                        </td>
                        <td width="25%">
                            <asp:TextBox ID="TXT_DOA" runat="server" Width="70%" Enabled="true" BackColor="Transparent" BorderColor="Transparent" BorderStyle="None" ForeColor="Black" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="20%">
                            <asp:TextBox ID="TXT_DOE" runat="server" Enabled="true" BackColor="Transparent" BorderColor="Transparent" BorderStyle="None" ForeColor="Black" ReadOnly="true"></asp:TextBox>
                            
                        </td>
                        <td class="lbl" width="10%">
                            Date of birth</td>
                        <td width="25%">
                            <asp:TextBox ID="TXT_DOB" runat="server" Width="70%" Enabled="true" BackColor="Transparent" BorderColor="Transparent" BorderStyle="None" ForeColor="Black" ReadOnly="true"></asp:TextBox>
   ...
   <%-- <table width="100%">
        <tbody>
            <tr>
                ...
                <td valign="middle" align="left">
                    <asp:TextBox ID="TXT_PATIENT_NAME" runat="server" Width="472px" ReadOnly="true" ForeColor="Black"
                        BorderStyle="None" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox></td>
                <td valign="middle" align="left">
                    <asp:Label ID="lbl_DOA" runat="server" Text="Date Of Accident" Font-Bold="False"></asp:Label>
                </td>
                <td valign="middle" align="left">
                    <asp:TextBox ID="TXT_DOA" runat="server" Width="85px" ReadOnly="true" ForeColor="Black"
                        BorderStyle="None" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td valign="middle" align="left">
                    <asp:Label ID="LBL_DOE" runat="server" Text="Date Of Examination" Font-Bold="False"></asp:Label>
                </td>
                <td valign="middle" align="left">
                    <asp:TextBox ID="TXT_DOE" runat="server" Width="85px" ReadOnly="true" ForeColor="Black"
                        BorderStyle="None" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox></td>
                <td valign="middle" align="left">
                    <asp:Label ID="LBL_DOB" runat="server" Text="Date Of Birth" Font-Bold="False"></asp:Label>
                </td>
                <td valign="middle" align="left">
                    <asp:TextBox ID="TXT_DOB" runat="server" Width="85px" ReadOnly="true" ForeColor="Black"
                        BorderStyle="None" BorderColor="Transparent" BackColor="Transparent"></asp:TextBox></td>
            </tr>
        </tbody>
    </table>--%>
            ...
            <td width="100%" class="TDPart">
                ...
                <table width="100%" class="lbl">
                    <tr>
                        ...
                        <td class="lbl" style="width: 18%">
                            <asp:RadioButtonList ID="rdlDazedDizzyNervous" runat="server" RepeatDirection="Horizontal"
                                Width="165px">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="25%">
                            <asp:RadioButtonList ID="rdlPatientAfterAccident" runat="server" RepeatDirection="Horizontal"
                                Width="380px" RepeatLayout="Flow">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td class="lbl">
                            <asp:RadioButtonList ID="RDO_NUMBNESS_TINGLING_LOWER_UPPER" runat="server" RepeatDirection="Horizontal"
                                Width="188px">
                                <asp:ListItem Value="0">upper /</asp:ListItem>
                                <asp:ListItem Value="1">lower extremities.</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td class="lbl" style="width: 219px">
