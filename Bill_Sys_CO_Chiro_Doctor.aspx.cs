...
public partial class Bill_Sys_Image_Save : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Session["CO_CHIRO_EVENT_ID"] = "12007"; for testing use
        _objcheckOut = new Bill_Sys_CheckoutBO();
        DigitalSign signobj = new DigitalSign();        
        objNF3Template = new Bill_Sys_NF3_Template();
        DataSet dsObj = _objcheckOut.PatientName(Session["CO_CHIRO_EVENT_ID"].ToString());
        ...
        sz_EventID = Session["CO_CHIRO_EVENT_ID"].ToString();       
        int flag = 0;
        try
        {
