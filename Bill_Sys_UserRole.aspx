<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_UserRole.aspx.cs" Inherits="Bill_Sys_UserRole" %>
                    ...
                    <tr>
                        ...
                        <td class="Center" valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                                        ...
                                        <table border="0" cellpadding="3" cellspacing="0" class="ContentTable" style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 35%" class="ContentLabel">
                                                    <asp:TextBox ID="txtUserRole" runat="server" CssClass="textboxCSS" MaxLength="50"></asp:TextBox></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                </td>
                                                <td style="width: 35%">
                                                </td>
                                ...
                                <tr>
                                    <td style="width: 100%" class="TDPart">
                                        <asp:DataGrid ID="grdUserRoleList" CssClass="GridTable" Width="100%" runat="server"
                                            OnDeleteCommand="grdUserRoleList_DeleteCommand" OnPageIndexChanged="grdUserRoleList_PageIndexChanged"
                                            OnSelectedIndexChanged="grdUserRoleList_SelectedIndexChanged" AutoGenerateColumns="false">
                                            <ItemStyle CssClass="GridRow" />
                                            <Columns>
                                                <asp:ButtonColumn CommandName="Select" Text="Select" ItemStyle-CssClass="grid-item-left">
                                                </asp:ButtonColumn>
                                                <asp:BoundColumn DataField="SZ_USER_ROLE_ID" HeaderText="User Role ID" Visible="false">
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="SZ_USER_ROLE" HeaderText="User Role"></asp:BoundColumn>
