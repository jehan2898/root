<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_AC_Acupuncture_Followup.aspx.cs" Inherits="Bill_Sys_AC_Acupuncture_Followup"
                                ...
                                <table width="100%" border="0">
                                    <tr>
                                        <td align="center" valign="middle">
                                            <asp:Label ID="lblPatientLastName" runat="server" CssClass="ContentLabel" Font-Bold="False" Text="LAST NAME"></asp:Label>
                                        </td>
                                        ...
                                        <td align="center" valign="middle">
                                            <asp:Label ID="lblPatientFirstName" runat="server" CssClass="ContentLabel" Font-Bold="False" Text="FIRST NAME"></asp:Label>
                                        </td>
                                        <td align="left" valign="middle">
                                        ...
                                        <td align="center" valign="middle">
                                            <asp:Label ID="lbl_doa" runat="server" CssClass="ContentLabel" Font-Bold="False" Text="DOA"></asp:Label>
                                        </td>
                                        <td align="left" valign="middle">
                                                       ...
                                                       <asp:BoundField 
                                                        ...
                                                        <asp:BoundField 
                                                            ...
                                                            DataField="SZ_TYPE_CODE_ID"  />
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtDocNote" runat="server" TextMode="MultiLine"  Width="350px" 
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:Button ID="btnSave" runat="server" Text="SAVE" CssClass="Buttons"  OnClick="btnSave_OnClick"/>
                                        </td>   
                                    </tr>
                                </table>
                            </td>
