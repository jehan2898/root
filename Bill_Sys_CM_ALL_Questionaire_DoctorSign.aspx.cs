...
public partial class Bill_Sys_CM_ALL_Questionaire_DoctorSign : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("Bill_Sys_CM_ALL_Questionaire_DoctorSign.aspx");
        }
        #endregion
    }
    ...
    protected void btnSumbit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (WebSignature2.ExportToStreamOnly())
            {
                System.IO.MemoryStream imgstream2 = (System.IO.MemoryStream)(WebSignature2.ImageMemoryStream);
                {
                    if (imgstream2 != null)
                    {
                        ...
                        DoctorImagePath = szDefaultPath + "_QuestionaireDoctorSign.jpg";
            ...
            _objcheckOut.SaveCMALLQuestionaireSignPath(sz_EventID, DoctorImagePath);
    ...
    public string FillPDFValue(string EventID, string sz_CompanyID, string sz_CompanyName)
    {
        ...
        string sz_CaseID = Session["CM_ALL_CaseID"].ToString();
