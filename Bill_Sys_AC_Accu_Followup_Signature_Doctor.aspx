<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_AC_Accu_Followup_Signature_Doctor.aspx.cs" Inherits="Bill_Sys_AC_Accu_Followup_Signature_Doctor" %>
 ...
 if(document.FORM1.SigPlusDoctor.NumberOfTabletPoints > 0)
{
   ...
   {
        alert("Please Doctor Sign Before Continuing...");
        return false;
   } 
}
...
<body>
    <FORM id="FORM1" method="post" name="FORM1" action="Bill_Sys_Ac_Accu_Follwup_Doctor.aspx?Sign=Doctor">
