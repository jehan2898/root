...
public partial class Bill_Sys_Co_DoctorSign_ChiroCaDatail : PageBase
{
    ...
    protected void btnSumbit_Click(object sender, EventArgs e)
    {
     ...
     //   string sz_EventID = Session["CH_EventID"].ToString();
            ...
            if (WebSignature2.ExportToStreamOnly())
            {
                System.IO.MemoryStream imgstream2 = (System.IO.MemoryStream)(WebSignature2.ImageMemoryStream);
                {
                    if (imgstream2 != null)
                    {
                        ...
                        string sz_case_id = ((Bill_Sys_CaseObject)Session["CASE_OBJECT"]) + Session["ChkCaseID"].ToString();
