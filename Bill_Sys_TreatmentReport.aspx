                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="width: 40%; height: 0px;" align="center">
                                                                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;" onkeypress="javascript:return WebForm_FireDefaultButton(event, 'ctl00_ContentPlaceHolder1_btnSearch')">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center" style="width: 117px; height: 37px;" valign="top">
                                                                                                    <extddl:ExtendedDropDownList ID="extddlCaseStatus" runat="server" Width="99%" Selected_Text="OPEN"
                                                                                                ...
                                                                                                <td class="td-widget-bc-search-desc-ch1" style="width: 100px; height: 37px;" align="center">
                                                                                                    <%--<asp:TextBox ID="TextBox2" runat="server" onkeypress="return CheckForInteger(event,'/')"
                                                                                                        CssClass="text-box" MaxLength="10" Width="71%"></asp:TextBox>
                                                                                                    <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/Images/cal.gif" Style="float: left;" />
                                                                                                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator5" runat="server" ControlExtender="MaskedEditExtender11"
                                                                                                        ControlToValidate="txtVisitFromDate" EmptyValueMessage="Date is required" InvalidValueMessage="Date is invalid"
                                                                                                        IsValidEmpty="True" TooltipMessage="Input a Date" Visible="true" Width="100%"></ajaxToolkit:MaskedEditValidator>--%>
                                                                                                </td>
                                                                                                <td class="td-widget-bc-search-desc-ch1" style="width: 100px; height: 37px;" align="center">
                                                                                                    <%--<asp:TextBox ID="TextBox3" runat="server" onkeypress="return CheckForInteger(event,'/')"
                                                                                                        CssClass="text-box" MaxLength="10" Width="71%"></asp:TextBox>
                                                                                                    <asp:ImageButton ID="ImageButton8" runat="server" ImageUrl="~/Images/cal.gif" Style="float: left;" />
                                                                                                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator6" runat="server" ControlExtender="MaskedEditExtender12"
                                                                                                        ControlToValidate="txtVisitTODate" EmptyValueMessage="Date is required" InvalidValueMessage="Date is invalid"
                                                                                                        IsValidEmpty="True" TooltipMessage="Input a Date" Visible="true" Width="100%"></ajaxToolkit:MaskedEditValidator>--%>
                                                                                                </td>
                                                                                            </tr>
                                    ...
                                    <img alt="" src="Images/Excel.jpg" style="border:none;"  height="15px" width ="15px" title = "Export TO Excel"/></asp:LinkButton>
                                                            ...
                                                            <xgrid:XGridViewControl ID="grdCaseMaster" runat="server" Height="148px" Width="1002px"
                                                                ...
                                                                AlternatingRowStyle-BackColor="#EEEEEE" ExportToExcelFields="SZ_CASE_NO,SZ_PATIENT_NAME,SZ_CASE_TYPE_NAME,DT_DATE_OF_ACCIDENT,DT_CREATED_DATE,DATE_OF_FIRST_VISIT,DATE_OF_LAST_VISIT,SZ_PATIENT_PHONE"
                                                                ExportToExcelColumnNames="Case No,Patient Name,Case Type,Date Of Accident,Date Open,DATE OF FIRST VISIT,DATE OF LAST VISIT,Patient Phone"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="DATE_OF_FIRST_VISIT" HeaderText="Date Of First Visit"
                                                                    ...
                                                                    <asp:BoundField DataField="SZ_PATIENT_PHONE" HeaderText="Patient Phone" ItemStyle-HorizontalAlign="Center"
                                                                        HeaderStyle-HorizontalAlign="Center">
                                                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                    </asp:BoundField>
