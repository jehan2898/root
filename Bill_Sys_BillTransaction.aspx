            ...
            function clickButton1(e,charis)
{
 ...
 function openDiagnosisPage(obj)
       ...
       function CloseSource()
       {
            ...
            window.parent.document.location.href='Bill_Sys_BillTransaction.aspx';            
       }
       
       function checkExistingBills(obj,objCaseType,objBillNumber,objSpeciality)
       {
            if(obj != "0")
            {
                if(confirm('Bill will be regenerated on original date, Do you want to proceed?'))
                {
                    if(objCaseType=="WC000000000000000001")
                    {
                        document.getElementById('_ctl0_ContentPlaceHolder1_hdnWCPDFBillNumber').value=objBillNumber
                        document.getElementById('_ctl0_ContentPlaceHolder1_hdnSpeciality').value=objSpeciality;
       ...
       function showPDFWorkerComp()
        {
        document.getElementById('_ctl0_ContentPlaceHolder1_pnlPDFWorkerComp').style.height='180px';
        document.getElementById('_ctl0_ContentPlaceHolder1_pnlPDFWorkerComp').style.visibility = 'visible';
        document.getElementById('_ctl0_ContentPlaceHolder1_pnlPDFWorkerComp').style.position = "absolute";
	    document.getElementById('_ctl0_ContentPlaceHolder1_pnlPDFWorkerComp').style.top = '400px';
	    document.getElementById('_ctl0_ContentPlaceHolder1_pnlPDFWorkerComp').style.left ='450px';
        }
        function ClosePDFWorkerComp()
       {
            document.getElementById('_ctl0_ContentPlaceHolder1_pnlPDFWorkerComp').style.height='0px';
            document.getElementById('_ctl0_ContentPlaceHolder1_pnlPDFWorkerComp').style.visibility = 'hidden';  
       }
       ...
       {    
            ...
            if(blResult == true)
            {
                ...
                var _isvalid = formValidator('frmBillTrans','txtBillDate');                  
                ...
                {
                    var _value = document.getElementById("_ctl0_ContentPlaceHolder1_txtClaimInsurance");                  
                   if(_value.value==0)
                    {
       ...
       function QuickBillConfirmClaimInsurance()
       {    
       ...
       function FormValidation()
        {
            //var objDoctor = document.getElementById('_ctl0_ContentPlaceHolder1_extddlDoctor').value; //removed by shailesh 31mar2010
        ...
        function ValidateGridCheckBox(objDocName,objVisitType,objDocID)
        {
            //alert("Check1");
            var index = 2;
            var chkbox;
            var cnt = 0;
            chkbox=document.getElementById('_ctl0_ContentPlaceHolder1_grdCompleteVisit' + '__ctl' + index + '_chkSelectItem');
            //alert('_ctl0_ContentPlaceHolder1_grdCompleteVisit' + '__ctl' + index + '_chkSelectItem');
            //
            var docName = objDocName;
            //alert(docName);
            var VisitType = objVisitType;
            DoctorID = objDocID;
            ...
            //alert("Final Count:" + cnt);
            if(cnt > 1)
            {
                var PreDocName = document.getElementById('_ctl0_ContentPlaceHolder1_hdnDocName').value;
                //alert(PreDocName);
                var PreVisitType = document.getElementById('_ctl0_ContentPlaceHolder1_hdnVisitType').value;
                //alert(PreVisitType);
                if(PreDocName == docName)
                {
                //    if(PreVisitType == VisitType)
                //    {
                ...
                //    else
                //    {
                //        alert('You cannot select multiple visit type for same doctor');
                //        return false;
                //    }
                ...
                {
                    document.getElementById('_ctl0_ContentPlaceHolder1_hndJavaScriptDocID').value = document.getElementById('_ctl0_ContentPlaceHolder1_hndDoctorID').value;
                    alert('Select visit of same doctor only');
                    return false;
                }
                //alert("Select only 1 checkbox from grid!!!");
                //return false;
            }
            else if(cnt == 0)
            {
                var i_chkbox
                var i_Index = 2
                chkbox=document.getElementById('_ctl0_ContentPlaceHolder1_grdCompleteVisit' + '__ctl' + i_Index + '_chkSelectItem');
                while(i_chkbox != null)
                {
            ...
            {
                //alert("true");
                document.getElementById('_ctl0_ContentPlaceHolder1_hdnDocName').value = docName;
                document.getElementById('_ctl0_ContentPlaceHolder1_hdnVisitType').value = VisitType;
                //alert(document.getElementById('_ctl0_ContentPlaceHolder1_hdnDocName').value);
                //alert(document.getElementById('_ctl0_ContentPlaceHolder1_hdnVisitType').value);
                //__doPostBack('_ctl0_ContentPlaceHolder1_grdCompleteVisit __ctl2_chkSelectItem','');
                return true;
                
            }
            
            //var id = _ctl0_ContentPlaceHolder1_grdCompleteVisit __ctl2_chkSelectItem
        }
       
        
       function completeGridValidator(obj1)
       {
            
            var querystringtype = obj1;
            //alert(querystringtype);
            if(querystringtype == 'Search')
            {
                //alert('old bill')
                //document.getElementById('_ctl0_ContentPlaceHolder1_dvbuttons').style.zIndex = 1;
                //document.getElementById('_ctl0_ContentPlaceHolder1_dvgrdProcedure').style.zIndex = 2;
                //__doPostBack('_ctl0_ContentPlaceHolder1_btnAddServices','');
                return true;
            }
            else
            {
                ...
                if(cnt == 0)
                {
                    if(document.getElementById('_ctl0_ContentPlaceHolder1_hndPopUpvalue').value == 'GridPopUp')
                    {
                    
                    }
                    else
                    {
                        alert('Select doctor from grid');
                    }
                    var modal = $find('_ctl0_ContentPlaceHolder1_modalpopupAddservice');
                    //alert(modal);
                    modal.hide();  
                    //return false;
                }
                ...
                {
                    //alert('new bill');
                    var chkpostback = document.getElementById('_ctl0_ContentPlaceHolder1_hndPopFirstPostback').value;
                    //alert(chkpostback);
                    if(chkpostback == '')
                    {
                        //alert('test');
                        document.getElementById('_ctl0_ContentPlaceHolder1_hndPopUpvalue').value = 'PopUpValue';
                        document.getElementById('_ctl0_ContentPlaceHolder1_hndPopFirstPostback').value = 'FirstPostBack';
                        __doPostBack('_ctl0_ContentPlaceHolder1_btnAddServices','onclick');
                    }
                    else if(chkpostback == 'FirstPostBack')
                    {
                        //DoctorID = objDocID;
                        var docpostbackID = document.getElementById('_ctl0_ContentPlaceHolder1_hndJavaScriptDocID').value;
                        //alert(docpostbackID);
                        var DocID = document.getElementById('_ctl0_ContentPlaceHolder1_hndDoctorID').value;
                        //alert(DocID);
                        //document.getElementById('_ctl0_ContentPlaceHolder1_hndPopUpvalue').value = 'PopUpValue';
                        if(docpostbackID == DocID)
                        {
                            return true;
                        }
                        else
       ...
       function CompleteVisitGroupVisit(obj1)
       {
            ...
            else
            {
                ...
                if(cnt == 0)
                {
                    ...
                    //alert('Select doctor from grid');
                    var modal = $find('_ctl0_ContentPlaceHolder1_modalpopupaddgroup');
                    modal.hide();
                    //return false;
                }
                else
                {
                    ...
                    //document.getElementById('_ctl0_ContentPlaceHolder1_hndPopUpvalue').value = 'GroupPopUpValue';
                    //__doPostBack('_ctl0_ContentPlaceHolder1_btnAddGroup','onclick');
    ...
    <script>
        function validate()
        {
            if(document.getElementById('_ctl0_ContentPlaceHolder1_extddlDoctor') != null)
            {
    ...
    <script>
        function onOk()
        {
         var tempdt =  document.getElementById('_ctl0_ContentPlaceHolder1_txtDateOfservice');
        if(tempdt.value=='' && document.getElementById('_ctl0_ContentPlaceHolder1_txtDateOfservice').style.visibility=='visible')
        {
            alert('Please enter date of service');
            document.getElementById('_ctl0_ContentPlaceHolder1_txtDateOfservice').style.backgroundColor = "#ffffff";
            return false;
        }        
          
           //AjaxControlToolkit.PopupControlBehavior.__VisiblePopup.hidePopup();
            //return false;
            __doPostBack('_ctl0$ContentPlaceHolder1$Button1','');
            
          
        }
        
        function onGroupService()
        {
         var tempdt =  document.getElementById('_ctl0_ContentPlaceHolder1_txtGroupDateofService');
        if(tempdt.value=='' && document.getElementById('_ctl0_ContentPlaceHolder1_txtGroupDateofService').style.visibility=='visible')
        {
            alert('Please enter date of service');
            document.getElementById('_ctl0_ContentPlaceHolder1_txtGroupDateofService').style.backgroundColor = "#ffffff";
            return false;
        }        
          
           //AjaxControlToolkit.PopupControlBehavior.__VisiblePopup.hidePopup();
            //return false;
            __doPostBack('_ctl0$ContentPlaceHolder1$lnkAddGroupService','');
        ...
        {
        document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.height='180px';
        document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.visibility = 'visible';
        document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.position = "absolute";
	    document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.top = '355px';
	    document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.left ='450px';
        ...
        function CloseServiceSource()
       {
        ...
        {
        document.getElementById('_ctl0_ContentPlaceHolder1_pnlGroupService').style.height='180px';
        document.getElementById('_ctl0_ContentPlaceHolder1_pnlGroupService').style.visibility = 'visible';
        document.getElementById('_ctl0_ContentPlaceHolder1_pnlGroupService').style.position = "absolute";
	    document.getElementById('_ctl0_ContentPlaceHolder1_pnlGroupService').style.top = '355px';
	    document.getElementById('_ctl0_ContentPlaceHolder1_pnlGroupService').style.left ='400px';
	    document.getElementById('_ctl0_ContentPlaceHolder1_txtGroupDateofService').value=''; 
	     document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.height='0px';
            document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.visibility = 'hidden';  
            document.getElementById('_ctl0_ContentPlaceHolder1_txtDateOfservice').value='';   
       ...
       function showDiagnosisCodePopup()
       {
	        ...
	        document.getElementById('_ctl0_ContentPlaceHolder1_pnlDiagnosisCode').style.left ='750px';
	    //    document.getElementById('_ctl0_ContentPlaceHolder1_txtGroupDateofService').value=''; 
	        document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.height='0px';
            document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.visibility = 'hidden';  
        //    document.getElementById('_ctl0_ContentPlaceHolder1_txtDateofService').value='';   
       ...
       function checkGridForRow()
       {
            var f = document.getElementById('_ctl0_ContentPlaceHolder1_grdTransactionDetails')
            var bflag = false
            
            
       }
       
       function btndopostback()
       {
            __doPostBack('_ctl0_ContentPlaceHolder1_btnAddServices','');
       }
                                    ...
                                    <td style="width: 100%" class="TDPart">
                                        <table border="0" cellpadding="3" cellspacing="3" class="ContentTable" style="width: 100%">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Button ID="btnLoadProcedures" Text="Get Codes" runat="server" CssClass="Buttons"
                                                        Visible="false" OnClick="btnLoadProcedures_Click" />
                                                    <asp:Button ID="btnQuickBill" Text="Quick Bill" runat="server" CssClass="Buttons"
                                                        Visible="false" OnClick="btnQuickBill_Click" />
                                                </td>
                                                
                                            </tr>
                                            <tr>
                                                <td class="ContentLabel" colspan="4" style="width: 15%">
                                                    <div ID="dvcompletevisit" style="overflow: scroll; height: 200px;" runat="server" visible="false">
                                                        
                                                        <asp:DataGrid ID="grdCompleteVisit" runat="server" Width="100%" CssClass="GridTable"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundColumn DataField="VisitType" HeaderText="Visit Type" ItemStyle-HorizontalAlign="Left"
                                                                    HeaderStyle-HorizontalAlign="Left"></asp:BoundColumn>
                                                                <asp:BoundColumn DataField="VisitDate" HeaderText="Visit Date" ItemStyle-HorizontalAlign="Left"
                                                                    HeaderStyle-HorizontalAlign="Left"></asp:BoundColumn>
                                            ...
                                            <tr>
                                                ...
                                                <asp:TextBox ID="txtBillID" runat="server" Visible="False" Width="10px"></asp:TextBox></tr>
                                            <%--  
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 35%">
                                                    ...
                                                    <asp:Button ID="btnOk" runat="server" Text="Ok" Width="80px" CssClass="Buttons" Visible="false"  /></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                </td>
                                                <td style="width: 35%">
                                                    &nbsp;
                                ...
                                <tr>
                                    <td style="width: 100%;" class="TDPart">
                                        <div align="right" style="vertical-align: top;">
                                            ...
                                            <%-- <a id="hlnkShowGroupProcCode" style="cursor: pointer; height: 240px; vertical-align: top;"
                                                onclick="showGroupPopup();" class="Buttons" runat="server" title="Add Group Services">
                                                Add Group Services</a> <a id="hlnkShowServices" style="cursor: pointer; height: 240px;
                                                    vertical-align: top;" onclick="showServicePopup();" class="Buttons" runat="server"
                                                    title="Add Services">Add Services</a>--%>
                                                    <asp:Button ID="btnAddGroup" runat="server" Text="Add Group Services" CssClass="Buttons" />
                                                    <ajaxToolkit:ModalPopupExtender ID="modalpopupaddgroup" runat="server" PopupControlID="pnlGroupService" 
                                                    TargetControlID= "btnAddGroup" Drag="true" BackgroundCssClass="modalBackground" OkControlID="btnGroupServices" 
                                                    CancelControlID ="btnCloseGroup" OnCancelScript="CloseGroupSource()" ></ajaxToolkit:ModalPopupExtender>
                                                    <asp:Button ID="btnAddServices" runat="server" Text="Add Services" CssClass="Buttons" OnClick="btnAddServices_Click" />
                                                    <ajaxToolkit:ModalPopupExtender ID="modalpopupAddservice" runat="server" PopupControlID="pnlShowNotes" 
                                                    TargetControlID= "btnAddServices" Drag="true" BackgroundCssClass="modalBackground" OkControlID="btnService" 
                                                    CancelControlID ="btnclose" OnCancelScript="CloseServiceSource()" ></ajaxToolkit:ModalPopupExtender>
                                        ...
                                        <div style="overflow: scroll; height: 150px; width: 99%;">
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                <contenttemplate>
                                               
                                        <asp:DataGrid ID="grdTransactionDetails" runat="server" 
                                            OnSelectedIndexChanged="grdTransactionDetails_SelectedIndexChanged"
                                            AutoGenerateColumns="False" 
                                            Width="96%" CssClass="GridTable" >
                                            ...
                                            <Columns>
                                             <%--0 --%>
                                               ...
                                               <%-- <asp:BoundColumn DataField="FLT_AMOUNT" HeaderText="Amount" DataFormatString="{0:0.00}">
                                                 ...
                                                 <%--6 --%>
                                                <asp:BoundColumn DataField="FACTOR_AMOUNT" HeaderText="Amount" DataFormatString="{0:0.00}">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundColumn>
                                                 <%--7 --%>
                                                ...
                                                <asp:TemplateColumn>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkMIReport" runat="server" Text="Edit W.C. 4.3 " CommandArgument='<%# DataBinder.Eval(Container,"DataItem.SZ_BILL_NUMBER")%>'
                                                            CommandName="Doctor's Report Of MMI" Visible="false"> </asp:LinkButton>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateColumn>
                                                <%-- 16 --%>
    ...
    <asp:Panel ID="pnlShowNotes" runat="server" CssClass="modalPopup">
        ...
        <a id="A1" href="#">
            <input type="image" name="mgbtnDateofService" id="Image1" runat="server" src="Images/cal.gif"
                border="0" /></a>
        <input type="button" value="Add" class="Buttons" onclick="onOk()" id ="btnService"/><a
            style="cursor: pointer;" title="Close" id="btnclose">X</a>
    ...
    <%--  <ajaxToolkit:PopupControlExtender ID="popUpGroupService" runat="server" TargetControlID="hlnkShowGroupProcCode"
            PopupControlID="pnlGroupService" Position= "Center" OffsetX="-400" OffsetY="-120" />--%>
    <asp:Panel ID="pnlGroupService" runat="server" CssClass="modalPopup">
        ...
        <input type="button" value="Add" class="Buttons" onclick="onGroupService()" id="btnGroupServices" /><a
             style="cursor: pointer;" title="Close" id="btnCloseGroup">X</a>
  ...
  //
    ...
    function closed(cal) {
      ...
      if (document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.visibility == 'hidden' && document.getElementById('_ctl0_ContentPlaceHolder1_pnlGroupService').style.visibility == 'visible')
        {el = document.getElementById("_ctl0_ContentPlaceHolder1_txtGroupDateofService");}
       if (document.getElementById('_ctl0_ContentPlaceHolder1_pnlShowNotes').style.visibility == 'visible' && document.getElementById('_ctl0_ContentPlaceHolder1_pnlGroupService').style.visibility == 'hidden')
        {el = document.getElementById("_ctl0_ContentPlaceHolder1_txtDateOfservice");}
