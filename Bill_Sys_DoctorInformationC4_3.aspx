<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_DoctorInformationC4_3.aspx.cs" Inherits="Bill_Sys_DoctorInformationC4_3" %>
    ...
    function CheckForInteger(e,charis)
        {
         ...
         function CopySameAddress()
         {
            ...
            if(chk.checked)
            {
               ...
               document.getElementById('txtBillingState').value= document.getElementById('txtOfficeState').value;
...
<body>
    <form id="frmDoctorInformationCfourThree" runat="server">
        <div>
         ...
         <%--       <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <th height="29" width="19%" scope="col">
                                    <div align="left">
                                        <span class="pg">&gt;&gt; Home >> Doctor's Information</span>
                                    </div>
                                </th>
                            </tr>
                        </table>
                ...
                <td colspan="6" style="height: 300px; vertical-align:top;">
                                 ...
                                 <td width="72%" scope="col">
                        	        ...
                        	        Doctor Information
                                        <div class="div_blockcontent">
                                                         <table>
                            <tr>
                                <th width="83%" align="center" valign="top" scope="col" colspan="6" style="height: 300px">
                                    <div align="left">
                                            ...
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
                                                ...
                                                <tr>
                                                    <td style="vertical-align: top; width: 13px;">
                                                        ...
                                                        <td style="width: 141px">
                                                           <div class="lbl"> WCB Authorization #</div> </td>
                                                    <td style="width: 144px">
                                                ...
                                                <tr>
                                                    <td style="width: 13px; ">
                                                        ...
                                                        <td style="width: 141px">
                                                        <div class="lbl">    WCB Rating Code</div> </td>
                                                    <td style="width: 144px; " >
                                                        <div class="lbl">
                                                ...
                                                <tr>
                                                    <td style="width: 13px">
                                                        4.</td>
                                                    <td  colspan="4">
                                                      <div class="lbl">  Office
                                                        Address(if changed previous report)</div> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 144px; ">
                                                        <asp:TextBox ID="txtOfficeState" runat="server" MaxLength="50" ></asp:TextBox></td>
                                                    <td >
                                                ...
                                                <tr>
                                                    <td colspan="5">
                                                       <div class="lbl"> <asp:CheckBox ID="chkCopySameAddress" runat="server" onclick="CopySameAddress();" Text="Copy Same Address for Biiling" /></div> </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 13px">
                                                        5.</td>
                                                    <td style="width: 141px">
                                                       <div class="lbl"> Billing Address</div> </td>
                                                    <td style="width: 144px">
                                                        </td>
                                                    <td>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 141px">
                                                      <div class="lbl">  State</div> </td>
                                                    <td style="width: 144px">
                                                        <asp:TextBox ID="txtBillingState" runat="server" MaxLength="50"></asp:TextBox></td>
                                                    <td>
                                                      <div class="lbl">  Zip Code</div> </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 141px; height: 30px;">
                                                      <div class="lbl">  Office Phone #.</div> </td>
                                                ...
                                                <tr>
                                                    <td style="width: 13px">
                                                        7.</td>
                                                    <td style="width: 141px">
                                                       <div class="lbl"> Billing Phone #.</div> </td>
                                                    <td style="width: 144px">
                                                ...
                                                <tr>
                                                    <td style="width: 13px">
                                                        9.</td>
                                                    <td style="width: 141px">
                                                       <div class="lbl"> Federal Tax ID #. is the</div> </td>
                                                    <td style="width: 144px">
                                                        <asp:TextBox ID="txtFederalTax" runat="server" MaxLength="50"></asp:TextBox></td>
                                                    <td>
                                                       <div class="lbl"> Tax ID #. is the(Check one)</div> </td>
                                                    <td>
                                                       <div class="lbl"> 
