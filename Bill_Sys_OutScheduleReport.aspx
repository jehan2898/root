   ...
   function CheckForInteger(e,charis)
        {
                           ...
                           function SetDate()
         {
            ...
            if(selValue == 0)
            {
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtEndDate').value = "";
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtStartDate').value = "";
                   
            }
            else if(selValue == 1)
            {
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtEndDate').value = getDate('today');
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtStartDate').value = getDate('today');
            }
            else if(selValue == 2)
            {
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtEndDate').value = getWeek('endweek');
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtStartDate').value = getWeek('startweek');
            }
            else if(selValue == 3)
            {
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtEndDate').value = getDate('monthend');
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtStartDate').value = getDate('monthstart');
            }
            else if(selValue == 4)
            {
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtEndDate').value = getDate('quarterend');
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtStartDate').value = getDate('quarterstart');
            }
            else if(selValue == 5)
            {
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtEndDate').value = getDate('yearend');
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtStartDate').value = getDate('yearstart');
            }
              else if(selValue == 6)
            {
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtEndDate').value = getLastWeek('endweek');
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtStartDate').value = getLastWeek('startweek');
            }else if(selValue == 7)
            {     
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtEndDate').value = lastmonth('endmonth');
                   
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtStartDate').value = lastmonth('startmonth');
            }else if(selValue == 8)
            {     
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtEndDate').value =lastyear('endyear');
                   
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtStartDate').value = lastyear('startyear');
            }else if(selValue == 9)
            {     
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtEndDate').value = quarteryear('endquaeter');
                   
                   document.getElementById('_ctl0_ContentPlaceHolder1_txtStartDate').value =  quarteryear('startquaeter');
            }
         }
    ...
    <div id="diveserch" language="javascript" onkeypress="javascript:return WebForm_FireDefaultButton(event, '_ctl0_ContentPlaceHolder1_btnGenerateReport')">
                                ...
                                <tr>
                                    <td style="width: 100%" class="TDPart">
                                        <table width="100%" border="0" align="center" class="ContentTable" cellpadding="0"
                                            ...
                                            <tr>
                                                <td style="font-size: 14px; font-family: arial; vertical-align: top;">
                                                    Status</td>
                                                <td class="tablecellSpace">
                                                </td>
                                                <td class="tablecellControl">
                                            ...
                                            <tr>
                                                <td colspan="6" align="right">
                                                    ...
                                                    <asp:Button ID="btnGenerateReport" runat="server" Text="Show" Width="150px" OnClick="btnGenerateReport_Click"
                                                        CssClass="Buttons" />&nbsp; <asp:Button ID="btnExportToExcel" runat="server" CssClass="Buttons" Text="Export To Excel"
