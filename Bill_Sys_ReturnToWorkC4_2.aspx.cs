...
public partial class Bill_Sys_ReturnToWorkC4_2 : PageBase
{
    ...
    protected void LoadOtherInformation()
    {
        ...
        {
            _workerstemplate = new workers_templateC4_2();
            _objDataSet = GetWorkStatusLimitationbyID(txtWorkStatusID.Text); /*_workerstemplate.GetWorkStatusLimitation(txtPatientID.Text);*/
    ...
    public DataSet GetWorkStatusLimitationbyID(string p_szworkstatusID)
    {
        ...
        try
        {
            ...
            comm.Parameters.AddWithValue("@SZ_WORK_STATUS_ID", p_szworkstatusID);
            comm.Parameters.AddWithValue("@FLAG", "GETDATA");

            SqlDataAdapter objSqlDataAdap = new SqlDataAdapter(comm);
