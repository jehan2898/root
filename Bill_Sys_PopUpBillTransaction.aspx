<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_PopUpBillTransaction.aspx.cs"
    Inherits="Bill_Sys_PopUpBillTransaction" %>
...
<body>
    <form id="form1" runat="server">
                                            ...
                                            <table border="0" cellpadding="3" cellspacing="3" class="ContentTable" style="width: 100%">
                                                <tr>
                                                    <td class="ContentLabel" style="text-align: center; height: 20px;" colspan="4">
                                                        ...
                                                        <asp:Button ID="Button2" runat="server" Text="Button" OnClick="Button2_Click" Visible="false"/><div id="ErrorDiv" runat="server" style="color: red" visible="true">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="ContentLabel" style="width: 40%">
                                                       Doctor &nbsp;<extddl:ExtendedDropDownList ID="extddlDoctor" runat="server" Width="80%" Connection_Key="Connection_String"
        ...
        <div id="divid2" style="position: absolute; left: 100px; top: 100px; width: 500px;
            ...
            <iframe id="iframeAddDiagnosis" src="" frameborder="0" height="380" width="500" language="javascript" onblur="return iframeAddDiagnosis_onblur()"></iframe>
        </div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                <tr>
                    <td align="right">
                        ...
                        <input type="button" value="Add" class="Buttons" onclick="onGroupService()" /><a onclick="CloseGroupSource();" style="cursor: pointer;" title="Close">X</a>
                    </td>
                </tr>
                <tr>
                        ...
                        <div style="height: 200px; overflow-y: scroll;">
                            <asp:DataGrid ID="grdGroupProcCodeService" runat="server" AllowPaging="false" Width="99%"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="I_GROUP_AMOUNT_ID" HeaderText="Amount Id" Visible="false"></asp:BoundColumn>
                      <asp:BoundColumn DataField="FLT_AMOUNT" HeaderText="Amount" Visible="false"></asp:BoundColumn>
                                </Columns>
                                <HeaderStyle CssClass="GridHeader" />
                            </asp:DataGrid>
