<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_PaymentReport.aspx.cs" Inherits="Bill_Sys_PaymentReport" %>
                        ...
                        <tr>
                            ...
                            <td class="Center" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                                    <tr>
                                        <td style="width: 100%; height: 168px;" class="TDPart">
                                            <table border="0" cellpadding="3" cellspacing="0" class="ContentTable" style="width: 100%">
                                                ...
                                                <td style="width: 35%; height: 18px;">
                                                    <div>
                                                        <extddl:ExtendedDropDownList ID="extddlCaseType" runat="server" Width="65%" Connection_Key="Connection_String"
                                        ...
                                        <td style="width: 100%" class="TDPart">
                                            <asp:DataGrid ID="grdAllReports" runat="server" Width="100%" CssClass="GridTable"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="CASE_NUMBER" HeaderText="Case Number"></asp:BoundColumn>
                                                    <asp:BoundColumn DataField="BILL_NUMBER" HeaderText="Bill Number"></asp:BoundColumn>
                                                    <asp:BoundColumn DataField="PATIENT_NAME" HeaderText="Patient Name"></asp:BoundColumn>
                                                    <asp:BoundColumn DataField="BILL_AMOUNT" HeaderText="Bill Amount" DataFormatString="{0:0.00}">
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="CHECK_DATE" HeaderText="Check Date" DataFormatString="{0:MM/dd/yyyy}">
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="CHECK_AMOUNT" HeaderText="Check Amount" DataFormatString="{0:0.00}">
                                                    </asp:BoundColumn>
                                                     <asp:BoundColumn DataField="SZ_CASE_TYPE_NAME" HeaderText="Case Type">
                                                    </asp:BoundColumn>
                                                </Columns>
                                            ...
                                            <asp:DataGrid ID="grdForReport" runat="server" Width="100%" CssClass="GridTable"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="CHECK_AMOUNT" HeaderText="Check Amount" DataFormatString="{0:0.00}">
                                                       ...
                                                       <asp:BoundColumn DataField="SZ_CASE_TYPE_NAME" HeaderText="Case Type" DataFormatString="{0:0.00}">
                                                    </asp:BoundColumn>
                                                </Columns>
                                                <HeaderStyle CssClass="GridHeader" />
                                            </asp:DataGrid>
