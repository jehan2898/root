<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_LineViewDayCalander.aspx.cs" Inherits="Bill_Sys_LineViewDayCalander" %>
...
<body topmargin="0" style="text-align:center" bgcolor="#FBFBFB">
	...
	<table cellpadding="0" cellspacing="0" class="simple-table">
		...
		<tr>
	      ...
	      <cc2:WebCustomControl1 id="TreeMenuControl1" runat="server"  Procedure_Name="SP_MST_MENU" Connection_Key="Connection_String" Width="100%" Xml_Transform_File="TransformXSLT.xsl" LevelMenuItemStylesCSS="sublevel1" DynamicMenuItemStyleCSS="sublevel1" StaticMenuItemStyleCSS="parentlevel1"  Child_Label_CSS="sublevel1"  Height="24px"></cc2:WebCustomControl1></td>
		  ...
		  <td height="29" colspan="2" align="right" background="Images/sub-menu-bg.jpg">
		  	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				<tr>
				  ...
				  <th height="29" width="81%" scope="col"><div align="right" runat="server" id="divNavigation"><span class="sub-menu">
			...
			<td colspan="2" bgcolor="#EAEAEA" align="center">
					...
					<tr runat="server" id="tr1" visible="false">
					   ...
					   <td style="border-bottom: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn0" runat="server" Visible="false"  OnClick="ShowAll"  ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
					  </td>
					</tr>
					<tr runat="server" id="tr2" visible="false">
					  ...
					  <td style="BORDER-BOTTOM: #999966 1px solid; height: 22px;">
						   <asp:LinkButton ID="LnkBtn1" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
					  </td>
					</tr>
					<tr runat="server" id="tr3" visible="false">
					   ...
					   <td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn2" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown"  CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
					  </td>
					</tr>
					<tr runat="server" id="tr4" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn3" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr5" visible="false">
					   ...
					   <td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn4" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
					  </td>
					</tr>
					<tr runat="server" id="tr6" visible="false">
						...
						<asp:Literal ID="literal5" runat="server">
						 ...
						 <td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn5" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr7" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn6" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr8" visible="false">
					   ...
					   <td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn7" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
					  </td>
					</tr>
					<tr runat="server" id="tr9" visible="false">
					  ...
					  <td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn8" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown"  CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
					  </td>
					</tr>
					<tr runat="server" id="tr10" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn9" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr11" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn10" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr12" visible="false">
					   ...
					   <td class="css-cal-text">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn11" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr13" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn12" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr14" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn13" runat="server" Visible="false"  ForeColor="SaddleBrown" OnClick="ShowAll" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr15" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn14" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr16" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn15" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr17" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn16" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr18" visible="false">
					   ...
					   <td class="css-cal-text">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn17" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr19" visible="false">
					   ...
					   <td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn18" runat="server" Visible="false" OnClick="ShowAll"  ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
					  </td>
					</tr>
					<tr runat="server" id="tr20" visible="false">
					   ...
					   <td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn19" runat="server" Visible="false" OnClick="ShowAll"  ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
					  </td>
					</tr>
					<tr runat="server" id="tr21" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn20" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr22" visible="false">
					   ...
					   <td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn21" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
					  </td>
					</tr>
					<tr runat="server" id="tr23" visible="false">
					   ...
					   <td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn22" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
					  </td>
					</tr>
					<tr runat="server" id="tr24" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn23" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					 <tr runat="server" id="tr25" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn24" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr26" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn25" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					 <tr runat="server" id="tr27" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn26" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr28" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn27" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					 <tr runat="server" id="tr29" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn28" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr30" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn29" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
					<tr runat="server" id="tr31" visible="false">
						...
						<td style="BORDER-BOTTOM: #999966 1px solid">
						   <asp:LinkButton ID="LnkBtn30" runat="server" Visible="false"  OnClick="ShowAll" ForeColor="SaddleBrown" CssClass="css-show-all">(Show All)</asp:LinkButton>&nbsp;
						</td>
					</tr>
				</table>			
			</td>
