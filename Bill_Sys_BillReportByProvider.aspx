<%@ page language="C#" masterpagefile="~/MasterPage.master" CodeFile="Bill_Sys_BillReportByProvider.aspx.cs" autoeventwireup="true" inherits="Bill_Sys_BillReportByProvider" title="Green Bills - Bill Report By Provider" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <script type="text/javascript">
     function ShowBills(OffID) {

        var vrFromDate="";
        vrFromDate = document.getElementById("<%=txtFromDate.ClientID%>").value;
        var vrToDate = "";
        vrToDate = document.getElementById("<%=txtToDate.ClientID%>").value;
        var vrProvider = "";
        vrProvider = document.getElementById("<%=txtProvider.ClientID%>").value;
        var vrLocation = "";
        var drploc = document.getElementById("ctl0_ContentPlaceHolder1_objextddlLocation");
        if (drploc!=null)
        {
            vrLocation = drploc.value
        }


        window.location.href = 'Bill_Sys_DetailBillReportProvider.aspx?OffID=' + OffID + '&FromDate=' + vrFromDate + '&ToDate=' + vrToDate + '&Location=' + vrLocation + '&Provider=' + vrProvider;
         return true;
            ...
            <td style="padding-right: 3px; padding-left: 3px; padding-bottom: 3px; width: 100%;
                ...
                <table id="MainBodyTable" cellpadding="0" cellspacing="0" style="width: 100%;height: 100%;">
                                            ...
                                            <Columns>   
                                                ...
                                                <asp:TemplateColumn HeaderText="Bill Amount">
                                                    ...
                                                    <ItemTemplate>
                                                           ...
                                                           <asp:LinkButton ID="lnkTotalBillAmount" runat="server" CommandName="OpenDetailReport" Visible="false"
                                                            Text='<%# DataBinder.Eval(Container,"DataItem.TOTAL_BILL_AMOUNT") %>'></asp:LinkButton>
                                                          <a id="A1" href="#" onclick='<%# "ShowBills(" + "\""+ Eval("SZ_OFFICE_ID") +"\");" %>' ><%# DataBinder.Eval(Container, "DataItem.TOTAL_BILL_AMOUNT")%></a>  
                                                ...
                                                <asp:BoundColumn DataField="MN_PAID" HeaderText="Received">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundColumn>
                                                ...
                                                <asp:BoundColumn DataField="TOTAL_OUTSTANDING_AMOUNT" HeaderText="Balance">
                                                   ...
                                                   <asp:BoundColumn DataField="mn_transferred_amount" HeaderText="Transferred">
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundColumn>
                    ...
                    <tr>
                        ...
                        <asp:HiddenField ID="hdloffid" runat="server" />
                        </td>
                    </tr>
                </table>
            </td>
