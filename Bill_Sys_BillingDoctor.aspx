<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_BillingDoctor.aspx.cs" Inherits="Bill_Sys_BillingDoctor" %>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                                <tr>
                                    <td style="width: 100%" class="TDPart">
                                        <table border="0" cellpadding="3" cellspacing="2" class="ContentTable" style="width: 100%">
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="ContentLabel" style="width: 15%">
                                                    <%--Doctor Type--%>
                                                    Doctor License Number</td>
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtLicenseNumber" runat="server" CssClass="textboxCSS" MaxLength="50"></asp:TextBox>
                                                    <cc1:ExtendedDropDownList ID="extddlDoctorType" Width="255px" runat="server" Connection_Key="Connection_String"
                                                        Procedure_Name="SP_MST_DOCTOR_TYPE" Flag_Key_Value="DOCTOR_TYPE_LIST" Selected_Text="--- Select ---" Visible="false"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="ContentLabel" style="width: 15%">
                                                ...
                                                <td class="ContentLabel" style="width: 35%">
                                                        ...
                                                        Procedure_Name="SP_MST_OFFICE" Flag_Key_Value="BILLING_OFFICE_LIST" Selected_Text="--- Select ---" />
                                                </td>
                                                <td class="ContentLabel" style="width: 15%">
                                                    WCB Authorization&nbsp;</td>
                                                <td class="ContentLabel" style="width: 35%">
                                                    <cc1:ExtendedDropDownList ID="extddlProvider" Width="90%" runat="server" Connection_Key="Connection_String"
                                                        Procedure_Name="SP_MST_PROVIDER" Flag_Key_Value="PROVIDER_LIST" Selected_Text="--- Select ---" visible="false"/>
                                                    <asp:TextBox ID="txtWCBAuth" runat="server" MaxLength="50" CssClass="textboxCSS"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="ContentLabel" style="width: 15%">
                                                ...
                                                <td class="ContentLabel" style="width: 15%">
                                                    <%--Billing Office--%>&nbsp;</td>
                                                <td class="ContentLabel" style="width: 35%"><cc1:ExtendedDropDownList ID="extddlBillingOffice" Width="90%" runat="server" Connection_Key="Connection_String"
                                                        Procedure_Name="SP_MST_OFFICE" Flag_Key_Value="BILLING_OFFICE_LIST" Selected_Text="--- Select ---" visible="false"/></td>
                                            </tr>
                                            <tr>
                                                <td class="ContentLabel" style="width: 15%">
                                                    <%--Billing Address--%></td>
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtBillingAdd" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                </td>
                                                <td class="ContentLabel" style="width: 35%">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtBillingCity" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                   <%--Billing State--%>
                                                </td>
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtBillingState" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox>
                                                    <cc1:ExtendedDropDownList ID="extddlBillingState" runat="server" Width="90%" Connection_Key="Connection_String"
                                                        Procedure_Name="SP_MST_STATE" Flag_Key_Value="GET_STATE_LIST" Selected_Text="--- Select ---" Visible="false">
                                            ...
                                            <tr>
                                                ...
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtBillingZip" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                   <%--Billing Phone--%>
                                                </td>
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtBillingPhone" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="ContentLabel" style="width: 15%">
                                                  <%-- NPI--%>
                                                ...
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtNPI" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                  <%-- Federal Tax--%>
                                                </td>
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtFederalTax" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="ContentLabel" style="width: 15%">
                                                ...
                                                <td class="ContentLabel" style="width: 15%">
                                                    <asp:TextBox ID="txtKOEL" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="ContentLabel" style="width: 15%">
                                                    <%--Assign No--%></td>
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtAssignNumber" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                </td>
                                                <td class="ContentLabel" style="width: 15%">
                                                </td>
                                              ...
                                              <tr>
                                                ...
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtOfficeAdd" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                    <%--Office City--%>
                                                </td>
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtOfficeCity" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="ContentLabel" style="width: 15%">
                                                    <%--Office State--%>
                                                ...
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtOfficeState" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                    <%--Office Zip--%>
                                                </td>
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtOfficeZip" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td class="ContentLabel" style="width: 15%">
                                                    <%--Office Phone--%>
                                                ...
                                                <td class="ContentLabel" style="width: 35%">
                                                    <asp:TextBox ID="txtOfficePhone" runat="server" MaxLength="50" CssClass="textboxCSS" Visible="false"></asp:TextBox></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                    &nbsp;</td>
                                                <td class="ContentLabel" style="width: 35%">
                                                    </td>
                                    ...
                                    <td style="width: 100%" class="TDPart">
                                        <asp:DataGrid ID="grdDoctorNameList" runat="server" OnDeleteCommand="grdDoctorNameList_DeleteCommand"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="SZ_ASSIGN_NO" HeaderText="Assign Number" Visible="false"></asp:BoundColumn>
                                                <asp:BoundColumn DataField="SZ_BILLING_STATE_ID" HeaderText="Billing State ID" Visible="false"></asp:BoundColumn>
                                                <asp:ButtonColumn CommandName="Delete" Text="Delete" Visible="false"></asp:ButtonColumn>
                                                <asp:TemplateColumn>
                                                    <ItemTemplate>
