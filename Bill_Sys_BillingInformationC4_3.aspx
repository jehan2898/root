<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_BillingInformationC4_3.aspx.cs" Inherits="Bill_Sys_BillingInformationC4_3" %>
...
<body>
    <form id="frmBillingInfoC4_3" runat="server">
        <div>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <th height="29" width="19%" scope="col">
                                    <div align="left">
                                        <span class="pg">&gt;&gt; Home >> Billing Information </span>
                                    </div>
                                </th>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td colspan="3" scope="col">
                                    ...
                                    <div align="left" class="blocktitle">
                                     <asp:Label ID="lblDivHeading" runat="server" Text="Billing Information"></asp:Label><div id="divPlanOfCare" class="div_blockcontent" >
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 121px">
                                                        <asp:TextBox ID="txtInsuranceState" runat="server" ReadOnly="True"></asp:TextBox></td>
                                                    <td>
                                                    </td>
                                                    <td>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <asp:GridView ID="grdBillingInformation" runat="server" Width="100%" AutoGenerateColumns="False">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="PAID_AMOUNT" HeaderText="Total Paid Amount" Visible="false"></asp:BoundField>
