<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_History.aspx.cs"
    Inherits="Bill_Sys_History" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function validate_historyradiobtn()
        {
            var value = "";
            var rdllist = document.getElementById('rdlstHospitalization');
            var rdlyes = document.getElementById('rdlstHospitalization_0');
            var rdlno = document.getElementById('rdlstHospitalization_1');
            var rdlnone = document.getElementById('rdlstHospitalization_2');
            var rdltext = document.getElementById('txtHospitalization');
            if(rdlyes.checked)
            {
                value = "0";
            }
            ...
            {
                value = "1";
                document.getElementById('txtHospitalization').value = "";
            }
            if(rdlnone.checked)
            {
                value = "2";
        ...
        function validate_rdlInjury()
        {
            var value = "";
            var rdlinjury = document.getElementById('rdlstInjury');
            var patient = document.getElementById('rdlstInjury_0');
            var medicalrecord = document.getElementById('rdlstInjury_1');
            var rdlother = document.getElementById('rdlstInjury_2');
            var rdlothertext = document.getElementById('txtLearnSourceDescription');
            if(patient.checked)
            {
                value = "0";
                document.getElementById('txtLearnSourceDescription').value = "";
            }
        ...
        function validate_PreviouslyTreated()
        {
            var value = "";
            var rdlpretreatyes = document.getElementById('rdlstPreviouslyTreated_0');
            var rdlpretreatno = document.getElementById('rdlstPreviouslyTreated_1');
            var rdlpretreatnone = document.getElementById('rdlstPreviouslyTreated_2');
            var txtpretreatyes = document.getElementById('txtPreviouslyTreated');
            if(rdlpretreatyes.checked)
            {
                value = "0";
            }
            if (rdlpretreatno.checked) {
                value = "1";
                document.getElementById('txtPreviouslyTreated').value = "";
            }
            if (rdlpretreatyes.checked) {
                value = "0";
                document.getElementById('txtPreviouslyTreated').value = "";
                                                ...
                                                <tr>
                                                    <td colspan="4" width="100%" align="center">
                                                       <asp:TextBox ID="txtCompanyID" runat="server" Width="10px" Visible="false"></asp:TextBox>
                                                        <asp:TextBox ID="txtPrevTreat" runat="server" Visible="false"></asp:TextBox>
