<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_DiagnosisType.aspx.cs" Inherits="Bill_Sys_DiagnosisType" %>
                    ...
                    <tr>
                        ...
                        <td class="Center" valign="top">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                                        ...
                                        <table border="0" cellpadding="3" cellspacing="0" class="ContentTable" style="width: 100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 35%" class="ContentLabel">
                                                    <asp:TextBox ID="txtDiagnosisType" runat="server" CssClass="textboxCSS" MaxLength="50"></asp:TextBox></td>
                                                <td class="ContentLabel" style="width: 15%">
                                                </td>
                                                <td style="width: 35%">
                                                </td>
                                ...
                                <tr>
                                    <td style="width: 100%" class="TDPart">
                                        <asp:DataGrid ID="grdDiagnosisType" runat="server" OnSelectedIndexChanged="grdDoctorType_SelectedIndexChanged"
                                            OnPageIndexChanged="grdDoctorType_PageIndexChanged" Width="100%" CssClass="GridTable"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="SZ_DIAGNOSIS_TYPE_ID" HeaderText="DOCTOR TYPE ID" Visible="False">
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="SZ_DIAGNOSIS_TYPE" HeaderText="Diagnosis Type"></asp:BoundColumn>
