...
function ListBox(Arguments)
{
	...
	var AlternateItemBackColor = Arguments.AlternateItemBackColor ? Arguments.AlternateItemBackColor : '#F0F8FF';
	var SelectedItemColor = Arguments.SelectedItemColor ? Arguments.SelectedItemColor : '#0000FF';
	var SelectedIItemBackColor = Arguments.SelectedIItemBackColor ? Arguments.SelectedIItemBackColor : '#FFFFE0';
    ...
    ListBoxDiv.style.width = 322 + 'px';  
	ListBoxDiv.style.height = 400 + 'px';
	
    this.AddItem = function(_Text, _Value, _bit)
	{
        var Item = null;
		var CheckBox = null;        
        var Span = null;
