<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bill_Sys_VerificationsentBills_Report.aspx.cs" Inherits="Bill_Sys_VerificationsentBills_Report" Title="Untitled Page" %>
                    ...
                    <tr>
                        ...
                        <td class="Center" valign="top" style="height: 100%">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                        ...
                                        <table border="0" cellpadding="3" cellspacing="3" class="ContentTable" style="width: 100%">
                                            <tr>
                                                <td class="ContentLabel" style="text-align: left; height: 25px;" colspan="4">
                                                    ...
                                                    <b>Verification Bill Report</b></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 35%">
                                                    <cc1:ExtendedDropDownList ID="extddlBillStatus" runat="server" Connection_Key="Connection_String"
                                                        Flag_Key_Value="GET_VERIFICATION_BILL_STATUS" Procedure_Name="SP_MST_BILL_STATUS"
                                ...
                                <tr>
                                    <td align="right" class="TDPart">
                                        <asp:Button ID="btnSetLitigate" runat="server" Text="Set Litigate" CssClass="Buttons" OnClick="btnSetLitigate_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 100%;height: 100%;" class="TDPart" valign="top" >
                                       
                                        <asp:DataGrid ID="grdVerification" runat="Server" AutoGenerateColumns="False" CssClass="GridTable"
                                            ...
                                            <Columns>   
                                                ...
                                                <asp:BoundColumn DataField="FLT_BILL_AMOUNT" HeaderText="Bill Amount" ItemStyle-HorizontalAlign="Right">
                                                 ...
                                                 <%--5--%>
                                                  <asp:BoundColumn DataField="FLT_RECEIVED_AMOUNT" HeaderText="Received" ItemStyle-HorizontalAlign="Right">
                                                </asp:BoundColumn>
                                                   <%--6--%>
