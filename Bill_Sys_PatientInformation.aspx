<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_PatientInformation.aspx.cs"
    Inherits="Bill_Sys_PatientInformation" %>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 156px">
                                                                                        <asp:TextBox ID="txtJobTitle" runat="Server" TextMode="MultiLine" 
                                                                                            Width="300px" MaxLength="54"  onkeyDown="return checkTextAreaMaxLength(this,event,'54');"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 156px">
                                                                                        <asp:TextBox ID="txtWorkActivities" runat="Server"  TextMode="MultiLine"
                                                                                            Width="300px" MaxLength="233" onkeyDown="return checkTextAreaMaxLength(this,event,'230');"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                    </td>
                                                                                    <td>
