...
/*File Name            :       Bill_Sys_ReferringDoctor.aspx.cs
...
public partial class Bill_Sys__Referring_Doctor : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        { 
            ...
            btnSave.Attributes.Add("onclick", "return Validator();");
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("Bill_Sys__Referring_Doctor.aspx");
        }
        #endregion
        //Method End
        using (Utils utility = new Utils())
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {       
                ...
                _saveOperation.Xml_File = "Doctor.xml";
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
                ...
                _editOperation.Xml_File = "Doctor.xml";
    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            _listOperation.Xml_File = "Doctor.xml";
    ...
    protected void grdDoctorNameList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            for (int i = 0; i < grdDoctorNameList.Columns.Count; i++)
            {
                string strtext = grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[i].Text;
            }
           ...
           // if (grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[4].Text != "&nbsp;") { extddlDoctorType.Text = grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[4].Text; }
            ...
            if (grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[32].Text != "&nbsp;")
            {
                extddlOffice.Text = grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[32].Text;
            }
            else
            {
            ...
            if (grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[31].Text != "&nbsp;") { extddlDoctorType.Text = grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[31].Text; }

            if (grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[7].Text != "&nbsp;") { txtAssignNumber.Text = grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[7].Text; } else { txtAssignNumber.Text = ""; }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            for (int i = 0; i < grdDoctorNameList.Items.Count; i++)
            {
                ...
                {
                    if (!_deleteOpeation.deleteRecord("SP_MST_DOCTOR", "@SZ_DOCTOR_ID", grdDoctorNameList.Items[i].Cells[0].Text, "REF_DELETE"))
                    {
                        if (szListOfDoctor == "")
                        {
