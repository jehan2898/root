<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_UserContactDetails.aspx.cs"
    Inherits="Bill_Sys_UserContactDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Go Green Bills</title>
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            if (document.getElementById('<%=txtEmail.ClientID%>').value == '') {
                ...
                alert('Please Select Email Phone');
                return false;
            } else {
                return true;
            }
                                                            ...
                                                            <td style="width: 50%; text-align: left;" colspan="2" >
                                                                ...
                                                                <td colspan="2">
                                                                 ...
                                                                 <div style="color:White;background:Black;"> <h4>
                                                                        Update Contact Details</h4></div>
                                                                </td>
                                                                </tr>
                                                                <tr class="userRow">
                                                                <td style="padding:3px" >   <asp:Label  CssClass="LabelCSS" runat="server" ID="lblUserName">User Name</asp:Label></td>
                                                                <td style="padding:3px" >   <asp:TextBox ID="txtUserName" runat="server" ReadOnly="true" placeholder="Enter UserName"></asp:TextBox></td>
                                                                </tr>

                                                                 <tr  class="userRow">
                                                                <td style="padding:3px" >  <asp:Label runat="server" CssClass="LabelCSS" ID="Label1">Email Address</asp:Label></td>
                                                                <td style="padding:3px" ><asp:TextBox ID="txtEmail" runat="server" placeholder="Enter Email"></asp:TextBox></td>
                                                                </tr>

                                                                <tr  class="userRow">
                                                                <td  style="padding:3px" > <asp:Label runat="server" CssClass="LabelCSS" ID="Label2"> Phone </asp:Label>  </td>
                                                                <td  style="padding:3px" ><asp:TextBox ID="txtPhone" runat="server" placeholder="Enter Phone"></asp:TextBox></td>
                                                                </tr>
                                                               
                                                                <tr> <td  style="padding:3px"></td> 
                                                                <td colspan="1" align="left"  style="padding:3px">
                                                                <asp:Button ID="btnSubmitDetail" runat="server" CssClass="loginButtonCSS" Text="Submit" OnClick="btnSubmitDetail_Click" />
                                                                </td>
