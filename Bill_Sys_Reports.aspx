<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_Reports.aspx.cs" Inherits="Bill_Sys_Reports" %>
...
- Carrier Reports
                                            ...
                                            <tr valign="top">
                                                ...
                                                <extddl:ExtendedDropDownList ID="extddlInsuranceCompany" runat="server" Width="255px" Connection_Key="Connection_String"
                                                        Flag_Key_Value="INSURANCE_LIST" Procedure_Name="SP_MST_INSURANCE_COMPANY" Selected_Text="---Select---" /></td> 
