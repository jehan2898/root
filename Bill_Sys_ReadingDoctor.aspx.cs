...
/*File Name            :       Bill_Sys_ReadingDoctor.aspx.cs
...
public partial class Bill_Sys_ReadingDoctor : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("Bill_Sys_ReadingDoctor.aspx");
        }
        #endregion
        //Method End
        using (Utils utility = new Utils())
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            txtIsOwner.Text = rdlstWorkType.SelectedValue.ToString();
            _saveOperation.WebPage = this.Page;
            _saveOperation.Xml_File = "READINGDOCTOR.xml";
            _saveOperation.SaveMethod();
            BindGrid();
            ClearControl();
            lblMsg.Visible = true;
            lblMsg.Text = "Doctor Saved Successfully ...!";
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            _editOperation.Xml_File = "READINGDOCTOR.xml";
            _editOperation.UpdateMethod();
            BindGrid();
            lblMsg.Visible = true;
            lblMsg.Text = "Doctor Updated Successfully ...!";
    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            _listOperation.Xml_File = "READINGDOCTOR.xml";
    ...
    protected void grdDoctorNameList_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            // if (grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[4].Text != "&nbsp;") { extddlDoctorType.Text = grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[4].Text; }
            ...
            if (grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[6].Text != "&nbsp;") { extddlProvider.Text = grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[6].Text; } else { extddlProvider.Text = ""; }
            ...
            if (grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[30].Text != "&nbsp;") { extddlDoctorType.Text = grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[30].Text; }

            if (grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[31].Text != "&nbsp;") { extddlOffice.Text = grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[31].Text; }
            ...
            int iColumncount = grdDoctorNameList.Columns.Count - 1;
        string val=     grdDoctorNameList.Items[grdDoctorNameList.SelectedIndex].Cells[iColumncount].Text;
       if (val == "&nbsp;" || val == "" || val == null || val == "False")
       {
           rdlstWorkType.SelectedIndex = 0;
       }else if(val=="True")
       {
           rdlstWorkType.SelectedIndex = 1;
       }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            for (int i = 0; i < grdDoctorNameList.Items.Count; i++)
            {
                ...
                {
                    if (!_deleteOpeation.deleteRecord("SP_MST_READINGDOCTOR", "@SZ_DOCTOR_ID", grdDoctorNameList.Items[i].Cells[1].Text))
                    {
                        if (szListOfDoctor == "")
                        {
