...
/*File Name            :       UserControl_CheckPageAutharizationAttorney.ascx.cs
/*Purpose              :       To Check Page Autharization according to User role 
/*Author               :       Rohit Kate
/*Date of creation     :       24 Dec 2015  
/*Modified By          :
/*Modified Date        :
/************************************************************/
using System;
...
public partial class UserControl_CheckPageAutharizationAttorney : System.Web.UI.UserControl
{
        ...
        try
        {
            ...
            if (Session["CASE_OBJECT"] != null)
            {
                ...
                else
                {
                    ...
                    {
                        //- add for attroney-//
                        if (((Bill_Sys_UserObject)(Session["USER_OBJECT"])).SZ_USER_ROLE_NAME.ToLower().Equals ("attorney"))
                        {
                            ...
                            // AJAX Pages/Bill_Sys_CaseDetails.aspx?CaseID=<%# DataBinder.Eval(Container,"DataItem.SZ_CASE_ID")%>&cmp=<%# DataBinder.Eval(Container,"DataItem.SZ_COMPANY_ID")%>'>
