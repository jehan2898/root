<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bill_Sys_Initial_followupReport.aspx.cs" Inherits="Bill_Sys_Initial_followupReport" Title="Untitled Page" %>                           
                                            ...
                                            <tr>
                                                <td class="ContentLabel" colspan="4">
                                                    ...
                                                    <asp:Button ID="btnSearch" runat="server" Text="Search" Width="80px" CssClass="Buttons" OnClick="btnSearch_Click"
                                                         /> &nbsp; <asp:Button id="Button1" runat="server" cssclass="Buttons" Text="Export To Excel" OnClick="btnExportToExcel_Click"  />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
