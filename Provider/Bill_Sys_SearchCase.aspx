<%@ Page Language="C#" MasterPageFile="~/Provider/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_SearchCase.aspx.cs" Inherits="Bill_Sys_SearchCase" Title="Untitled Page" %>
                                            ...
                                            <td colspan="3">
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <extddl:ExtendedDropDownList ID="extProvider" runat="server" Width="98%" Selected_Text="---Select---"
                                                                Procedure_Name="SP_GET_USER_OFFICE" Flag_Key_Value="OFFICE_LIST" Connection_Key="Connection_String"
                                                                AutoPost_back="True"
