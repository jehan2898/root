...
public partial class Bill_Sys_SearchCase : PageBase
{
    ...
    private void bindGrid()
    {
        ...
        patientSearchArr.Add(txtUserID.Text);
        patientSearchArr.Add(extProvider.Text);
        patientSearchArr.Add(txtPatientName.Text);
        patientSearchArr.Add(txtInsuranceCompany.Text);
    ...
    public DataSet GetPatientInfo(ArrayList searchArray)
    {
        ...
        try
        {
            ...
            if (searchArray[10].ToString() != "" && searchArray[10].ToString() != null && searchArray[10].ToString() != "NA")
            {
                comm.Parameters.AddWithValue("@SZ_USER_ID", searchArray[10].ToString());
            }
            if (searchArray[11].ToString() != "" && searchArray[11].ToString() != null && searchArray[11].ToString() != "NA")
            {
                comm.Parameters.AddWithValue("@SZ_USER_ID_SEACRH", searchArray[11].ToString());
            }
            if (searchArray[12].ToString() != "" && searchArray[12].ToString() != null && searchArray[12].ToString() != "NA")
            {
                comm.Parameters.AddWithValue("@SZ_PATIENT_NAME", searchArray[12].ToString());
            }
            if (searchArray[13].ToString() != "" && searchArray[13].ToString() != null && searchArray[13].ToString() != "NA")
            {
                comm.Parameters.AddWithValue("@SZ_INSURANCE_ID", searchArray[13].ToString());
            }
