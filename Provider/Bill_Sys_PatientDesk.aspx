<%@ Page Language="C#" MasterPageFile="~/Provider/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_PatientDesk.aspx.cs" Inherits="Provider_Bill_Sys_PatientDesk"
    Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript"> 
        ...
        {  
            ...
            location.href = "../Provider/Bill_Sys_BillSearch.aspx?fromCase=true&caseid="+CaseId+"&caseno="+CaseNo+"&cmpid="+cmpid; 
        } 
    </script>
    ...
    <script type="text/javascript"> 
        ...
        {  
            ...
            var CaseNo=document.getElementById("<%=hdnCaseNo.ClientID%>").value;
            var cmpid=document.getElementById("<%=hdnCompanyId.ClientID%>").value;
            location.href = "../Provider/Bill_Sys_CaseDetails.aspx?fromCase=true&caseid="+CaseId+"&caseno="+CaseNo+"&cmpid="+cmpid; 
        } 
                    ...
                    <table style="height: 100%; width: 100%;" border="0">
                        ...
                        <tr>
                            <td align="left" valign="top" class="txt2">
                                <asp:LinkButton ID="lnkviewbills" runat="server" OnClientClick="redirectbillsearch(); return false;">View Bills</asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" class="txt2">
                                <asp:LinkButton ID="lnkCaseInfo" runat="server" OnClientClick="redirectCaseInfo(); return false;">Case Info</asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" valign="top" class="txt2">
                                    ...
                                    <td style="width: 100%" class="TDPart">
                                        <asp:DataGrid ID="grdPatientList" Width="100%" CssClass="GridTable" runat="Server"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="SZ_PATIENT_NAME" HeaderText="Name" HeaderStyle-HorizontalAlign="center"
                                                    ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
                                                <asp:BoundColumn DataField="SZ_INSURANCE_NAME" HeaderText="Insurance Company" HeaderStyle-HorizontalAlign="center"
                                                    ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
                                                <asp:BoundColumn DataField="SZ_ATTORNEY_NAME" HeaderText="Attorney Company" HeaderStyle-HorizontalAlign="center"
                                                    ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>
                                                <asp:BoundColumn DataField="DT_ACCIDENT" HeaderText="Accident Date" ItemStyle-HorizontalAlign="center"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <ajaxToolkit:TabContainer ID="tabVistInformation" runat="Server" ActiveTabIndex="1">
                                            <ajaxToolkit:TabPanel runat="server" ID="tabpnlOne" Visible="False" TabIndex="1">
                                                <HeaderTemplate>
                                            ...
                                            <ajaxToolkit:TabPanel runat="server" ID="tabpnlTwo" TabIndex="1" Visible="False">
                                                <HeaderTemplate>
                                            ...
                                            <ajaxToolkit:TabPanel runat="server" ID="tabpnlThree" TabIndex="2" Visible="False">
                                                <HeaderTemplate>
...
--%>
                                            ...
                                            <ajaxToolkit:TabPanel runat="server" ID="tabpnlFour" TabIndex="3" Visible="False">
                                                <HeaderTemplate>
