<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturnToWorkC4_2.aspx.cs"
    Inherits="ReturnToWorkC4_2" %>
                                                ...
                                                <tr>
                                                    <td>
                                                        <ul style="font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                            <li><a href="PatientInformationC4_2.aspx">Patient Information </a></li>
                                                            <li><a href="DoctorsInformationC4_2.aspx">Doctor Information </a></li>
                                                            <li><a href="BillingInformationC4_2.aspx">Billing Information </a></li>
                                                            <li><a href="ExaminationandTreatmentC4_2.aspx">Examination and Treatment </a>
                                                            </li>
                                                            <li><a href="DoctorsOpinionC4_2.aspx">Doctor's Opinion </a></li>
                                                            <li><a href="ReturnToWorkC4_2.aspx">Return To Work </a>
                                                                <br />
                                                            </li>
                                                        </ul>
                                                    </td>
                                                            ...
                                                            <asp:ListItem Value="0">No</asp:ListItem>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3" style="height: 39px">
                                                                        <asp:TextBox ID="txtDescribeWorkRestriction" runat="server" Width="355px"></asp:TextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 56px">
                                                                    </td>
