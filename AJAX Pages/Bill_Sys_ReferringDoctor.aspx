<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_ReferringDoctor.aspx.cs" Inherits="AJAX_Pages_Bill_Sys_ReferringDoctor"
    Title="Green Your Bills-Referring Doctor" %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        ...
                                                        <cc1:ExtendedDropDownList ID="extddlOffice" runat="server" Width="83%" Selected_Text="--- Select ---"
                                                            Flag_Key_Value="OFFICE_LIST" Procedure_Name="SP_MST_OFFICE" Connection_Key="Connection_String">
                                            ...
                                            <img alt="" src="Images/Excel.jpg" style="border:none;"  height="15px" width ="15px" title = "Export TO Excel"/></asp:LinkButton>
                                                ...
                                                <td colspan="4" style="width:100%" >
                                                 ...
                                                 <xgrid:XGridViewControl ID="grdRffDoc" runat="server" Height="148px" Width="100%"
                                                                        ...
                                                                        XGridKey="Bill_Sys_Rff_Doc" GridLines="None" AllowPaging="true" AlternatingRowStyle-BackColor="#EEEEEE"
