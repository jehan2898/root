...
public partial class DoctorOpinion : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("DoctorOpinion.aspx");
        }
        #endregion
    }
    ...
    {//Logging Start
        ...
        try
        {
            if (_obj.CheckPatientExist("SP_MST_DOCTORS_OPINION", Session["PatientID"].ToString()) == false)
            {
                ...
                _saveOperation.Xml_File = "DoctorOpinion.xml";
            ...
            Response.Redirect("PlanOfCare.aspx", false);
    ...
    {//Logging Start
        ...
        try
        {
            ...
            _editOperation.Xml_File = "DoctorOpinion.xml";
