<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_BillTransaction_NoDiagnosys.aspx.cs" Inherits="Bill_Sys_BillTransaction_NoDiagnosys" %>
...
//         }
         ...
         function checkList()
         {
             var list = document.getElementById('ctl00_ContentPlaceHolder1_lstDiagnosisCodes');
       ...
       function CheckValidateAddToPrefredList()
	   {
		      var f= document.getElementById("<%=grdCompleteVisit.ClientID%>");
		        var bfFlag = false;	
		        for(var i=0; i<f.getElementsByTagName("input").length ;i++ )
		        {		
				  if(f.getElementsByTagName("input").item(i).name.indexOf('chkSelectItem') !=-1)
		            {
		        ...
		        if(bfFlag == false)
		        {
		        alert('Please Select Doctor From Grid.');
                                                            ...
                                                            <asp:Panel ID="dvcompletevisit" ScrollBars="Vertical" Style="height: 200px;" runat="server"
                                                                ...
                                                                <asp:DataGrid ID="grdCompleteVisit" runat="server" Width="96%" CssClass="mGrid" AutoGenerateColumns="false"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <%-- 11--%>
                                                                        <asp:TemplateColumn HeaderText="Include Limit" ItemStyle-HorizontalAlign="Center"
                                                                        ...
                                                                        <%-- 16--%>
                                                                        <asp:TemplateColumn HeaderText="Procedure Code Count" HeaderStyle-HorizontalAlign="Center">
                                                                            <ItemTemplate>
                                                                ...
                                                                <tr style="width: 100%">
                                                                    ...
                                                                    <td valign="top" width="30%">
                                                                        <table width="100%">
                                                                            <tr style="width: 100%">
                                                                                <td>
                                                                                    <asp:LinkButton ID="lnkAddDiagnosis" runat="server" Text="Add Diagnosis" Style="text-align: right;
                                                                                        font-size: 12px; vertical-align: top;"></asp:LinkButton>
                                                                            ...
                                                                            <tr style="width: 100%">
                                                                                <td>
                                                                                    <asp:LinkButton ID="lnkAddPreferedList" runat="server" Visible="False" Text="Add Preferred Diagnosis"
                                                                                        Style="text-align: right; font-size: 12px; vertical-align: top;"></asp:LinkButton>
                                                                                    <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="pnlAddPreferredListDiagnosisCode"
                                                                                        TargetControlID="lnkAddPreferedList" Drag="false" BackgroundCssClass="modalBackground"
                                                                                        CancelControlID="btnPreferredDiagnosisCodeClose">
                                                                                    </ajaxToolkit:ModalPopupExtender>
                                                                                </td>
                                                                            </tr>
                                                                            <tr style="width: 100%">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanelpnlShowNotes" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <div align="right" style="vertical-align: top;">
                                                    ...
                                                    <asp:Button ID="btnAddPreferedList" runat="server" Text="Preferred Services" CssClass="Buttons"
                                                        OnClick="btnAddPreferedList_Click" />
            ...
            <tr>
                <td valign="top" style="text-align: left;" class="ContentLabel">
                    <asp:RadioButtonList ID="rdbListPDFType" runat="server">
                        ...
                        <asp:ListItem Value="4" Text="OCT Report"></asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </tr>
            <tr>
    ...
    <asp:Panel ID="pnlAddPreferredListDiagnosisCode" runat="server" BackColor="white"
        Style="display: none;">
        <asp:UpdatePanel ID="upPreferredList" runat="server">
            <ContentTemplate>
                <table border="0" cellpadding="1" cellspacing="1" style="width: 100%; height: 100%">
                    <tr>
                        <td align="right">
                            <asp:Button ID="btnPreferredDiagnosisCodeClose" CssClass="Buttons" runat="server"
                                Text="X" OnClientClick="CloseDiagnosisCodePopup();" />
                            <%--      <a onclick="CloseDiagnosisCodePopup();" style="cursor: pointer;" title="Close">X</a>--%>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table border="0" class="ContentTable" style="width: 100%">
                                <tr runat="server" id="tr1">
                                    <td class="ContentLabel" style="width: 15%; height: 18px;">
                                        Diagnosis Type:</td>
                                    <td style="width: 35%; height: 18px;">
                                        <extddl:ExtendedDropDownList ID="extddlPreferredDiagnosisType" runat="server" Width="105px"
                                            Connection_Key="Connection_String" Procedure_Name="SP_MST_DIAGNOSIS_TYPE" Selected_Text="--- Select ---"
                                            Flag_Key_Value="DIAGNOSIS_TYPE_LIST"></extddl:ExtendedDropDownList>
                                    </td>
                                    <td class="ContentLabel" style="width: 15%; height: 18px;">
                                    ...
                                    <td style="width: 35%; height: 18px;">
                                        <asp:TextBox ID="txtPreferedCode" runat="server" Width="55px" MaxLength="50"></asp:TextBox>
                                    </td>
                                    <td class="ContentLabel" style="width: 15%; height: 18px;">
                                        Description :
                                    </td>
                                    <td style="width: 35%; height: 18px;">
                                        <asp:TextBox ID="txtPreferedDesc" runat="server" Width="110px" MaxLength="50"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="ContentLabel" colspan="6">
                                        <asp:Button ID="btnPreferredSearch" runat="server" Text="Search" Width="80px" CssClass="Buttons"
                                            OnClick="btnPreferredSearch_Click" />
                                        <asp:Button ID="btnAddPreferredDiagnosis" runat="server" Text="Add" Width="80px"
                                            CssClass="Buttons" OnClick="btnAddPreferredDiagnosis_Click" />&nbsp;
                                        <%--<asp:Button ID="btnCancel" runat="server" Text="Cancel" Width="80px"  cssclass="Buttons" OnClick="btnCancel_Click"/>--%>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="width: 100%" valign="top">
                            <div style="height: 200px; background-color: Gray; overflow-y: scroll;">
                                <asp:DataGrid ID="grdPreferredDiagonosisCode" runat="server" Width="99%" CssClass="GridTable"
                                    AutoGenerateColumns="false" AllowPaging="true" PageSize="10" PagerStyle-Mode="NumericPages"
                                    OnPageIndexChanged="grdPreferredDiagonosisCode_PageIndexChanged">
                                    <ItemStyle CssClass="GridRow" />
                                    <Columns>
                                        <asp:TemplateColumn>
                                            <ItemTemplate>
