<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_Lien_Attorney_Sign.aspx.cs" Inherits="AJAX_Pages_Bill_Sys_Lien_Attorney_Sign" %>
...
<!--
        ...
        function OnSave() {
            ...
            if (document.FORM1.SigPlusDoctor.NumberOfTabletPoints > 0) {
                ...
                parent.document.getElementById('divDocSignatureLien').style.visibility = 'hidden';
                parent.document.getElementById('divDocSignatureLien').style.zIndex = -1;
...
<body>
    <form id="FORM1" method="post" name="FORM1" action="Bill_Sys_Save_Lien_Sign.aspx?Sign=Provider" style="border-bottom:10px;">
        <h2>
            <center>
