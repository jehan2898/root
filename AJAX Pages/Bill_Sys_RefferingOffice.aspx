<%@ Page Title="Green Your Bills - Reffering Office" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bill_Sys_RefferingOffice.aspx.cs"
 Inherits="AJAX_Pages_Bill_Sys_RefferingOffice" %>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; width: 40%; text-align: right" align="right" colspan="2">
                                                        Record Count:<%= this.grdOfficeList.RecordCount%>
                                                        | Page Count:
                                                ...
                                                <tr>
                                                    <td style="width: 100%" colspan="4">
                                                        <xgrid:XGridViewControl ID="grdOfficeList" runat="server" Height="148px" Width="100%"
                                                            ...
                                                            XGridKey="Bill_Sys_mst_office_reff" GridLines="None" AllowPaging="true" AlternatingRowStyle-BackColor="#EEEEEE"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <%-- 5--%>
                                                                <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                     headertext="State" DataField="SZ_OFFICE_STATE_ID"  SortExpression="SZ_OFFICE_STATE_ID"/>
                                                                <%-- 6--%>
                                                                <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="left"
