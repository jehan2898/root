<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="EmployerCaseVisit.aspx.cs" Inherits="AJAX_Pages_EmplioyerCaseVisit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function popup_Closing_view(s, e) {
            IframeViewDoc.Hide();
            document.getElementById('<%= btnRefresh.ClientID %>').click();
        }

        function popup_Closing(s, e) {
            IFrame_DownloadFiles.Hide();
            document.getElementById('<%= btnRefresh.ClientID %>').click();
        }

    </script>
    <script type="text/javascript">
        function jfkvisitscan(caseid, visitid, caseno) {
            debugger;
            ScanJfkVisitDoc(caseid, visitid, caseno, 2);
        }
    </script>
    <script type="text/javascript">
        function showViewFrame(visitId) {
            var url = "ViewJfKDocs.aspx?visitId=" + visitId;

            IframeViewDoc.SetContentUrl(url);
            IframeViewDoc.Show();
            return false;
        }
        <%--function callScan(caseid, visitid,casno,patientname) {
               var cmpid = document.getElementById('<%= hdnCompanyID.ClientID %>').value;
               var cmpname = document.getElementById('<%= hdnCompanyName.ClientID %>').value;
               var uid = document.getElementById('<%= hdnUserID.ClientID %>').value;
               var uname = document.getElementById('<%= hdnUserName.ClientID %>').value;
               var url = document.getElementById('<%= hdnUrl.ClientID %>').value;
              
               var scanurl = url + 'CaseId=' + caseid + '&CompanyId=' + cmpid + '&CompanyName=' + cmpname + '&UserName=' + uname + '&UserId=' + uid + '&VisitID=' + visitid + "&Flag=JfkVisitDoc&CaseNo="+casno+"&PName="+patientname;               
               window.open(scanurl, 'Scan_Document', 'channelmode=no,location=no,toolbar=no,menubar=0,resizable=0,status=no,scrollbars=0, width=600,height=550');
           }--%>
    ...
    <%--<script type="text/javascript">
        $(document).ready(function () {
            $('.scanlbl').click(function () {
                ...
                caseid = dataArray[0];
                visitid = dataArray[1];
                var url = "UploadJFKVisitFiles.aspx?caseid=" + caseid + "&visitId=" + visitid;
...
"- or click and drag for faster selection.";
                ...
                if (document.getElementById('<%=txtdate.ClientID %>').value == "") {
                    ...
                    if (listBox.options.length > 0) {
                        ...
                        if (iFlag == 1) {
                            ...
                            alert('Please select the procedure code. ');
                        return false;
    ...
    <script>
        ...
        function confirm_visit_delete() {
            ...
            if (confirm("Are you sure want to Delete Visit?") == true) {
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
                    ...
                    <td style="padding-right: 3px; padding-left: 3px; padding-bottom: 3px; padding-top: 3px; vertical-align: top; width: 1500px;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" style="background-color: White; width: 100%;">
                            <tr>
                                <td></td>
                                <td valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0" style="background-color: White; width: 99%;">
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td style="width: 100%" valign="top">
                                                <table border="0" style="width: 100%; height: 171px">
                                                    <tr>
                                                        <td style="text-align: left; width: 550px;">
                                                            <table border="0" align="left" cellpadding="0" cellspacing="0" style="width: 40%; height: 250px; border: 1px solid #B5DF82;">
                                                                <tr>
                                                                    <td colspan="2" height="28" align="left" valign="middle" bgcolor="#B5DF82">
                                                                        <b class="txt3">Add Visits
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="td-widget-bc-search-desc-ch" style="text-align: left">Employer
                                                                    </td>
                                                                    <td class="style1">
                                                                        <extddl:ExtendedDropDownList ID="extddlEmployer" runat="server" Width="89.3%" Connection_Key="Connection_String"
                                                                            Flag_Key_Value="EMPLOYER_LIST" Procedure_Name="SP_MST_EMPLOYER_COMPANY" Selected_Text="---Select---"
                                                                            AutoPost_back="false" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="td-widget-bc-search-desc-ch" width="33%" style="text-align: left">Date
                                                                    </td>
                                                                    <td class="style1">
                                                                        <asp:TextBox ID="txtdate" runat="server" Width="74.6%" autocomplete="off" CssClass="search-input"
                                                                            Height="24px"></asp:TextBox><span style="color: #ff0000">*</span> <a id="trigger"
                                                                                href="#">
                                                                ...
                                                                <script type="text/javascript">
                                                                    ...
                                                                    function closed(cal) {
                                                                        ...
                                                                        el = document.getElementById("txtdate");
                                                                        el = document.getElementById("<%=txtdate.ClientID%>");
                                                                ...
                                                                <tr>
                                                                    <td class="td-widget-bc-search-desc-ch" style="text-align: left" width="33%">Procedure Code
                                                                    </td>
                                                                    <td class="style1">
                                                                        <%-- <asp:TextBox ID="TextBox3" runat="server"  Width="80%"  autocomplete="off" 
                                                                             CssClass="search-input" Height="25px"></asp:TextBox>--%>
                                                                        <asp:ListBox ID="lstProcedureCode" runat="server" Width="80%" Height="100px" SelectionMode="Multiple"></asp:ListBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
            ...
            <table id="First1" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: White; margin-top: 4px;">
                <tr>
                    <td align="right">
                        ...
                        <asp:Button Text="Delete Visit" ID="btnDeleteVisit" runat="server" OnClick="btnDeleteVisit_Click" />
                        &nbsp;&nbsp;&nbsp;
                    ...
                    <td style="width: 1200px">
                        <div style="height: 450px; overflow: scroll;">
                            <asp:DataGrid Width="100%" ID="grdVisits" CssClass="mGrid" runat="server"
                                AutoGenerateColumns="False" OnItemDataBound="grdVisits_ItemDataBound">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="EventAmount" DataFormatString="{0:c}" HeaderText="Visit Amount"
                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="SZ_INVOCE_NO" HeaderText="Invoice#" ItemStyle-HorizontalAlign="Center"
                                        HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="mn_invoice_amount" DataFormatString="{0:c}" HeaderText="Invoice Amount"
                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="INVOICE_DATE" HeaderText="Invoice Date" ItemStyle-HorizontalAlign="Center"
                                        HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Status" HeaderText="Bill Status" ItemStyle-HorizontalAlign="Center"
                                        HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    </asp:BoundColumn>
                                    <asp:TemplateColumn Visible="false">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkOpen" runat="server" CommandName="OpenPdf" CommandArgument="SZ_INVOCE_LINK"
                                                Font-Bold="true" Font-Size="12px">open</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:BoundColumn DataField="SZ_INVOCE_LINK" HeaderText="SZ_INVOCE_LINK Date" ItemStyle-HorizontalAlign="Center"
                                        Visible="false" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="bt_status" HeaderText="bt_status" ItemStyle-HorizontalAlign="Center"
                                        Visible="false" HeaderStyle-HorizontalAlign="Center">
                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                    </asp:BoundColumn>
                                    <asp:TemplateColumn>
                                        <ItemTemplate>
                                            ...
                                            <a id="caseDetailScan" href="#" runat="server" onclick='<%# "jfkvisitscan(" + "\""+ Eval("CASE_ID")+"\""+",\"" + Eval("VISIT_ID")  +"\""+ ",\""  + Eval("CASE_NO")  +"\""+ ");"%>'
                                                title="Scan/Upload">Scan/Upload</a>

                                            <%--<a id="caseDetailScan" href="#" runat="server" data-val='<%# Eval("CASE_ID")+","+ Eval("VISIT_ID") %>'
                                        title="Upload" class="lbl scanlbl">Upload</a>
                                        <a id="lnkScan"  runat="server" visible="true" href="#" onclick='<%# "callScan(" + "\""+ Eval("CASE_ID")  + "\","+ "\""+ Eval("VISIT_ID") + "\","+ "\""+ Eval("CASE_NO") + "\","+ "\""+ Eval("PATIENT_NAME")  +"\");" %>' >|Scan</a>--%>
                                            <a id="lnkView" runat="server" visible="true" href="#" onclick='<%# "showViewFrame(" + "\""+ Eval("VISIT_ID")  +"\");" %>'>|View</a>

                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:BoundColumn DataField="bt_has_document" HeaderText="bt_has_document" ItemStyle-HorizontalAlign="Left"
                                        HeaderStyle-HorizontalAlign="left" Visible="false">
                                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                                    </asp:BoundColumn>
    ...
    <dx:ASPxPopupControl ID="IFrame_DownloadFiles" runat="server" CloseAction="CloseButton"
        ...
        ClientInstanceName="IFrame_DownloadFiles" HeaderText="UploadFile" HeaderStyle-HorizontalAlign="Left"
        ...
        <ClientSideEvents CloseButtonClick="popup_Closing" />
    </dx:ASPxPopupControl>

    <dx:ASPxPopupControl ID="IframeViewDoc" runat="server" CloseAction="CloseButton"
        Modal="true" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter"
        ClientInstanceName="IframeViewDoc" HeaderText="View" HeaderStyle-HorizontalAlign="Left"
        HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#000000" AllowDragging="True"
        EnableAnimation="False" EnableViewState="True" Width="600px" ToolTip="Download File(s)"
        PopupHorizontalOffset="0" PopupVerticalOffset="0" AutoUpdatePosition="true"
        ...
        <ClientSideEvents CloseButtonClick="popup_Closing_view" />
    </dx:ASPxPopupControl>

    <div id="dialog" style="overflow: hidden;">
        <iframe id="scanIframe" frameborder="0" scrolling="no"></iframe>
    </div>
