<%@ page language="C#" autoeventwireup="true" masterpagefile="~/MasterPage.master"  CodeFile="Bill_Sys_ReCaseDetails.aspx.cs" inherits="Bill_Sys_ReCaseDetails" title="Green Your Bills - Workarea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <tr>
                                                ...
                                                <td align="right" width="65%">
                                                    ...
                                                    <ajaxToolkit:PopupControlExtender ID="PopEx" runat="server" TargetControlID="hlnkShowNotes"
                                                        PopupControlID="pnlShowNotes" Position="Center" OffsetX="-600" OffsetY="-10" />
                                                         <ajaxToolkit:PopupControlExtender ID="PopupControlExtender1" runat="server" TargetControlID="acase"
                       ...
                       <asp:LinkButton ID="hlnkPatientDesk" runat="server"   OnClick="hlnkPatientDesk_Click" >Patient Desk</asp:LinkButton>--%>
                                                    <ajaxToolkit:TabContainer ID="tabcontainerPatientEntry" runat="Server" ActiveTabIndex="0"
                                                        >
                                                        <ajaxToolkit:TabPanel runat="server" ID="tabPnlViewAll" TabIndex="6" Height="1000px">
                                                            <HeaderTemplate>
                                                                            ...
                                                                            <td colspan="4" rowspan="2">
                                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                    <tr>
                                                                                        <td width="25%" style="height: 16px">
                                                                                            <span class="tablecellControl">
                                                                                                <%--<asp:CheckBox ID="ChkBoxSingle" runat="server" />Single
                                                                                            <asp:CheckBox ID="ChkBoxMarried" runat="server" />Married
                                                                                            <asp:CheckBox ID="ChkBoxOther" runat="server" />Other
                                                                                            <asp:CheckBox ID="ChkBoxEmployeed" runat="server" />Employed<br />
                                                                                            <asp:CheckBox ID="ChkBoxFullTime" runat="server" />Full-Time Student
                                                                                            <asp:CheckBox ID="ChkBoxPartTime" runat="server" />Part-Time Student--%>
                                        ...
                                        <ajaxToolkit:TabPanel runat="server" ID="tabpnlInsuranceInformation" TabIndex="2">
                                            ...
                                            <contenttemplate>
                                                                <div align="left" style="height: 600px;">
                                                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
                                                                        <!-- Start : Data Entry -->
                                                                        <tr>
                                                                            <td class="tablecellLabel">
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                &nbsp; <a id="lnkSearchInsuranceCompany" href="#" runat="server" title="Search Insurance Company"
                                                                                    class="td-PatientInfo-lf-desc-ch" >Search Insurance Company</a>
                                                                                    <%--Nirmalkumar--%>
                                        ...
                                        <ajaxToolkit:TabPanel runat="server" ID="tabpnlAcciInfo" TabIndex="5" Visible="false">
                                            ...
                                            <contenttemplate>
                                                            ...
                                                            <ajaxToolkit:TabPanel runat="server" ID="tabpnlAttorneyInformation" TabIndex="6">
                                            <headertemplate>
                                                                <div style="width: 120px;" class="lbl">
                    ...
                    <tr>
                        <td style="width: 100%">
                            <div align="left" style="vertical-align: top;">
                                <div style="float: left; padding-right: 200px; text-indent: 10px;" class="td-PatientInfo-lf-desc-ch">
                                    Note Details</div>
   ...
   <div style="border-right: silver 1px solid; border-top: silver 1px solid; left: 119px;
        ...
        <ajaxToolkit:ModalPopupExtender ID="mp2" runat="server" TargetControlID="lb_1"
   ...
   <asp:UpdatePanel ID="UpdatePanelAtt" runat="server">
        <ContentTemplate>
         ...
         <ajaxToolkit:ModalPopupExtender ID="mp3" runat="server" TargetControlID="lbl_2"
     ...
     <table align="center" style="width:500px;height:300px; background-color:White;">
        ...
        <ajaxToolkit:ModalPopupExtender ID="ModalPopupaduster" runat="server" TargetControlID="lb_10"
            ...
            <td class="ContentLabel" style="width: 15%" colspan="3">
                 ...
                 <tr>
                    <td class="ContentLabel" style="width: 15%">
                       Adjuster Name:</td>
                    <td style="width: 35%">
                       <asp:TextBox ID="txtAdjusterPopupName1" runat="Server" autocomplete="off"   AutoPostBack="true"/></td>
                    <td class="ContentLabel" style="width: 15%">
                        Phone Number:</td>
                    <td style="width: 35%">
