...
public partial class PatientInformation : PageBase
{
    ...
    {//Logging Start
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("PatientInformation.aspx");
        }
        #endregion
        //Method End
    ...
    {//Logging Start
        ...
        try
        {
            ...
            _editOperation.Xml_File = "PatientInformation_MasterBilling.xml";
    ...
    protected void btnSaveAndGoToNext_Click(object sender, EventArgs e)
    {
        ...
        {
            UpdateData();
            Response.Redirect("WorkerTemplate.aspx", false);
        }
        catch (Exception ex)
        {
            Elmah.ErrorSignal.FromCurrentContext().Raise(ex);
