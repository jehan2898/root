                                ...
                                <tr>
                                    <td style="width: 100%" class="TDPart">
                                      <table style="width: 100%">
                                        ...
                                        <tr>
                                            <td style="width: 100%">
                                                <asp:DataGrid ID="grdBillReportDetails" AutoGenerateColumns="false" runat="server" Width="100%" CssClass="GridTable" OnItemCommand="grdBillReportDetails_ItemCommand" >
