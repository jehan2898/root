...
public partial class AJAX_Pages_Bill_Sys_Reminder_Pop_UP : PageBase
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        btnDismissAccount.Attributes.Add("onclick", "return ValidateAccountText();");
    }
    ...
    public void LoadGrid()
    {
        ...
        try
        {
            ...
            if (addReminder.Tables[0].Rows.Count > 0)
            {
                lblAccountResult.Visible = false;
                grdaccountreminder.DataSource = null;
                grdaccountreminder.DataBind();
                grdaccountreminder.DataSource = addReminder.Tables[0];
                grdaccountreminder.DataBind();
                lblDisReasonacoount.Visible = true;
                lblAccountReminder.Visible = true;
                btnDismissAccount.Visible = true;
                txtDismissAccountReason.Visible = true;

            }
            else
            {
                divAccount_reminder.Visible = false;
            }
