<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Invoice_Storage_generate_popup.aspx.cs"
    Inherits="AJAX_Pages_Invoice_Storage_generate_popup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server" id="framehead">
    <title>Storage Invoice POPUP</title>
    <link href="Css/mainmaster.css" rel="stylesheet" type="text/css" />
    <link href="Css/UI.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
        <asp:DataGrid ID="grdstoragegenerate" runat="server" Width="100%" AutoGenerateColumns="false"
