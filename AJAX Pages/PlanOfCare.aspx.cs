...
using Componend;
public partial class PlanOfCare : PageBase
{
    ...
    {//Logging Start
        ...
        try
        {
            ...
            SaveAssistiveDevice();
            Response.Redirect("WorkStatus.aspx", false);
            if (rdlstTreatmentGuidelines.SelectedValue.ToString() == "1")
            {
    ...
    {//Logging Start
        ...
        try
        {
            ...
            _saveOperation.WebPage = this.Page;
            _saveOperation.Xml_File = "PlanOfCareTransaction.xml";
    ...
    {//Logging Start
        ...
        try
        {
            ...
            _saveOperation.WebPage = this.Page;
            _saveOperation.Xml_File = "AssistiveDeviceDetails.xml";
    ...
    {//Logging Start
        ...
        try
        {
            _workerstemplate.DeletePlanOfCareDetails(txtPlanofCareID.Text, "SP_TXN_TEST_REFERRAL_TRANSACTION");
        }
        catch (Exception ex)
        {
            Elmah.ErrorSignal.FromCurrentContext().Raise(ex);
    ...
    {//Logging Start
        ...
        try
        {
            _workerstemplate.DeletePlanOfCareDetails(txtPlanofCareID.Text, "SP_TXN_PATIENT_ASSISTIVE_DEVICE");
        }
        catch (Exception ex)
        {
            Elmah.ErrorSignal.FromCurrentContext().Raise(ex);
    ...
    {//Logging Start
        ...
        try
        {
            if (rdlstPatientNeedDiagnosisTest.SelectedValue == "0")
            {
                ...
                _objDataSet = _workerstemplate.GetTestTransactionDetailList(txtPlanofCareID.Text);
                LoadCheckBoxAndTextBox(_objDataSet);
            }
            _workerstemplate = new workers_templateC4_2();
            _objDataSet = new DataSet();
            _objDataSet = _workerstemplate.GetAssistiveDeviceDetailList(txtPlanofCareID.Text);
            LoadCheckBoxAndTextBox(_objDataSet);
        }
        catch (Exception ex)
        {
