<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_PrintTreatmentRecords.aspx.cs" Inherits="Bill_Sys_PatientList" Title="Green Your Bills - Patient List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
           ...
           for (var i = 0; i < f.getElementsByTagName("input").length ; i++) {
               if (f.getElementsByTagName("input").item(i).type == "checkbox") {
                   if (f.getElementsByTagName("input").item(i).checked != false) {
                       ...
                       if (confirm("You are about to print the treatment records for all the selected patients. Do you want to continue? [Ok/Cancel]"))
                           return true;
                       return false;
                   }
               }
                    ...
                    <tr>
                        ...
                        <td>
                                    ...
                                    <td colspan="4">
                                        <table>
                                            <tr>
                                                ...
                                                <td class="td-widget-bc-search-desc-ch1" style="width:27%">
                                                    Case Status
                                                </td>
                                                <td class="td-widget-bc-search-desc-ch1" style="width:28%">
                                                    Patient
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-widget-bc-search-desc-ch3">
                                                    <asp:TextBox ID="txtPatientName" runat="server" Width="160%" autocomplete="off" CssClass="search-input"></asp:TextBox>
                                    ...
                                    <td colspan="4">
                                        <table>
                                            <tr>
                                                ...
                                                <td class="td-widget-bc-search-desc-ch1" style="width:29%">
                                                    Insurance
                                                </td>
                                                <td class="td-widget-bc-search-desc-ch1" style="width:27%">
                                                    Claim Number
                                                </td>
                                                <td class="td-widget-bc-search-desc-ch1" style="width:27%; visibility:hidden">
                                                    SSN#
                                                </td>
                                                <td class="td-widget-bc-search-desc-ch1" valign="top" style="width:30%">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-widget-bc-search-desc-ch3">
                                                    <asp:TextBox ID="txtInsuranceCompany" runat="server" Width="95%" autocomplete="off"
                                                ...
                                                <td class="td-widget-bc-search-desc-ch3" valign="top">
                                                    <asp:TextBox ID="txtChartNo" runat="server" Width="165%"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td class="td-widget-bc-search-desc-ch1" style="width:27%">
                                                 ...
                                                 <td class="td-widget-bc-search-desc-ch1" valign="top" style="width:29%">
                                                    <asp:Label ID="lblLocation" runat="server" Text="Location" class="td-widget-bc-search-desc-ch1"></asp:Label>
                                                </td>
                                                <td class="td-widget-bc-search-desc-ch1" valign="top" style="width:26%">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-widget-bc-search-desc-ch3" valign="top">
                                                    <asp:TextBox ID="txtDateofBirth" onkeypress="return CheckForInteger(event,'/')" runat="server"
                                                        MaxLength="10" Width="80%" CssClass="search-input"></asp:TextBox>
                                                    <asp:ImageButton ID="imgbtnDateofBirth" runat="server" ImageUrl="~/Images/cal.gif"
                                                        valign="bottom"></asp:ImageButton>
                                                </td>
                                                 <td class="td-widget-bc-search-desc-ch3" valign="top">
                                                    <extddl:ExtendedDropDownList ID="extddlLocation" runat="server" Width="98%" Selected_Text="---Select---"
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" style="width: 800px;
                                ...
                                <tr>
                                    <td height="28" align="left" valign="middle" bgcolor="#B5DF82" class="txt2" colspan="2">
                                        <b class="txt3">Print Treatment Records</b>
                                    </td>
                                    <td ></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <table width="100%" style="text-align:center">
                                            <tr>
                                                <td class="td-widget-bc-search-desc-ch1" style="width:30%">
                                                    Start Date
                                                </td>
                                                <td class="td-widget-bc-search-desc-ch1" style="width:30%">
                                                    End Date
                                            ...
                                            <tr>
                                                <td class="td-widget-bc-search-desc-ch3" valign="top">
                                                    <asp:TextBox ID="txtStartDate" onkeypress="return CheckForInteger(event,'/')"
                                                        runat="server" MaxLength="10" Width="86%" CssClass="search-input"></asp:TextBox>
                                                    <asp:ImageButton ID="imgBtnStartDate" runat="server" ImageUrl="~/Images/cal.gif"
                                                        valign="bottom"></asp:ImageButton>
                                                </td>
                                                <td class="td-widget-bc-search-desc-ch3" valign="top">
                                                    <asp:TextBox ID="txtEndDate" onkeypress="return CheckForInteger(event,'/')" runat="server"
                                                        MaxLength="10" Width="86%" CssClass="search-input"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-widget-bc-search-desc-ch3" valign="bottom">
                                                    ...
                                                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender3" runat="server" Mask="99/99/9999"
                                                        MaskType="Date" TargetControlID="txtStartDate" PromptCharacter="_" AutoComplete="true">
                                                    </ajaxToolkit:MaskedEditExtender>
                                                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator3" runat="server" ControlExtender="MaskedEditExtender1"
                                                        ...
                                                        IsValidEmpty="True" TooltipMessage="Input a Date" Visible="true"></ajaxToolkit:MaskedEditValidator>
                                                    <asp:RangeValidator runat="server" ID="RangeValidator1" ControlToValidate="txtDateofAccident"
                                                        Type="Date" MinimumValue="01/01/1901" MaximumValue="12/31/2099" ErrorMessage="Enter a valid date " />
                                                    <asp:RequiredFieldValidator runat="server" ID="reqStartDateValidator" ValidationGroup="Submit" 
                                                        ControlToValidate="txtStartDate" SetFocusOnError="true" ErrorMessage="End Date is Required">
                                                ...
                                                <td class="td-widget-bc-search-desc-ch3" valign="bottom">
                                                    ...
                                                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender4" runat="server" Mask="99/99/9999"
                                                        MaskType="Date" TargetControlID="txtEndDate" PromptCharacter="_" AutoComplete="true">
                                                    </ajaxToolkit:MaskedEditExtender>
                                                    <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator4" runat="server" ControlExtender="MaskedEditExtender2"
                                                        ...
                                                        IsValidEmpty="True" TooltipMessage="Input a Date" Visible="true"></ajaxToolkit:MaskedEditValidator>
                                                    <asp:RangeValidator runat="server" ID="RangeValidator2" ControlToValidate="txtDateofBirth"
                                                        Type="Date" MinimumValue="01/01/1901" MaximumValue="12/31/2099" ErrorMessage="Enter a valid date " />
                                                    <asp:RequiredFieldValidator runat="server" ID="reqEndDateValidator" ValidationGroup="Submit" 
                                                        ControlToValidate="txtEndDate" SetFocusOnError="true" ErrorMessage="End Date is Required">
                                                    </asp:RequiredFieldValidator>
                                                </td>
                                                <td></td>
                                            </tr>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                            <ContentTemplate>
                                                <asp:Button ID="btnPrinTreatmentDetails" ValidationGroup="Submit" OnClick="btnPrinTreatmentDetails_Click" runat="server" Visible="true"
                                            Text="Print Treatment Records"></asp:Button>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <td>
                                    <xgrid:XGridViewControl ID="grdPatientList" runat="server" Width="100%" CssClass="mGrid"
                                        DataKeyNames="SZ_PATIENT_ID,SZ_CASE_ID,SZ_COMPANY_ID,SZ_CASE_NO,SZ_RECASE_NO,BT_DELETE" MouseOverColor="0, 153, 153"
                                        ...
                                        AllowSorting="true" AutoGenerateColumns="false" OnRowCommand="grdPatientList_RowCommand"
                                        GridLines="None">
                                        <Columns>
                                            <%--0--%>
    ...
    <dx:ASPxPopupControl 
        ...
        PopupVerticalOffset="0"   AutoUpdatePosition="true" ScrollBars="Auto"
        RenderIFrameForPopupElements="Default" Height="250px">
        <ContentStyle>
            <Paddings PaddingBottom="5px" />
        </ContentStyle>
    </dx:ASPxPopupControl>
