<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_AOB_Provider_Sign.aspx.cs" Inherits="AJAX_Pages_Bill_Sys_AOB_Provider_Sign" %>
...
<!--
    ...
    function OnSave() {
        ...
        if (document.FORM1.SigPlusDoctor.NumberOfTabletPoints > 0) {
            ...
            parent.document.getElementById('divDocSignatureAob').style.visibility = 'hidden';
            parent.document.getElementById('divDocSignatureAob').style.zIndex = -1;
...
<body>
    <form id="FORM1" method="post" name="FORM1" action="Bill_Sys_Save_AOB_Sign.aspx?Sign=Provider" style="border-bottom:10px;">
        <h2>
            <center>
