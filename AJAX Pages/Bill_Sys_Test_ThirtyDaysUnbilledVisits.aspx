<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_Test_ThirtyDaysUnbilledVisits.aspx.cs" Inherits="Bill_Sys_Test_ThirtyDaysUnbilledVisits"
    Title="Untitled Page" %>
            ...
            <tbody>
                <tr>
                    <td style="padding-right: 3px; padding-left: 3px; padding-bottom: 3px; vertical-align: top;
                        ...
                        <table style="width: 100%; height: 100%" id="MainBodyTable" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    <td class="LeftTop">
                                    </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td width="100%" class="TDPart">
                                                        <table width="100%" style="width: 100%" class="ContentTable" cellspacing="0" cellpadding="3"
                                                            border="0" id="TABLE1">
                                                            <tbody>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td style="height: 19px" class="lbl" colspan="1" align="left">
                                                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                            <ContentTemplate>
                                                                                <b>Total Count:</b> &nbsp;
                                                                                <asp:Label ID="lblCount" runat="server"></asp:Label></ContentTemplate>
                                                                        </asp:UpdatePanel>
                                                                    </td>
                                                                    <td colspan="5">
                                                        ...
                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                            <ContentTemplate>
                                                                <div style="overflow: scroll; height: 600px">
                                                                    <asp:DataGrid ID="grd30DaysReport" runat="server" Width="100%" CssClass="GridTable"
                                                                        AutoGenerateColumns="false" OnItemCommand="grd30DaysReport_ItemCommand">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" />
                                                                    ...
                                                                    <a href="#" onclick="javascript:OpenPopUPDisplayDiagCode('<%# DataBinder.Eval(Container,"DataItem.CASE_ID")%>','<%# DataBinder.Eval(Container,"DataItem.SPECIALIYT")%>')">                                                                                Show(<%# DataBinder.Eval(Container,"DataItem.DIAG COUNT")%>)</a>--%>
                                                                            ...
                                                                            <%-- 30--%>
                                                                            <asp:BoundColumn DataField="SPECIALIYT_CODE" HeaderText="SPECIALITY Code" Visible="false">
                                                                            </asp:BoundColumn>
                                                                            <asp:BoundColumn DataField="BT_INS_CLAIM" HeaderText="INS CLAIM" Visible="false"></asp:BoundColumn>
                                                ...
                                                <tr>
                                                    <td class="TDPart" style="width: 100%">
                                                        <ajaxToolkit:CalendarExtender ID="calExtFromDate" runat="server" PopupButtonID="imgbtnFromDate"
                                                            TargetControlID="txtFromDate">
                                                        </ajaxToolkit:CalendarExtender>
                                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="imgbtnToDate"
