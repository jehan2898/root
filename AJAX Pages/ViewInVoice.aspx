<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ViewInVoice.aspx.cs" Inherits="AJAX_Pages_ViewInVoice" %>
                                                                        ...
                                                                        <td style="width: 40%; height: 0px;" align="center">
                                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; border-right: 1px solid #B5DF82;
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtCaseNo" runat="server" Width="94%"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                            ...
                                                                            <Columns>
                                                                               ...
                                                                               <asp:TemplateColumn>
                                                                                ...
                                                                                Font-Bold="true" Font-Size="12px">open</asp:LinkButton>
                                                                                 ...
                                                                                 <asp:BoundColumn DataField="SZ_INVOCE_LINK" HeaderText="SZ_INVOCE_LINK Date" ItemStyle-HorizontalAlign="Center" Visible="false"
                                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                                </asp:BoundColumn>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="width: 50%; height: 20px">
                                                    ...
                                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtToDate"
                                                        ...
                                                        MaskType="Date" TargetControlID="txtInvoceFromDate" PromptCharacter="_" AutoComplete="true">
                                                    </ajaxToolkit:MaskedEditExtender>
                                                    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender4" runat="server" Mask="99/99/9999"
                                                        MaskType="Date" TargetControlID="txtInvoceToDate" PromptCharacter="_" AutoComplete="true">
                                                    </ajaxToolkit:MaskedEditExtender>
