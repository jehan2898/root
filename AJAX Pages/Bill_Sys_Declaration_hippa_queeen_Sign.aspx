<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_Declaration_hippa_queeen_Sign.aspx.cs"
    Inherits="AJAX_Pages_Bill_Sys_Declaration_hippa_queeen_Sign" %>
...
function OnSave() {
    ...
    {     
       ...
       parent.document.getElementById('divPatientSignatureDCHQ').style.visibility='hidden';
       parent.document.getElementById('divPatientSignatureDCHQ').style.zIndex = -1;  
   }
   else
   {
...
<body>
    <form id="FORM2" method="post" name="FORM2" action="Bill_Sys_Save_Dec_Hippa_Patient_Guarantor_Sign.aspx?Sign=Patient">
        <h2>
            <center>
