...
public partial class AJAX_Pages_Dignosis_Code_Popup : PageBase
{
    ...
    //private DataTable SelectDiagnosisLookup()
    //{
    //    this._digosisCodeBO = new Bill_Sys_DigosisCodeBO();
    //    DataTable dtCodes = new DataTable();
    //    try
    //    {
    //        dtCodes = this._digosisCodeBO.GetDignosisCodesDesc(this.txtCompanyID.Text);
    //    }
