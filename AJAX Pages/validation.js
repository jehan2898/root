		...
		// ------ Accept Numeric from '0' to '9' Only ----------		
			...
			{	
				    ...
				    for (var iLoop=0; iLoop < stringArray.length ; iLoop++)
				    {
					    ...
					    var strCurrElement ='ctl00$ContentPlaceHolder1$' + stringArray[iLoop];				
...
function ConfirmPassword()
{
 ...
 function openTypePage(obj)
       {
            ...
            document.getElementById('divpatientID').style.zIndex = 1;   
            document.getElementById('divpatientID').style.position='absolute';  
           
            document.getElementById('divpatientID').style.position = 'absolute'; 
            document.getElementById('divpatientID').style.left= '150px'; 
            document.getElementById('divpatientID').style.top= '200px'; 
            document.getElementById('divpatientID').style.visibility='visible'; 
            document.getElementById('framepatientDesk').style.visibility='visible';  
            if(obj!='a')
            {           
                document.getElementById('framepatientDesk').src="Bill_Sys_UpgradePatient.aspx?PatientFlag="+ obj;                        
            }
            else
            {               
                document.getElementById('framepatientDesk').src="Bill_Sys_UpgradePatient.aspx?PatientFlag="+ obj;                      
 ...
 {
    document.getElementById('divpatientID').style.visibility='hidden';
    document.getElementById('framepatientDesk').src='';
    document.getElementById('framepatientDesk').style.visibility='hidden';
 }
 ...
 function ShowDiv()
	...
	/* function PopupformValidator(ID,strElements,errordiv)
			{	
				    ...
				    for (var iLoop=0; iLoop < stringArray.length ; iLoop++)
				    {
					    ...
					    var strCurrElement ='_ctl0:ContentPlaceHolder1:' + stringArray[iLoop];				
						    ...
						    if(strCurrElement == element_name)			
						    {
							    ...
							    {											
								    ...
								    {	
								       ...
								       document.getElementById(errormsg).innerHTML='Enter the mandatory field';							
									    theElement.focus();
									    theElement.style.backgroundColor = "#ffff99";
									    return false;
								    }
...
*/
	...
	function PopupformValidator(ID,strElements,ErroDivName)
			{	
						    ...
						    if(strCurrElement == element_name)			
						    {
							    ...
							    {											
								    ...
								    {	
								       ...
								       document.getElementById(ErroDivName).innerHTML='Enter the mandatory field';							
									    theElement.focus();
									    theElement.style.backgroundColor = "#ffff99";
									    return false;
								    }
							    ...
							    if(ID=='frmRegistration')
							    {
                                   ...
                                   {
                                         document.getElementById(ErroDivName).innerHTML='Password Do not match..!';                                       
                                         return false;
                                   }
							    }
							    // Check Radio buttons ...
