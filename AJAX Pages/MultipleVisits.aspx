<%@ Page Language="C#" culture="en-US" AutoEventWireup="true" masterpagefile="~/MasterPage.master" CodeFile="MultipleVisits.aspx.cs" Inherits="MultipleVisits" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 0px;"
                                            ...
                                            <tr>
                                                <td style="vertical-align: middle; text-align: center; height: 40px;" colspan="2">
                                                    <asp:Label ID="lblNote" Text="* Enter comma separated case-numbers. Note: Patients only in 'OPEN' case status will appear if 'Active' patients is selected."
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; vertical-align: top;"
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-widget-bc-search-desc-ch" style="height: 18px; width: 60%; text-align: left;">
                                                    ...
                                                    <ajaxcontrol:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="imgbtnAppointdate"
