...
CodeFile="UnfinalizedVisit.aspx.cs" Inherits="AJAX_Pages_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Clear() {
            ...
            document.getElementById('ctl00_ContentPlaceHolder1_extddlDoctorName').value = "NA";
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 40%; height: 0px;" align="center">
                                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; border-right: 1px solid #B5DF82;
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <extddl:ExtendedDropDownList ID="extddlCaseType" runat="server" Width="95%" Connection_Key="Connection_String"
                                                                                            Flag_Key_Value="CASETYPE_LIST" Procedure_Name="SP_MST_CASE_TYPE" Selected_Text="---Select---" />
                                                                                    </td>
                                                                                    <td>
                                                                                        <extddl:ExtendedDropDownList ID="extddlDoctorName" runat="server" Width="90%" Procedure_Name="SP_GET_DOCTOR_SPECIALTY_FOR_UNFINALIZED_VISIT"
                                                                                            Flag_Key_Value="DOCTOR_LIST" Connection_Key="Connection_String" />
                                                                                    </td>
                                                                                    <td>
                                                                                        <extddl:ExtendedDropDownList ID="extddlSpeciality" runat="server" Width="95%" Procedure_Name="SP_GET_DOCTOR_SPECIALTY_FOR_UNFINALIZED_VISIT"
                                                                                            Flag_Key_Value="SPECIALTY_LIST" Connection_Key="Connection_String" />
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="td-widget-bc-search-desc-ch">
                                                                                    ...
                                                                                    <td colspan="4" style="vertical-align: middle; text-align: center">
                                                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                                                            <ContentTemplate>
                                                                                                ...
                                                                                                &nbsp;
                                                                                                <asp:Button Style="width: 80px" ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click">
                                                                                                </asp:Button>
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td style="vertical-align: middle; width: 40%; text-align: right" align="right" colspan="2">
                                                                                    Record Count:<%= this.grdvisits.RecordCount%>| Page Count:
                                                                                    <gridpagination:XGridPaginationDropDown ID="con" runat="server">
                                                                                    </gridpagination:XGridPaginationDropDown>
                                                                                    <asp:LinkButton ID="lnkExportToExcel" OnClick="lnkExportTOExcel_onclick" runat="server"
                                                                                        Text="Export TO Excel"> <img alt="" src="Images/Excel.jpg" style="border:none;"  height="15px" width ="15px" title = "Export TO Excel"/></asp:LinkButton>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                    <xgrid:XGridViewControl ID="grdvisits" runat="server" Height="148px" Width="100%"
                                                                        CssClass="mGrid" AllowSorting="true" PagerStyle-CssClass="pgr" PageRowCount="50"
                                                                        DataKeyNames="" XGridKey="UnfinalizedVisit" GridLines="None" AllowPaging="true"
                                                                        AlternatingRowStyle-BackColor="#EEEEEE" HeaderStyle-CssClass="GridViewHeader"
                                                                        ContextMenuID="ContextMenu1" EnableRowClick="false" ShowExcelTableBorder="true"
                                                                        ExcelFileNamePrefix="BillSearch" MouseOverColor="0, 153, 153" AutoGenerateColumns="false"
                                                                        ExportToExcelColumnNames="Case#,Patient Name,Date Of Visit,Visit Type,Doctor Name,Case Type,Specialty,No of Days,Insurance Company,Claim Number"
                                                                        ExportToExcelFields="CASE_NO,PATIENT_NAME,VISIT_DATE,VISIT_TYPE,SZ_DOCTOR_NAME,CASE_TYPE,SPECIALTY,NOD,SZ_INSURANCE_NAME,SZ_CLAIM_NUMBER">
                                                                        <HeaderStyle CssClass="GridViewHeader"></HeaderStyle>
                                                                        <PagerStyle CssClass="pgr"></PagerStyle>
                                                                        <AlternatingRowStyle BackColor="#EEEEEE"></AlternatingRowStyle>
                                                                        <Columns>
                                                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                                SortExpression="CONVERT(INT,MST_CASE_MASTER.SZ_CASE_NO)" HeaderText="Case #" DataField="CASE_NO" />
                                                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                                SortExpression="MST_PATIENT.SZ_PATIENT_FIRST_NAME" HeaderText="Patient Name" DataField="PATIENT_NAME" />
                                                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                                SortExpression="TXN_CALENDAR_EVENT.DT_EVENT_DATE" HeaderText="Date Of Visit" DataField="VISIT_DATE" />
                                                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                                SortExpression="MST_VISIT_TYPE.VISIT_TYPE" HeaderText="Visit Type" DataField="VISIT_TYPE" />
                                                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                                SortExpression="MST_DOCTOR.SZ_DOCTOR_NAME" HeaderText="Doctor Name" DataField="SZ_DOCTOR_NAME" />
                                                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                                SortExpression="MST_CASE_TYPE.SZ_CASE_TYPE_NAME" HeaderText="Case Type" DataField="CASE_TYPE" />
                                                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                                SortExpression="MST_PROCEDURE_GROUP.SZ_PROCEDURE_GROUP" HeaderText="Specialty" DataField="SPECIALTY" />
                                                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                                HeaderText="No of Days" DataField="NOD" />
                                                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                                SortExpression="MST_INSURANCE_COMPANY.SZ_INSURANCE_NAME" HeaderText="Insurance Company" DataField="SZ_INSURANCE_NAME" />
                                                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center"
                                                                                SortExpression="MST_CASE_MASTER.SZ_CLAIM_NUMBER" HeaderText="Claim Number" DataField="SZ_CLAIM_NUMBER" />
                                                                        </Columns>
