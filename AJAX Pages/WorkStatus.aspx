<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkStatus.aspx.cs"
    Inherits="WorkStatus" %>
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <th width="83%" align="center" valign="top" scope="col" colspan="6" style="height: 428px">
                                                        ...
                                                        <asp:TextBox ID="txtHealthCareProvider" runat="server" Visible="False" Width="35px"></asp:TextBox></th>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
