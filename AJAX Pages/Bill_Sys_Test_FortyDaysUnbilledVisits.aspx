<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_Test_FortyDaysUnbilledVisits.aspx.cs" Inherits="Bill_Sys_Test_FortyDaysUnbilledVisits"
    Title="Untitled Page" %>
                                ...
                                <tr>
                                    ...
                                    <td class="Center" valign="top">
                                        <table style="width: 100%; height: 100%" cellspacing="0" cellpadding="0" border="0">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 100%; height: 172px" class="TDPart">
                                                ...
                                                <td class="ContentLabel" style="width: 160px">
                                                </td>
                                                <td style="width: 25%">
                                                </td>
                                            </tr>
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 35%">
                                                                        <asp:TextBox ID="txtFromDate" onkeypress="return CheckForInteger(event,'/')" runat="server"
                                                                            MaxLength="10" CssClass="text-box">
                                                                        </asp:TextBox>
                                                                    ...
                                                                    <td style="width: 160px" class="ContentLabel">
                                                                        To Date:
                                                                    </td>
                                                                    <td style="width: 35%">
                                                                        <asp:TextBox ID="txtToDate" Width="80%" onkeypress="return CheckForInteger(event,'/')" runat="server"
                                                                            MaxLength="10" CssClass="text-box">
                                                                        </asp:TextBox>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 15%; height: 22px" class="ContentLabel">
                                                                        <asp:Label ID="lblSpeciality" runat="server"  CssClass="lbl" Text="Speciality"></asp:Label></td>
                                                                    <td style="width: 35%; height: 22px">
                                                                        <cc1:ExtendedDropDownList ID="extddlSpeciality" runat="server" Width="140px" Selected_Text="---Select---"
                                                                    ...
                                                                    <td style="width: 160px" class="ContentLabel">
                                                                        Case Type:</td>
                                                                    <td style="width: 35%">
                                                                     <extddl:ExtendedDropDownList ID="extddlCaseType" runat="server" Width="66%" Connection_Key="Connection_String" Procedure_Name="SP_MST_CASE_TYPE" Flag_Key_Value="CASETYPE_LIST" Selected_Text="--- Select ---" OldText="" StausText="False" />
                                                                    </td>
                                                                </tr>--%>
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 29%" class="lbl" align="left">
                                                                    ...
                                                                    <td style="width: 29%; height: 22px;" class="lbl" align="left">
                                                                        ...
                                                                        &nbsp; To Date: &nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <asp:TextBox ID="txtToDate" onkeypress="return CheckForInteger(event,'/')" Width="60%"
                                                                            runat="server" MaxLength="10"></asp:TextBox>
                                                                        <asp:ImageButton ID="imgbtnToDate" runat="server" ImageUrl="~/Images/cal.gif"></asp:ImageButton>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 32%" class="ContentLabel">
                                                                        &nbsp;
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="ContentLabel" colspan="5">
                                                                        ...
                                                                        <asp:TextBox ID="txtRefCompanyID" runat="server" Width="10px" Visible="False">
                                                                        </asp:TextBox>
                                                             ...
                                                             &nbsp;
                                                                ...
                                                                <asp:Button ID="btnExportToExcel"
                                                                                OnClick="btnExportToExcel_Click" runat="server" CssClass="Buttons" Text="Export To Excel">
                                                                            </asp:Button>
                                                                </td>
                                                                </tr>--%>
                                                                <tr>
                                                                    <td widh="100%" colspan="3">
                                                                        <table width="100%">
                                                                            <tr>
                                                                                <td colspan="1">
                                                                                    &nbsp;
                                                                                ...
                                                                                <td width="20%" align="right">
                                                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                        <contenttemplate>
                                                                          <asp:Button ID="btnSearch" OnClick="btnSearch_Click"  runat="server"  Width="80px" CssClass="Buttons" Text="Search"></asp:Button>&nbsp;&nbsp;
                                                                        </contenttemplate>
                                                                                    </asp:UpdatePanel>
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    <td style="height: 19px" class="lbl" colspan="1" align="left">
                                                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                            <contenttemplate><b>Total Count:</b> &nbsp; <asp:Label id="lblCount" runat="server" ></asp:Label></contenttemplate>
                                                                        </asp:UpdatePanel></td>
                                                                    <td colspan="3">
                                                ...
                                                <tr>
                                                    <td style="width: 100%" class="TDPart">
                                                        ...
                                                        <div style="overflow: scroll; height: 600px">
                                                            <asp:DataGrid ID="grd40DaysReport" runat="server" Width="100%" CssClass="GridTable"
                                                                 AutoGenerateColumns="false" OnItemCommand="grd40DaysReport_ItemCommand">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" />
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:LinkButton ID="lnkAddDiagCode" runat="server" Text="Edit" 
                                                                                CommandName="ShowPop" > </asp:LinkButton>
                                                                    ...
                                                                    <asp:BoundColumn DataField="PATIENT_ID" HeaderText="Patient Id" Visible="false"></asp:BoundColumn>
                                                                    <%-- 10--%>
                                                                    <asp:BoundColumn DataField="CASE_ID" HeaderText="Case Id" Visible="false"></asp:BoundColumn>
                                                                    <%-- 11--%>
                                                                    <asp:BoundColumn DataField="CLAIM_NUMBER" HeaderText="Claim Name" Visible="false"></asp:BoundColumn>
                                                                    <%-- 12--%>
                                                                    ...
                                                                    <%-- 16--%>
                                                                    <asp:BoundColumn DataField="SZ_STATUS" HeaderText="Ins Address" Visible="false"></asp:BoundColumn>
                                                                    <%-- 17--%>
                                                                    <asp:BoundColumn DataField="SZ_CODE_ID" HeaderText="Ins Address" Visible="false"></asp:BoundColumn>
                                                                    <%-- 18--%>
                                                                    <asp:BoundColumn DataField="EVENT_ID" HeaderText="Ins Address" Visible="false"></asp:BoundColumn>
                                                                    <%-- 19--%>
                                                                    <asp:BoundColumn DataField="DOCTOR_ID" HeaderText="Ins Address" Visible="false"></asp:BoundColumn>
                                                                    <%-- 20--%>
                                                                    ...
                                                                    <asp:BoundColumn DataField="SCHEDULE_DATE" HeaderText="Shedule Date" Visible="false"
                                                                        DataFormatString="{0:MM/dd/yyyy}"></asp:BoundColumn>
                                                                             <%-- 27--%>
                                                                    <asp:BoundColumn DataField="CASE_TYPE" HeaderText="Case Id" Visible="false">
                                                                    </asp:BoundColumn>
                                                                    ...
                                                                    <asp:BoundColumn DataField="BT_INS_CLAIM" HeaderText="INS CLAIM" Visible="false">
                                                                      ...
                                                                      <asp:BoundColumn DataField="SPECIALIYT" HeaderText="Specialty" Visible="false"></asp:BoundColumn>
                                                                        <%-- 32/34--%>
                                                                            <asp:BoundColumn DataField="SZ_STUDY_NUMBER" HeaderText="SZ_STUDY_NUMBER" Visible="false"></asp:BoundColumn>
                                                                </Columns>
                                                                <HeaderStyle CssClass="GridHeader" />
                                                            </asp:DataGrid>
                                                            
                                                             <asp:Panel ID="pnlPDFWorkerComp" runat="server" Style="
