<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_PacketDocument.aspx.cs" Inherits="AJAX_Pages_Bill_Sys_PacketDocument"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel112" runat="server" Visible="true">
        <ContentTemplate>
            <asp:Wizard ID="Wizard1" runat="server" Width="100%" OnNextButtonClick="Wizard1_NextButtonClick"
                OnFinishButtonClick="Wizard1_FinishButtonClick" ActiveStepIndex="0" Font-Size="Small"
                FinishCompleteButtonText="Save" DisplaySideBar="False">
                            ...
                            <tbody>
                                <tr style="text-align: left">
                                    <td style="padding-right: 3px; padding-left: 3px; padding-bottom: 3px; vertical-align: top;
                                        ...
                                        <asp:Label runat="server" Text="Assign Documents to specialty" CssClass="Labels"
                                            Font-Bold="True" Font-Size="Small" ForeColor="Black" Width="205px" ID="Label1"
                                            ></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="text-align: center" class="TDPart" colspan="5">
                                        <div style="top: 150px; width: 400px; font-family: Times New Roman; text-align: center;">
                                ...
                                <tr align="left">
                                    ...
                                    <td style="width: 30%;" class="TDPart" align ="center">
                                        <asp:Panel runat="server" ScrollBars="Horizontal" Height="450px" Width="250px" ID="Panel3" allign="center">
                                            <asp:ListBox runat="server" Height="430px" ID="lbSelectedDocs">
                                            </asp:ListBox>
                                        </asp:Panel>
                                        &nbsp;
                                        <asp:Button runat="server" Text="Assign" CssClass="Buttons" ID="btnAssign"
                                    ...
                                    <td style="width: 30%" class="TDPart" align ="center">
                                        <asp:Panel runat="server" ScrollBars="Horizontal" Height="450px" Width="250px" ID="Panel4" allign="center">
                    ...
                    <asp:WizardStep runat="server" StepType="Finish" Title="2:">
                        <table width="100%">
                            <tbody>
                                <tr>
                                    <td class="TDPart">
                                        <asp:Label runat="server" Text="Select folder to packet all the documents in the folder."
                                            CssClass="Labels" Font-Bold="True" Font-Size="Small" ForeColor="Black" ID="Label2"
                                            ></asp:Label>
                                    </td>
                                    <td class="TDPart">
                                        &nbsp;</td>
                                    <td style="height: 24px; text-align: left" class="TDPart">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 45%" class="TDPart" align ="center">
                                        <asp:Panel runat="server" Height="450px" Width="100%" ID="Panel2">
                                            <asp:ListBox runat="server" Height="447px" Width="100%" ID="lbselect">
                                            </asp:ListBox>
                                        </asp:Panel>
