<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_Billinvoice_Storagereport.aspx.cs" Inherits="AJAX_Pages_Bill_Sys_Billinvoice_Storagereport"
    Title="Storage Invoice Report" %>
    ...
    <script type="text/javascript">
     ...
     function Clear()
       ...
       function Confirm_Delete_Code()
         {     
                var f= document.getElementById("<%=grdStoragegenerate.ClientID%>");
		        var bfFlag = false;	
...
//		        }
     ...
     function showInvoiceFrame(objInvoiceID,objCompanyID)
	    ...
	    // alert(objCaseID + ' ' + objCompanyID);
            ...
            document.getElementById('frmpatient').src="Invoice_Storage_generate_popup.aspx?StorageInvoiceID="+objInvoiceID+"&cmpId="+ objCompanyID+"";
            return false;   
        }
                ...
                <asp:UpdatePanel ID="UP_grdPatientSearch" runat="server">
                    <ContentTemplate>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 60%" align="right">
                                        Record Count:
                                        <%= this.grdStoragegenerate.RecordCount%>
                                        | Page Count:
                        ...
                        <table width="100%">
                            <tr>
                                <td>
                                    <xgrid:XGridViewControl ID="grdStoragegenerate" runat="server" Width="100%" CssClass="mGrid"
                                        DataKeyNames="storage_invoice_id,PAID_STATUS,MN_STORAGE_INVOICE_AMOUNT" MouseOverColor="0, 153, 153"
                                        EnableRowClick="false" ContextMenuID="ContextMenu1" HeaderStyle-CssClass="GridViewHeader"
                                        AlternatingRowStyle-BackColor="#EEEEEE" ExportToExcelFields="storage_invoice_id,INVOICE_GENERATED_DATE,PAID_STATUS,MN_STORAGE_INVOICE_AMOUNT"
                                        ShowExcelTableBorder="true" ExportToExcelColumnNames="INVOICE ID,Generated Date,Payment,Storage Amount"
                                        AllowPaging="true" XGridKey="Bill_sys_storage_generate" PageRowCount="40" PagerStyle-CssClass="pgr"
                                        AllowSorting="true" AutoGenerateColumns="false" GridLines="None">
                                        <Columns>
                                            <%--0--%>
                                            <asp:TemplateField HeaderText="Storage Invoice ID" SortExpression="convert(int,storage_invoice_id)">
                                                <itemtemplate>
                                                          <a id="lnkframePatient" href="#" onclick='<%# "showInvoiceFrame(" + "\""+ Eval("storage_invoice_id") + "\");" %>' ><%# DataBinder.Eval(Container, "DataItem.storage_invoice_id")%></a>
                                                </itemtemplate>
                                            ...
                                            <%--2--%>
                                            <asp:TemplateField HeaderText="Storage Invoice ">
                                                <itemtemplate>
                                            ...
                                            <asp:BoundField HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="right"
                                                SortExpression="mst_storage_invoices.sz_storage_total_amount" headertext="Storage Amount"
                                                DataFormatString="{0:C}" DataField="MN_STORAGE_INVOICE_AMOUNT" />
                                            <%--5--%>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="text-align: left">
                                                                <div style="left: 0px; width: 527px; position: absolute; top: 0px; height: 18px;
                                                                    border: 1px; background-color: #B5DF82; text-align: left" id="Div2">
                                                                    <b>Paid</b>
                                                                            ...
                                                                            <div style="height: 100px; overflow: scroll">
                                                                                <asp:DataGrid ID="grdPaymentTransaction" runat="server" Width="500px" CssClass="GridTable"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <%--1--%>
                                                                                        <asp:BoundColumn DataField="I_STORAGE_PAYMENT_ID" HeaderText="Payment ID" Visible="false">
                                                                                        </asp:BoundColumn>
                                                                                        <%--2--%>
                                                                                        ...
                                                                                        <%--4--%>
                                                                                        <asp:BoundColumn DataField="SZ_PAYMENT_AMOUNT" HeaderText="Check Amount" DataFormatString="{0:C}"
    ...
    <asp:TextBox ID="txtstoragepaymnetid" runat="server" Width="10px" Visible="false"></asp:TextBox>
    <asp:TextBox ID="txtTranstorageId" runat="server" Width="10px" Visible="false"></asp:TextBox>
    <asp:TextBox ID="txtPaymentID" runat="server" Width="10px" Visible="false"></asp:TextBox>
    <asp:TextBox ID="szbalance" runat="server" Width="10px" Visible="false"></asp:TextBox>
