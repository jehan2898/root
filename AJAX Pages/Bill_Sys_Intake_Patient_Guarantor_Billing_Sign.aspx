<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_Intake_Patient_Guarantor_Billing_Sign.aspx.cs"
    Inherits="AJAX_Pages_Bill_Sys_Intake_Patient_Guarantor_Billing_Sign" %>
...
function OnSave() {
    ...
    {     
       ...
       parent.document.getElementById('divDocSignaturePatientGuarantor').style.visibility='hidden';
       parent.document.getElementById('divDocSignaturePatientGuarantor').style.zIndex = -1;  
   }
   else
   {
...
<body>
    <form id="FORM2" method="post" name="FORM2" action="Bill_Sys_Save_Patient_Guarantor_Sign.aspx?Sign=Patient">
        <h2>
            <center>
