...
public partial class Bill_Sys_TreatmentReport : PageBase
{
    ...
    protected void lnkExportTOExcel_onclick(object sender, EventArgs e)
    {
        ...
        {
        ScriptManager.RegisterClientScriptBlock(this, GetType(), "mm", " window.location.href ='" + ApplicationSettings.GetParameterValue("FETCHEXCEL_SHEET").ToString() + grdCaseMaster.ExportToExcel(ApplicationSettings.GetParameterValue("EXCEL_SHEET").ToString()) + "';", true);
        }
    }
