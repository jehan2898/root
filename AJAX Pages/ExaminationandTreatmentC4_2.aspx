<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExaminationandTreatmentC4_2.aspx.cs" Inherits="ExaminationandTreatmentC4_2" %>
									...
									<tr>
										<td>
											<ul style="font-family:Arial, Helvetica, sans-serif;font-size:12px;">
												<li>
													<a href="PatientInformationC4_2.aspx">
														Patient Information
													</a>
												</li>

												<li>
													<a href="DoctorsInformationC4_2.aspx">
														Doctor Information
													</a>
												</li>

												<li>
													<a href="BillingInformationC4_2.aspx">
														Billing Information
													</a>
												</li>

												<li>
													<a href="ExaminationandTreatmentC4_2.aspx">
														Examination and Treatment
													</a>
												</li>

												<li>
													<a href="DoctorsOpinionC4_2.aspx">
														Doctor's Opinion
													</a>
												</li>
												<li>
													<a href="ReturnToWorkC4_2.aspx">
														Return To Work
													</a>
												<br />
												</li>
                                    ...
                                    <div id="divPlanOfCare" class="div_blockcontent" >
                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" style="text-align: left">
                                                        <asp:TextBox ID="txtChangesintreatmentplan" runat="server" TextMode="MultiLine" Width="326px"></asp:TextBox></td>
                                                    <td>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 13px">
                                                        5.</td>
                                                    <td colspan="2" style="text-align: left">
                                                        Based on this examination, does the patient need diagnostic tests and referrals?</td>
                                                    <td>
