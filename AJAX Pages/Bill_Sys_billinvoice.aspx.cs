...
public partial class AJAX_Pages_Bill_Sys_billinvoice : PageBase
{
    string sz_file_path = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        this.con.SourceGrid = grdInvoice;
        this.txtSearchBox.SourceGrid = grdInvoice;
        this.grdInvoice.Page = this.Page;
        this.grdInvoice.PageNumberList = this.con;
    ...
    {
        ScriptManager.RegisterClientScriptBlock(this, GetType(), "mm", " window.location.href ='" + ApplicationSettings.GetParameterValue("FETCHEXCEL_SHEET")  + grdInvoice.ExportToExcel(ApplicationSettings.GetParameterValue("EXCEL_SHEET") ) + "';", true);
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < grdInvoice.Rows.Count; i++)
        {
            sTemp = grdInvoice.DataKeys[i]["INVOICE_STATUS"].ToString();
            if (sTemp != null)
            {
                sTemp = sTemp.Replace("&nbsp;", "");
