<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_ComplaintMaster.aspx.cs" Inherits="Bill_Sys_ComplaintMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" style="background-color: White;">
        <tr>
            <td align="center" style="padding-right: 3px; padding-left: 3px;padding-bottom: 3px;width: 100%;
            ...
            <td colspan="3">
                            ...
                            <tr>
                                ...
                                <td   style="width: 350px; vertical-align:top;">
                                    <asp:TextBox ID="txtComplaintcopy" runat="server" MaxLength="4000" TextMode="MultiLine"
                                        Width="350px" Height="100"></asp:TextBox>
                                   ...
                                   <table style="width: 350px;">
                                        <tr style="width: 350px;">
                                            <td style="width: 400px;" align="right">
                                                &nbsp;
                                                <asp:GridView ID="grdSpecialtyComplaints" runat="server" Width="650px" CssClass="mGrid"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField DataField="sz_specialty" HeaderText="Specialty" HeaderStyle-HorizontalAlign="Left"
                                                            ItemStyle-HorizontalAlign="Left" ItemStyle-Width="50px"></asp:BoundField>
                                                        <asp:TemplateField HeaderText="Complaints" ItemStyle-Width="300px" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="left"  >
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:BoundField DataField="ID" HeaderText="" HeaderStyle-HorizontalAlign="Left"
                                                            ItemStyle-HorizontalAlign="Left" ItemStyle-Width="50px" Visible="true"></asp:BoundField>
        ...
        <tr>
            <td>
                ...
                <asp:TextBox ID="txtComplaint" runat="server" Style="display: none;" MaxLength="4000" TextMode="MultiLine" Width="350px" Height="100"></asp:TextBox>
                <asp:TextBox ID="txtProcedureGroup" runat="server" Style="display: none;" MaxLength="4000" TextMode="MultiLine" Width="350px" Height="100"></asp:TextBox>
            </td>
        </tr>
    </table>
    <%--        </ContentTemplate>
