<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bill_Sys_PatientSearch.aspx.cs" Inherits="Bill_Sys_PatientSearchEntry" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <tr>
                        ...
                        <td scope="col" id="anch_Patient">
                               <table style=" width: 100%; border: 1px solid #B5DF82;" class="txt2"
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <xgrid:XGridViewControl ID="grdPatientList" runat="server" Height="0px" Width="1002px" OnRowCommand ="grdPatientList_OnRowCommand"
                                                                        ...
                                                                        ExportToExcelColumnNames="Case #,Claim No,Patient Name,Insurance Company,Date Of Accident" 
                                                                        ExportToExcelFields="SZ_CASE_NO,SZ_CLAIM_NUMBER,SZ_PATIENT_NAME,SZ_INSURANCE_COMPANY,DT_ACCIDENT_DATE" 
                                                                        AlternatingRowStyle-BackColor="#EEEEEE"
                                                                        AllowPaging="true" GridLines="None" XGridKey="DoctorSearchPatientList" PageRowCount="50" PagerStyle-CssClass="pgr"
                                                                        AllowSorting="true" DataKeyNames="">
                                                ...
                                                <asp:BoundField DataField="SZ_CLAIM_NUMBER" HeaderText="Claim No" >
                                                    <itemstyle horizontalalign="Left" />
                                                    <headerstyle horizontalalign="Center" />
                                                </asp:BoundField>
                                              ...
                                              <%--  <asp:BoundField DataField="SZ_TYPE" HeaderText="Visit Type" ReadOnly="True" visible="false">
                                                ...
                                                <asp:BoundField DataField="SZ_PATIENT_ID" HeaderText="Patient Id" ReadOnly="True" visible="false">
                                                 ...
                                                 <asp:TemplateField HeaderText="Template Manager">
                                                    <itemtemplate>                                                    
                                                            ...
                                                            <td style="width: 100%" class="TDPart">
                                                             ...
                                                             <asp:UpdatePanel ID="UpdatePanel25" runat="server">
                                                                ...
                                                                <table style="width: 100%" class="ContentTable" cellspacing="0" cellpadding="3" border="0">
                                                                    <tbody>                                                                        
                                                                <tr>
                                                                            <td style="width: 25%;font-weight:bold;" class="td-widget-bc-search-desc-ch"  align="left" >
                                                                                Visit Type</td>
                                                                            ...
                                                                            <td style="width: 10%;font-weight:bold;" class="td-widget-bc-search-desc-ch" align="left">
                                                                                Visit Date</td>
