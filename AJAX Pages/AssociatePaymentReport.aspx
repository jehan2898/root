<%@ Page Title="Green Your Bills - Associate Payment Report" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AssociatePaymentReport.aspx.cs" Inherits="AssociatePaymentReport"  %>
 ...
 <%-- For date validation--%>
    <script type="text/javascript" language="javascript">
        ...
        function Clear() {
            document.getElementById("<%=txtToBillDate.ClientID %>").value = '';
            document.getElementById("<%=txtFromBillDate.ClientID %>").value = '';
            document.getElementById("<%=txtProcCode.ClientID %>").value = '';
            document.getElementById("<%=txtProcCodeDesc.ClientID %>").value = '';
    ...
    <td>
     <table style="border: 1px solid #d3d3d3;" width="500px" border="0">
        ...
        <tr>
            ...
            <td class="td-widget-bc-search-desc-ch1"  align="left" colspan="2">
                Procedure Code Description
            </td>                        
         </tr>
        <tr>
            <td class="td-widget-bc-search-desc-ch3">
            <asp:TextBox ID="txtProcCode" runat="server" CssClass="text-box"  Width="90%"></asp:TextBox>
            </td> 
            <td class="td-widget-bc-search-desc-ch3" colspan="2">
           <asp:TextBox ID="txtProcCodeDesc" runat="server" CssClass="text-box"  Width="90%"></asp:TextBox>
            </td>             
        </tr>
        <tr>
            <td class="td-widget-bc-search-desc-ch1"  align="center" colspan="3" >
                Bill Number
            </td>                        
         </tr>
        <tr>
            <td class="td-widget-bc-search-desc-ch3" colspan="3">
           <asp:TextBox ID="txtBillNo" runat="server" CssClass="text-box" TextMode="MultiLine" Width="90%"></asp:TextBox>
            </td>             
        </tr>
        <tr>
            <td class="td-widget-bc-search-desc-ch1" align="left">
...
<table style="width:100%" >
    ...
    <tr>
        <td style="width: 90%">
                <dx:ASPxGridView ID="grdAssoPaymentReport" runat="server" 
                    ...
                    <Columns>
                        <dx:GridViewDataColumn Caption="Bill #"  VisibleIndex="1"   FieldName="Bill No"
                            Settings-AllowSort="True" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                            <Settings AllowSort="True" />
                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Procedure Code" VisibleIndex="2"  FieldName="Proc Code"
                             Settings-AllowSort="True"
                            HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                            <Settings AllowSort="True" />
                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Procedure Code Description" VisibleIndex="3" width="180px" FieldName="Proc Desc"
                            Settings-AllowSort="True" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                            <Settings AllowSort="True" />
                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Procedure Code Amount" VisibleIndex="4" width="150px" FieldName="Proc Code Amount" 
                            Settings-AllowSort="True" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center"  >
                            <DataItemTemplate>
                                <dx:ASPxLabel ID="lblAmount" runat="server" Text='<%# string.Format("{0:C}",Eval("Proc Code Amount")) %>' />
                             </DataItemTemplate>
                            <FooterCellStyle Font-Bold="True" />
                            <Settings AllowSort="True" />
                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Paid Amount" VisibleIndex="5" FieldName="Paid Amount"
                            Settings-AllowSort="True" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center" >
                            <DataItemTemplate>
                                <dx:ASPxLabel ID="lblPaidAmount" runat="server" Text='<%# string.Format("{0:C}",Eval("Paid Amount")) %>' />
                             </DataItemTemplate>
                            <FooterCellStyle Font-Bold="True" />
                            <Settings AllowSort="True" />
                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Check No" VisibleIndex="6"  FieldName="Check No"
                            Settings-AllowSort="True" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                            <Settings AllowSort="True" />
                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                         <dx:GridViewDataColumn Caption="Check Date" VisibleIndex="7" FieldName="Check Date"
                            Settings-AllowSort="True" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                            <Settings AllowSort="True" />
                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Payment Date" VisibleIndex="8" FieldName="Payment Date"
                            Settings-AllowSort="True" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                            <Settings AllowSort="True" />
                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn Caption="Visit Date" VisibleIndex="9" FieldName="visit_date" width="150px"
                            Settings-AllowSort="True" HeaderStyle-Font-Bold="true" HeaderStyle-HorizontalAlign="Center">
                            <Settings AllowSort="True" />
                            <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        </dx:GridViewDataColumn>
                ...
                <dx:ASPxGridViewExporter ID="grdExport" runat="server" GridViewID="grdAssoPaymentReport">
