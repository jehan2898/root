<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="View_InVoice.aspx.cs" Inherits="AJAX_Pages_View_InVoice" Culture="en-US" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function confirm_invoice_delete() {
            ...
            if (confirm("there may be other cases included in this invoice for which you may not find a relevant invoice please confirm. ?") == true) {
...
function openpdf(path) {
    ...
    window.open(path, 'AdditionalData', 'width=800,height=600,left=30,top=30,scrollbars=1');
}
function Validate() {
    var ddl = document.getElementById('ContentPlaceHolder1_extddlEmployer');
    if (ddl.value == "NA") {
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 40%; height: 0px;" align="center">
                                                                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; border-right: 1px solid #B5DF82; border-left: 1px solid #B5DF82; border-bottom: 1px solid #B5DF82"
                                                                                ...
                                                                                <tr>
                                                                                    <td class="td-widget-bc-search-desc-ch">Visit Date
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="td-widget-bc-search-desc-ch" colspan="2">Case#
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td valign="top">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="td-widget-bc-search-desc-ch">Bill/Unbilled
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:RadioButtonList ID="rdlstType" runat="server" RepeatDirection="Horizontal">
                                                                                            <asp:ListItem Value="0">UnBilled</asp:ListItem>
                                                ...
                                                <table width="100%" border="0">
                                                    <tr>
                                                        ...
                                                        <td style="width: 80%" align="right">
                                                            <asp:Button Text="Delete Invoice" ID="btnDeleteInvoice" runat="server"
                                                                OnClick="btnDeleteInvoice_Click" />
                                                            ...
                                                            <tr>
                                                                <td style="width: 1017px" colspan="5">
                                                                    <div style="height: 450px; overflow: scroll;">
                                                                        <asp:DataGrid Width="100%" ID="grdVisits" CssClass="mGrid" runat="server" AutoGenerateColumns="False" OnItemCommand="grdVisits_ItemCommand">
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:BoundColumn DataField="EventAmount" DataFormatString="{0:c}" HeaderText="Visit Amount" ItemStyle-HorizontalAlign="Center"
                                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                                </asp:BoundColumn>
                                                                                ...
                                                                                <asp:BoundColumn DataField="mn_invoice_amount" DataFormatString="{0:c}" HeaderText="Invoice Amount" ItemStyle-HorizontalAlign="Center"
                                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                                </asp:BoundColumn>
                                                                                ...
                                                                                <asp:BoundColumn DataField="SZ_INVOCE_LINK" HeaderText="SZ_INVOCE_LINK" ItemStyle-HorizontalAlign="Center" Visible="false"
                                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                                </asp:BoundColumn>

                                                                                <asp:BoundColumn DataField="bt_status" HeaderText="bt_status" ItemStyle-HorizontalAlign="Center" Visible="false"
                                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                                                </asp:BoundColumn>
                                                                                   <asp:TemplateColumn>
                                                                                    <ItemTemplate>
                                                                                        <asp:ImageButton ID="btnexportToXls" runat="server" CommandName="OpenToXls" Height="15px" Width="15px" CommandArgument="SZ_INVOCE_LINK"
                                                                                            ImageUrl="~/Images/Excel.jpg" />
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateColumn>
                                                                            </Columns>
