...
using Componend;
public partial class ExaminationandTreatmentC4_2 : PageBase
{
    ...
    {//Logging Start
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("ExaminationandTreatmentC4_2.aspx");
        }
        #endregion
        //Method End
        using (Utils utility = new Utils())
    ...
    {//Logging Start
        ...
        try
        {
            ...
            Response.Redirect("DoctorsOpinionC4_2.aspx", false);
        }
        catch (Exception ex)
        {
            Elmah.ErrorSignal.FromCurrentContext().Raise(ex);
