<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dignosis_Code_Popup.aspx.cs"
    Inherits="AJAX_Pages_Dignosis_Code_Popup" %>
        ...
        <div style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" Width="80px" CssClass="btn-primary"
                                    OnClientClick="if(!SubmitDGCode()) return false;" />
                            </td>
                        </tr>
                    </table>
                </div>
                            ...
                            <div class="row" style="margin-top: 30px">
                                ...
                                <div style="height: 200px; background-color: Gray; overflow-y: scroll;">
                                    <asp:DataGrid ID="grdDiagonosisCode" runat="server" Width="99%" CssClass="GridTable"
                                        AutoGenerateColumns="false" OnPageIndexChanged="grdDiagonosisCode_PageIndexChanged">
            ...
            <div style="width: 48%; float: right">
                ...
                <div class="row">
                    ...
                    <br />
                    <div id="divInsurance" runat="server" style="padding-left: 30px">
