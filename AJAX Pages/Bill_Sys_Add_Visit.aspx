    ...
    <script type="text/javascript">
        function showTrans() {
            ...
            if (chk.checked) {
                ...
                var f2 = document.getElementById('divTransGrd');
                f2.style.visibility = 'visible';
                f2.style.height = '400px';

                var edate = document.getElementById('txtEventDate').value;
                var He = document.getElementById('ddlHours_event').value;
                var Me = document.getElementById('ddlMinutes_event').value;
                var Te = document.getElementById('ddlTime_event').value;
                document.getElementById('ddlHours').value = He;
                document.getElementById('ddlMinutes').value = Me;
                document.getElementById('ddlTime').value = Te;

                document.getElementById('txtFromDate').value = edate;
            } else {

                document.getElementById('ddlHours').value = "00";
                document.getElementById('ddlMinutes').value = "00";
                document.getElementById('ddlTime').value = "AM";
                    ...
                    if (t.value == '00') {
                        ...
                        if (document.getElementById("extddlVisitType").value == 'NA') {
                            ...
                            if (chk.checked) {
                                ...
                                var trans = document.getElementById('extddlTransport').value
                                if (trans == "NA") {
...
<body>
                                            ...
                                            <div id="griddiv" style="float: left; position: relative; left: 0px; top: 0px; width: 100%;">
                                                <asp:DataGrid ID="grdPatientList" runat="server" Width="100%" CssClass="GridTable"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundColumn DataField="SZ_PATIENT_ID" HeaderText="Patient ID" Visible="False">
                                                        </asp:BoundColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="SZ_PATIENT_STREET" HeaderText="Street" Visible="False">
                                                        </asp:BoundColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="SZ_PATIENT_PHONE" HeaderText="Phone" Visible="False">
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="SZ_PATIENT_EMAIL" HeaderText="Email" Visible="False">
                                                        </asp:BoundColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="DT_INJURY" HeaderText="Date of Injury" DataFormatString="{0:MM/dd/yyyy}"
                                                            Visible="False"></asp:BoundColumn>
                                                        <asp:BoundColumn DataField="SZ_JOB_TITLE" HeaderText="Job Title" Visible="False">
                                                        </asp:BoundColumn>
        ...
        <tr>
            ...
            <td style="font-family: Arial; font-size: 12px; text-align: left; width: 85%;" valign="top"
                ...
                <dx:aspxgridview id="grdDoctor" runat="server" keyfieldname="CODE" autogeneratecolumns="false"
                    width="85%" settingspager-pagesize="120" settingscustomizationwindow-height="100"
    ...
    <table width="100%">
        <tr>
            <td>
                <div id="divTrans" runat="server" style="width: 100%; visibility: hidden; height:60px">
                    <table width="100%">
                        <tr>
                            <td style="width: 15%;">
                                Transport Name
                ...
                <div id="divAddBtn" runat="server" style="width: 100%;">
                    <table width="100%">
                        <tr>
                ...
                <div id="divTransGrd" runat="server" style="width: 100%; visibility: hidden; overflow: scroll;
                    height: 400px;">
                            ...
                            <td style="width: 100%" align="center">
                                <div style="overflow: auto; height: 10%; width: 100%;">
                                    <asp:DataGrid ID="grdTransport" runat="server" Width="100%" CssClass="GridTable"
                                        ...
                                        <ItemStyle CssClass="GridRow" />
                                        <Columns>
                                            <asp:BoundColumn DataField="I_TRANS_ID" HeaderText="I_TRANS_ID" Visible="false">
                                            </asp:BoundColumn>
                                            ...
                                            <asp:BoundColumn DataField="SZ_CASE_ID" HeaderText="SZ_CASE_ID" Visible="false">
                                            </asp:BoundColumn>
