...
public partial class WorkStatus : PageBase
{
    ...
    {//Logging Start
        ...
        try
        {
            ...
            _editOperation.Xml_File = "WorkStatus.xml";
    ...
    {//Logging Start
        ...
        try
        {
            ...
            _editOperation.Primary_Value = Session["DOCTOR_ID"].ToString();
            _editOperation.WebPage = this.Page;
            _editOperation.Xml_File = "providerBilling.xml";
            _editOperation.LoadData();
