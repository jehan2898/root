<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_AOB_Patient_Sign.aspx.cs" Inherits="AJAX_Pages_Bill_Sys_AOB_Patient_Sign" %>
...
function OnSave() {
    ...
    {     
       ...
       parent.document.getElementById('divPatientSignatureAOB').style.visibility='hidden';
       parent.document.getElementById('divPatientSignatureAOB').style.zIndex = -1;  
   }
   else
   {
...
<body>
    <form id="FORM2" method="post" name="FORM2" action="Bill_Sys_Save_AOB_Sign.aspx?Sign=Patient">
        <h2>
            <center>
