...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Add_User(sz_ip_address) {
            if (sz_ip_address != "") {
                var url = 'Add_User_With_IP_Address.aspx?sz_ip_address=' + sz_ip_address;
                //alert(url);
                User_Popup.SetContentUrl(url);
                User_Popup.Show();
                return false;
            }
            else {
                alert("Input the IP Address");
                return false;
            }
        ...
        <tr>
            <td style="border: 0px solid #B5DF82; height: 140px; width: 70%">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <table style="border-right: #b5df82 1px solid; border-top: #b5df82 1px solid; border-left: #b5df82 1px solid; width: 100%; border-bottom: #b5df82 1px solid; height: 140px"
                            ...
                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="width: 50%" align="center">
                                                        <extddl:ExtendedDropDownList ID="extddlSysKeys" runat="server" Width="85%" AutoPost_back="True"
                                                            ...
                                                            Connection_Key="Connection_String" OnextendDropDown_SelectedIndexChanged="extddlSysKeys_extendDropDown_SelectedIndexChanged"></extddl:ExtendedDropDownList>
                                                    </td>
                                                    <td style="width: 50%" align="center">
                                                        ...
                                                        <extddl:ExtendedDropDownList ID="extddlTreatmentAddress" runat="server" Width="150px"
                                                            ...
                                                            Flag_Key_Value="GET_TREATMENT_ADDRESS_LIST" Connection_Key="Connection_String" OnextendDropDown_SelectedIndexChanged="extddlTreatmentAddress_extendDropDown_SelectedIndexChanged"></extddl:ExtendedDropDownList>
                                                        ...
                                                        <extddl:ExtendedDropDownList ID="extdlPOS" runat="server" Width="150px"
                                                            ...
                                                            Flag_Key_Value="GET_POS_LIST" Connection_Key="Connection_String" OnextendDropDown_SelectedIndexChanged="extdlPOS_extendDropDown_SelectedIndexChanged"></extddl:ExtendedDropDownList>
                                                        ...
                                                        <extddl:ExtendedDropDownList ID="extdlLDateFormate" runat="server" Width="150px"
                                                            ...
                                                            Flag_Key_Value="GET_DATE_FORMATE" Connection_Key="Connection_String" Maintain_State="true"></extddl:ExtendedDropDownList>
                                                ...
                                                <tr>
                                                    <td style="width: 50%" align="center">
                                                        ...
                                                        <extddl:ExtendedDropDownList ID="extddlVisitType" runat="server" Width="200px" AutoPost_back="false"
                                                            ...
                                                            Flag_Key_Value="GET_VISIT_TYPE" Connection_Key="Connection_String" Visible="false"></extddl:ExtendedDropDownList>
                                ...
                                <tr>
                                    <td align="center" colspan="2">
                                        ...
                                        <asp:Button ID="btnUpdate" runat="server" Width="80px" Text="Update" OnClick="btnUpdate_Click"></asp:Button>
                                        <asp:Button ID="btnClear" runat="server" Width="80px" Text="Clear" OnClick="btnClear_Click"></asp:Button>
            ...
            <td style="width: 100%;">
                <div style="width: 100%;">
                    <table style="height: auto; width: 100%; border: 1px solid #B5DF82;" class="txt2"
                        align="left" ce00%; border: 1px solid #B5DF82;" class="txt2"
                            ...
                            <td style="width: 100%;">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <table style="vertical-align: middle; width: 100%" border="0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle; width: 10%;" align="left"></td>
                                                ...
                                                <tr>
                                                    <td align="right" width="100%" colspan="3"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <%--<dx:ASPxCallbackPanel ID="pUpdateTime" runat="server" ClientInstanceName="pUpdateTime"  oncallback="pUpdateTime_Callback">
                                            <panelcollection>  
                                            <dx:PanelContent>
                                        ...
                                        <asp:Button ID="btnAddIpAddress" Text="Add Ip Address" OnClick="btnAddIpAddress_Click" runat="server" />
                                        <asp:Button ID="btnSaveIdAddress" Text="Save Ip Address" OnClick="btnSaveIdAddress_Click" runat="server" />--%>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
                        ...
                        <table style="text-align: left; width: 200px;" border="0">
                            <tr>
                                <td style="text-align: left; width: 200px; vertical-align: top;">
                                    <table border="0" align="left" cellpadding="0" cellspacing="0" style="width: 350px; border: 1px solid #B5DF82;">
                                        <tr>
                                            <td style="width: 200px; height: 0px;" align="center">
                                                <table border="0" cellpadding="0" cellspacing="0" style="width: 350px;" onkeypress="javascript:return WebForm_FireDefaultButton(event, 'ctl00_ContentPlaceHolder1_btnSearch')">
                                                    ...
                                                    <tr>
                                                        <td class="td-widget-bc-search-desc-ch" style="width: 40%;">Law Firm</td>
                                                        <td class="td-widget-bc-search-desc-ch" style="width: 60%;">Email Address</td>
                                                    </tr>
                                                    <tr>
                            ...
                            <%--<tr>
                                <td align="left" valign="middle" bgcolor="#B5DF82" class="txt2" style="width: 500px;">
                                    <b class="txt3">IP Address Settings</b>
                                </td>
                                <td height="28" align="center" valign="middle" bgcolor="#B5DF82" class="txt2" style="width: 60%;">
                            ...
                            <tr>
                                <td>
                                    <table border="0" align="left" cellpadding="0" cellspacing="0" style="width: 350px;
                                        ...
                                        <tr>
                                            <td style="width: 200px; height: 0px;" align="center">
                                                <dx:ASPxGridView ID="grdIpAdress" runat="server" KeyFieldName="Column1" AutoGenerateColumns="false"
                                                    Width="100%" SettingsPager-PageSize="50" OnRowCommand="grdIpAdress_RowCommand">
                                                    <Columns>
                                                        <dx:GridViewDataColumn Settings-AllowSort="False" Width="30%" VisibleIndex="1">
                                                            <HeaderTemplate>
                                                                <asp:Label ID="lblEligibleAmt" runat="server" Text="Ip Address"></asp:Label>
                                                            </HeaderTemplate>
                                                            <DataItemTemplate>
                                                        ...
                                                        <dx:GridViewDataColumn Caption="Delete" Settings-AllowSort="False" Width="10%" VisibleIndex="2">
                                                            <DataItemTemplate>
                                                                <asp:LinkButton ID="lnkDelete" runat="server" Text='Delete' CommandName="Delete">
                                                                </asp:LinkButton>
                                                            </DataItemTemplate>
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn FieldName="i_id" Caption="i_id" VisibleIndex="3" Visible="false"
                                                            Width="120px" CellStyle-HorizontalAlign="Center">
                                                            <CellStyle HorizontalAlign="Center">
                                                            </CellStyle>
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn FieldName="sz_company_id" Caption="sz_company_id" VisibleIndex="4"
                                                            Visible="false" Width="120px" CellStyle-HorizontalAlign="Center">
                                                            <CellStyle HorizontalAlign="Center">
                                                            </CellStyle>
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn FieldName="sz_ip_address" Caption="sz_ip_address" VisibleIndex="5"
                                                            Visible="false" Width="120px" CellStyle-HorizontalAlign="Center">
                                                            <CellStyle HorizontalAlign="Center">
                                                            </CellStyle>
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn FieldName="dt_created" Caption="dt_created" VisibleIndex="6"
                                                            Visible="false" Width="120px" CellStyle-HorizontalAlign="Center">
                                                            <CellStyle HorizontalAlign="Center">
                                                            </CellStyle>
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn FieldName="sz_user_id" Caption="sz_user_id" VisibleIndex="7"
                                                            Visible="false" Width="120px" CellStyle-HorizontalAlign="Center">
                                                            <CellStyle HorizontalAlign="Center">
                                                            </CellStyle>
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn FieldName="IsActive" Caption="IsActive" VisibleIndex="8" Visible="false"
                                                            Width="120px" CellStyle-HorizontalAlign="Center">
                                                            <CellStyle HorizontalAlign="Center">
                                                            </CellStyle>
                                                        </dx:GridViewDataColumn>
                                            ...
                                            <td style="width: 200px; height: 0px;" align="center">
                                                <dx:ASPxGridView ID="grdIpAdress" runat="server" KeyFieldName="Column1" AutoGenerateColumns="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <%--<dx:GridViewCommandColumn Caption="Delete"  Width="10%" VisibleIndex="2">
                                                            <custombuttons>
                                                                   <dx:GridViewCommandColumnCustomButton ID="lnkDelete" Text="Delete"></dx:GridViewCommandColumnCustomButton>
                                                            </custombuttons>
                                                            
                                                        </dx:GridViewCommandColumn>--%>
                                                        <dx:GridViewDataColumn FieldName="i_id" Caption="i_id" VisibleIndex="3" Visible="false"
                                                            Width="10px" CellStyle-HorizontalAlign="Center">
                                                            <CellStyle HorizontalAlign="Center">
                                                            </CellStyle>
                                                        </dx:GridViewDataColumn>
                                                        <dx:GridViewDataColumn FieldName="sz_company_id" Caption="sz_company_id" VisibleIndex="4"
                                                        ...
                                                        <dx:GridViewDataColumn  Width="10%" VisibleIndex="9">
                                                        <HeaderTemplate>
                                                        <asp:Label ID="lblUser" runat="server" Text="Add User"></asp:Label>
                                                        </HeaderTemplate>
                                                        <DataItemTemplate>
                                                        <a href="javascript:void(0);" onclick="Add_User('<%# Eval("sz_ip_address") %>');return false;" class="regular" id="link_User" >Add</a>
                                                        </DataItemTemplate>
    ...
    <dx:ASPxPopupControl ID="User_Popup" runat="server" CloseAction="CloseButton" Modal="true"
        PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ClientInstanceName="User_Popup"
        HeaderText="Add User" HeaderStyle-HorizontalAlign="Left" HeaderStyle-BackColor="#000"
        AllowDragging="True" EnableAnimation="False" EnableViewState="True" Width="300px"
        ToolTip="Add User" PopupHorizontalOffset="0" PopupVerticalOffset="0"
