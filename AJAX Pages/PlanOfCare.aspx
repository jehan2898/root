<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlanOfCare.aspx.cs"
    Inherits="PlanOfCare" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <asp:ListItem Value="1">May affect patient's ability to return to work, make patient drowsy, or other issue. Explain</asp:ListItem>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="text-align: left; vertical-align: top;" colspan="2">
                                                                                    <div class="lbl">
                                                                                        Does the patient need diagnostic tests or referrals?</div>
                                                                                </td>
                                                                                <td>
                                                                                    <div class="lbl">
                                                                ...
                                                                <asp:ListItem Value="0">No</asp:ListItem>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="height: 26px">
                                                                                    <asp:TextBox ID="txtTreatmentGuidelines" runat="server" MaxLength="61"></asp:TextBox></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td style="width: 56px">
                                                                                </td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtVarianceGuideline" runat="server" MaxLength="233"></asp:TextBox></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="4">
                                                                                </td>
