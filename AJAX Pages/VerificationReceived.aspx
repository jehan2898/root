<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VerificationReceived.aspx.cs" Inherits="AJAX_Pages_VerificationReceived" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenBillVerificationScan() {
            ...
            scanBillVerification(caseid, specialityid, typeId, billNumber, '1');
        }
                        ...
                        <td style="vertical-align: top; width: 100%;">
                            ...
                            <div style="border: 0px solid; width: 100%;">
                                <table border="0" style="margin: 0 auto; width: 70%; padding-top: 10px; padding-bottom: 10px" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="lbltext">Verification Date
                                        </td>
                                        <td class="lblcontrol">
                    ...
                    <tr>
                        <td>
                            <div style="overflow: scroll; width: 99%; height: 260px">
                                <table>
                                    <asp:DataGrid ID="grdVerificationReceived" runat="server" AutoGenerateColumns="false"
                                        Width="99%" CssClass="GridTable" OnItemCommand="grdVerificationReceived_ItemCommand" DataKeyField="sz_bill_number">
