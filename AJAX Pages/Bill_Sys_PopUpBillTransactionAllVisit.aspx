<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_PopUpBillTransactionAllVisit.aspx.cs"
    Inherits="Bill_Sys_PopUpBillTransactionAllVisit" %>
...
//                }
                ...
                
               {
                    ...
                    var _value = document.getElementById("txtClaimInsurance");                  
                            if(_value.value==0)
                        {
                            alert("You do not have a claim number or an insurance company or an insurance company address added to this patient. You can not create a bill.");                
                                return false;
                         }else  if(_value.value==1)
                         {
                            alert("You do not have a insurance company or an insurance company address added to this patient. You can not create a bill.");                
                             return false; 
    ...
    <script>
        function validate()
        {
            if(document.getElementById('extddlDoctor') != null)
            {   
    ...
    <script>
        function onOk()
        {
         var tempdt =  document.getElementById('txtDateOfservice');
        if(tempdt.value=='' && document.getElementById('txtDateOfservice').style.visibility=='visible')
        {
            alert('Please enter date of service');
            document.getElementById('txtDateOfservice').style.backgroundColor = "#ffffff";
            return false;
        }        
        ...
        function onGroupService()
        {
         ...
         var tempdt =  document.getElementById('txtGroupDateofService');
        if(tempdt.value=='' && document.getElementById('txtGroupDateofService').style.visibility=='visible')
        {
            alert('Please enter date of service');
            document.getElementById('txtGroupDateofService').style.backgroundColor = "#ffffff";
            return false;
        }        
          
           //AjaxControlToolkit.PopupControlBehavior.__VisiblePopup.hidePopup();
            //return false;
            __doPostBack('lnkAddGroupService','');
        ...
        {
         var chk =CheckValidate();
        
         if(chk!=false)
         {
                document.getElementById('pnlShowNotes').style.height='180px';
                document.getElementById('pnlShowNotes').style.visibility = 'visible';
                document.getElementById('pnlShowNotes').style.position = "absolute";
	            document.getElementById('pnlShowNotes').style.top = '50px';
	            document.getElementById('pnlShowNotes').style.left ='40px';
	            document.getElementById('txtDateOfservice').value='';
	            document.getElementById('TestPanel').style.height='0px';
                    document.getElementById('TestPanel').style.visibility = 'hidden';  
                    document.getElementById('txtGroupDateofService').value=''; 
                    document.getElementById('Hfiels').value=1;
        ...
        function CloseServiceSource()
       {
            ...
            document.getElementById('pnlShowNotes').style.height='0px';
            document.getElementById('pnlShowNotes').style.visibility = 'hidden';  
            document.getElementById('txtDateOfservice').value='';      
       }
        ...
        function showGroupPopup()
        {
         ...
         if(chk!=false)
         {
            ...
            document.getElementById('TestPanel').style.height='180px';
            document.getElementById('TestPanel').style.visibility = 'visible';
            document.getElementById('TestPanel').style.position = "absolute";
	        document.getElementById('TestPanel').style.top = '50px';
	        document.getElementById('TestPanel').style.left ='40px';
	        document.getElementById('txtGroupDateofService').value=''; 
	         document.getElementById('pnlShowNotes').style.height='0px';
                document.getElementById('pnlShowNotes').style.visibility = 'hidden';  
                document.getElementById('txtDateOfservice').value='';   
       ...
       {
            document.getElementById('pnlDiagnosisCode').style.height='180px';
            document.getElementById('pnlDiagnosisCode').style.visibility = 'visible';
            document.getElementById('pnlDiagnosisCode').style.position = "absolute";
	        document.getElementById('pnlDiagnosisCode').style.top = '50px';
	        document.getElementById('pnlDiagnosisCode').style.left ='40px';
	    //    document.getElementById('txtGroupDateofService').value=''; 
	        document.getElementById('pnlShowNotes').style.height='0px';
            document.getElementById('pnlShowNotes').style.visibility = 'hidden';  
        //    document.getElementById('txtDateofService').value='';   
       ...
       {
            document.getElementById('pnlDiagnosisCode').style.height='0px';
            document.getElementById('pnlDiagnosisCode').style.visibility = 'hidden';  
          //  document.getElementById('txtGroupDateofService').value='';      
       }
       ...
       {
            var f= document.getElementById("<%= grdCompleteVisit.ClientID %>");	
  ...
  //
    ...
    function closed(cal) {
      ...
      if (document.getElementById('pnlShowNotes').style.visibility == 'hidden' && document.getElementById('TestPanel').style.visibility == 'visible')
        {el = document.getElementById("txtGroupDateofService");}
       if (document.getElementById('pnlShowNotes').style.visibility == 'visible' && document.getElementById('TestPanel').style.visibility == 'hidden')
        {el = document.getElementById("txtDateOfservice");}
...
<body>
    <form id="form1" runat="server">
                        ...
                        <tr>
                            ...
                            <td class="Center" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                                            ...
                                            <table border="0" cellpadding="3" cellspacing="3" class="ContentTable" style="width: 100%">
                                                <tr>
                                                    <td class="ContentLabel" style="text-align: center; height: 20px;" colspan="4">
                                                        ...
                                                        <asp:Button ID="Button2" runat="server" Text="Button" OnClick="Button2_Click" Visible="false" /><div
                                                            id="ErrorDiv" runat="server" style="color: red" visible="true">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="ContentLabel" style="width: 40%">
                                                        Doctor &nbsp;<extddl:extendeddropdownlist id="extddlDoctor" runat="server" width="80%"
                                                            connection_key="Connection_String" flag_key_value="GETDOCTORLIST" procedure_name="SP_MST_DOCTOR"
                                                            selected_text="---Select---" autopost_back="True" onextenddropdown_selectedindexchanged="extddlDoctor_extendDropDown_SelectedIndexChanged"
                                                ...
                                                <tr>
                                                    <td class="ContentLabel" colspan="4" style="width: 15%">
                                                        <asp:DataGrid ID="grdAllReports" runat="server" Width="100%" CssClass="GridTable"
                                                            AutoGenerateColumns="false" Visible="false" OnItemDataBound="grdAllReports_ItemDataBound">
                                                            <ItemStyle CssClass="GridRow" />
                                                            <Columns>
                                                                ...
                                                                <tr>
                                                                    <td width="60%">
                                                                        <table width="100%">
                                                                            <tr>
                                                                                <td width="100%">
                                                                                    <asp:ListBox ID="lstDiagnosisCodes" runat="server" Width="300px" SelectionMode="Multiple">
                                                                                    </asp:ListBox></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                    <td valign="top">
                                                                        <table width="100%">
                                                                            ...
                                                                            <tr>
                                                                                <td width="100%">
                                                                                    <asp:LinkButton ID="lnkbtnRemoveDiag" runat="server" Text="Remove" Style="font-size: 12px;
                                    ...
                                    <tr>
                                    <td colspan="4">
                                        <div id="divgrd" style="overflow:scroll; height:200px; ">
                                      <asp:DataGrid ID="grdCompleteVisit" runat="server" Width="96%" CssClass="mGrid" AutoGenerateColumns="false"
                                                                    ...
                                                                    <Columns>
                                                                        <asp:TemplateColumn ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="left">
                                                                           <%-- <HeaderTemplate>
                                                                                <asp:LinkButton ID="btnQuickBill"   OnClientClick="ConfirmQuickBill()"
                                    ...
                                    <tr>
                                        <td style="width: 100%;" class="TDPart">
                                            <div align="right" style="vertical-align: top;">
                                                ...
                                                <a id="hlnkShowGroupProcCode" style="cursor: pointer; height: 22px; vertical-align: top;"
                                                    onclick="showGroupPopup();" class="Buttons" runat="server" title="Add Group Services">
                                                    Add Group Services</a> <a id="hlnkShowServices" style="cursor: pointer; height: 22px;
                                            ...
                                            <div style="overflow: scroll; height: 200px; width: 99%;">
                                    ...
                                    <tr>
                                        <td class="TDPart" colspan="4" align="right">
                                            ...
                                            <asp:Button ID="btnSave" runat="server" Text="Add Bill" Width="80px" CssClass="Buttons"
                                            ...
                                            <asp:Button ID="btnClearService" runat="server" Text="Clear" Width="80px" CssClass="Buttons"
                                                OnClick="btnClearService_Click" Visible="false" />
                                                <asp:HiddenField ID="Hfiels" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
        ...
        <div id="divpatientID" style="position: absolute; width: 0px; height: 0px; background-color: #DBE6FA;
            ...
            <iframe id="framepatientDesk" src="" frameborder="0" height="0px" width="0px" visible="false">
            </iframe>
        </div>
        <div id="divid2" style="position: absolute; left: 100px; top: 100px; width: 500px;
            height: 0px; background-color: #DBE6FA; visibility: hidden; border-right: silver 1px solid;
            ...
            <iframe id="iframeAddDiagnosis" src="" frameborder="0" height="0px" width="500" language="javascript"
                onblur="return iframeAddDiagnosis_onblur()"></iframe>
        </div>
        <asp:Panel ID="pnlShowNotes" runat="server" Style="width: 420px; height: 0px; background-color: white;
            ...
            <a id="A1" href="#">
                <input type="image" name="mgbtnDateofService" id="Image1" runat="server" src="Images/cal.gif"
                    border="0" /></a>
            <input type="button" value="Add" class="Buttons" onclick="onOk()" /><a onclick="CloseServiceSource();"
        ...
        <%--  <ajaxcontrol:PopupControlExtender ID="popUpGroupService" runat="server" TargetControlID="hlnkShowGroupProcCode"
            PopupControlID="TestPanel" Position= "Center" OffsetX="-400" OffsetY="-120" />--%>
        <%--Test Panel For Group services--%>
        <asp:Panel ID="TestPanel" runat="server" Style="width: 450px; height: 0px; background-color: white;
            border-color: ThreeDFace; border-width: 1px; border-style: solid; visibility: hidden;">
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                <tr>
                    <td align="right">
                        ...
                        <input type="button" value="Add" class="Buttons" onclick="onGroupService()" id="Button3" /><a
                            onclick="CloseGroupSource();" style="cursor: pointer;" title="Close">X</a>
                    </td>
                </tr>
                <tr>
