...
public partial class AJAX_Pages_VerificationReceived : PageBase
{
    ...
    public void BindGrid()
    {
        ...
        try
        {
            ...
            grdVerificationReceived.DataSource = dset.Tables[0];
            grdVerificationReceived.DataBind();
        }
        catch (Exception ex)
        {
            lblScan.Visible = false;
    ...
    protected void grdVerificationReceived_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        try
        {
            ...
            oBillNo.Number = grdVerificationReceived.DataKeys[rowIndex].ToString();
