<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_BillReportByProvider.aspx.cs" Inherits="Bill_Sys_BillReportByProvider"
    Title="Untitled Page" %>
...
<div id="diveserch" runat="server" language="javascript">
                                    ...
                                    <td style="width: 100%;height: 100%;" class="TDPart" valign="top" >
                                        ...
                                        <asp:DataGrid ID="grdPayment" runat="Server" AutoGenerateColumns="False" CssClass="GridTable"
                                            ...
                                            <Columns>   
                                                ...
                                                <%--5--%>
                                                <asp:BoundColumn DataField="SZ_OFFICE_ID" HeaderText="Office ID" ItemStyle-HorizontalAlign="Right" Visible="false" >
                                                </asp:BoundColumn>
                                            </Columns>
