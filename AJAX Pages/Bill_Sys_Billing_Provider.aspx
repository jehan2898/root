<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_Billing_Provider.aspx.cs"
    Inherits="AJAX_Pages_Bill_Sys_Billing_Provider" %>
...
<head runat="server">
    ...
    function SelectAllForprovider(ival)
       {
            var f= document.getElementById('grdbillingprovider');	
            var str = 1;
...
<body>
    <form id="form1" runat="server">
        ...
        <%--  <div style="background-color: #E9E9E9; width: 950px; height: 750px; margin-top: 10px;
            margin-left: 150px;">--%>
        <table style="width: 95%; background-color: White; margin-left: 23px; 
            border: 2px;" border="0">
            <tr>
                <td style="vertical-align: top; width: 100%;">
                    <table style="width: 100%; border: 0px solid; margin-top: 20px; padding-left: 0px;"
                        ...
                        <tr>
                            <td>
                                <table width="100%" id="tbladdressforprovider" runat="server">
                                    <tr>
                                        <td style="width: 48%;" valign="top" id="tbldefaultgaddress" runat="server">
                                            ...
                                            <table border="0" width="100%">
                                                <tr>
                                                    <td align="right">
                                                        <dx:ASPxButton ID="ASPxButton1" runat="server" Text="Update" OnClick="btnUpdate_Click">
                                                        </dx:ASPxButton>
                                                    </td>
                                                    <td align="left">
                                                        <dx:ASPxButton ID="ASPxButton2" runat="server" Text="Remove" >
                                                        </dx:ASPxButton>
                                                    </td>
                                                </tr>
                                            </table>
