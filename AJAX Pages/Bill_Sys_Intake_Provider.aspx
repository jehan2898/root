<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_Intake_Provider.aspx.cs"
    Inherits="AJAX_Pages_Bill_Sys_Intake_Provider" %>
...
<!--
        ...
        function OnSave() {
            ...
            if (document.FORM1.SigPlusDoctor.NumberOfTabletPoints > 0) {
                ...
                parent.document.getElementById('divDocSignatureIntake').style.visibility = 'hidden';
                parent.document.getElementById('divDocSignatureIntake').style.zIndex = -1;
...
<body>
    <form id="FORM1" method="post" name="FORM1" action="Bill_Sys_Save_Intak_Sign.aspx?Sign=Provider"
