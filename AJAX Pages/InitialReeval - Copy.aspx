                                                                ...
                                                                <tr>
                                                                    <td style="width: 20%; height: 0px;" valign="top">
                                                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 550px;" onkeypress="javascript:return WebForm_FireDefaultButton(event, 'ctl00_ContentPlaceHolder1_btnSearch')">
                                                                            <tr>
                                                                                <td class="td-widget-bc-search-desc-ch" width="33%">Month
                                                                                </td>
                                                                            ...
                                                                            <tr>
                                                                                <td class="td-widget-bc-search-desc-ch" width="33%">Speciality
                                                                                </td>
                                                                                <td class="td-widget-bc-search-desc-ch" width="33%"></td>
                                                                                <td class="td-widget-bc-search-desc-ch" width="33%">Case Status
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="td-widget-bc-search-desc-ch" width="33%">
                    ...
                    <td style="width: 100%">
                        <div style="height: 700px; overflow: scroll;">
                            <asp:DataGrid Width="100%" ID="grdVisits" CssClass="mGrid"   runat="server" AutoGenerateColumns="False"
                                OnItemCommand="grdVisits_ItemCommand"  >
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="Work Phone" Visible="true">
                                        <HeaderTemplate>
                                            <asp:LinkButton ID="lnPhone" runat="server" CommandName="WPhone" CommandArgument="SZ_WORK_PHONE"
                                                Font-Bold="true" Font-Size="12px">Work Phone</asp:LinkButton>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container, "DataItem.SZ_WORK_PHONE")%>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Cell No." Visible="true">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="DOA" Visible="true">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="Insurance" Visible="true">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="Case Type" Visible="true">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="Doctor" Visible="true">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="Provider" Visible="true">
                                        <HeaderTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="Last Initial/Re-Eval Date" Visible="true">
                                        <HeaderTemplate>
