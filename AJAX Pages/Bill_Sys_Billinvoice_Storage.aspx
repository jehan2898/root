<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_Billinvoice_Storage.aspx.cs" Inherits="AJAX_Pages_Bill_Sys_Billinvoice_Storage"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   ...
   function SelectAll(ival)
       {
            var f= document.getElementById("<%= grdStorageInvoice.ClientID %>");	
                ...
                <asp:UpdatePanel ID="UP_grdPatientSearch" runat="server">
                    <ContentTemplate>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width: 60%" align="right">
                                        Record Count:
                                        <%= this.grdStorageInvoice.RecordCount%>
                                        | Page Count:
                        ...
                        <table width="100%">
                            <tr>
                                <td>
                                    <xgrid:XGridViewControl ID="grdStorageInvoice" runat="server" Width="100%" CssClass="mGrid"
                                        ...
                                        AllowPaging="true" XGridKey="StorageInvoice" PageRowCount="1000" PagerStyle-CssClass="pgr"
