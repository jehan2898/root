<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctorOpinion.aspx.cs" Inherits="DoctorOpinion" %>
                                                            ...
                                                            <asp:ListItem Text="No" Value="0"></asp:ListItem>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="75%" colspan="3" valign="top">
                                                                                            <div class="lbl">
                                                                                                2. Are the patient's complaints consistent with his/her history of the injury/illness?</div>
                                                                                        </td>
                                                                                        <td width="25%">
                                                                                            <div class="lbl">
                                                            ...
                                                            <asp:ListItem Text="N/A (no findings at this time)" Value=2></asp:ListItem>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="50%" colspan="2" style="height: 34px">
                                                                                            <div class="lbl">
                                                                                                4. What is the percentage (0-100%) of temporary impairment?</div>
                                                                                            <td width="50%" colspan="2" style="height: 34px">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td width="50%" colspan="4" valign="top">
                                                                                            <div class="lbl">
                                                                                                5. Describe findings and relevant diagnostic test results:</div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td width="50%" colspan="4">
                                                                                            <asp:TextBox ID="txtRelevantDiagosticTest" runat="server" TextMode="MultiLine" Height="80px"
                                                                                                Width="420px" onkeyDown="return checkTextAreaMaxLength(this,event,'258');"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </div>
