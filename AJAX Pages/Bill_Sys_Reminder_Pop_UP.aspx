...
<head runat="server">
	...
	function ConfirmDisMis()
	{
       ...
       function SelectAll1(ival)
       {
        ...
        function SelectAllAccount(ival)
       {
       ...
       function chkAccount()	
	{	
	    var f= document.getElementById("grdaccountreminder");	
		for(var i=0; i<f.getElementsByTagName("input").length ;i++ )
		{		
		    if(f.getElementsByTagName("input").item(i).type == "checkbox" )		
			{						
			    if(f.getElementsByTagName("input").item(i).checked==true)
			    {			    
			        document.getElementById('btnDismissAccount').disabled = false; 
			        return;
			    }	
			    else
			    {			        
			        document.getElementById('btnDismissAccount').disabled = true; 
			    }		
			}			
		}
	...
	function ValidateAccountText()
	{
	    if(document.getElementById('txtDismissAccountReason').value=="")
	    {
	        alert("Please give Dismiss Reason!!");
	        return false;
	    }
    ...
    <form id="frmReminder" runat="server">
        <div align="center">
            <table width="100%">
                                ...
                                <tr>
                                    <td align="center">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <asp:TextBox ID="txtDismissReason" runat="server" TextMode="MultiLine" Visible="false"
                                                        Width="510px" Height="100px"></asp:TextBox>
                                ...
                                <tr>
                                    <td class="TDPart">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <asp:TextBox ID="txtDismissCaseReason" runat="server" TextMode="MultiLine" Visible="false"
                                                        Width="510px" Height="100px"></asp:TextBox>
                ...
                <tr>
                    <td>
                        <div id="divAccount_reminder" runat="server">
                            <table width="100%">
                                <tr>
                                    <td class="TDPart">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td align="left">
                                                    <asp:Label ID="lblAccountReminder" runat="server" Text="Account Reminder :" Visible="false"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" valign="top">
                                                    <%--<div style="width: 100%; overflow: scroll">--%>
                                                    <asp:DataGrid ID="grdaccountreminder" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                        CellPadding="4" Font-Names="Verdana" Font-Size="Small" ForeColor="#333333" Width="100%">
                                                        <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                                        <EditItemStyle BackColor="#2461BF" />
                                                        <SelectedItemStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="Dismiss">
                                                                <HeaderTemplate>
                                                                    <asp:CheckBox ID="chkSelectAll1" runat="server" ToolTip="Select All" onclick="javascript:SelectAllAccount(this.checked);chkAccount();" />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:CheckBox ID="chkSelect" runat="server" onclick="chkAccount()" />
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                        </Columns>
                                                        <HeaderStyle BackColor="#B5DF82" Font-Bold="True" ForeColor="White" />
                                                    ...
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                    &nbsp;<asp:Label ID="lblAccountResult" runat="server" Font-Bold="True" ForeColor="Red"
                                                        Text="No Record Exists..!!" Visible="False"></asp:Label>
                                                    <%--    </div>--%>
                                                </td>
                                            </tr>
                                            <tr valign="top">
                                                <td align="left" valign="top">
                                                    <asp:Label ID="lblDisReasonacoount" runat="server" Text="Dismiss Reason:" Visible="false"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top">
                                                    <asp:TextBox ID="txtDismissAccountReason" runat="server" TextMode="MultiLine" Visible="false"
                                                        Width="510px" Height="100px"> </asp:TextBox>
                                                    <asp:Button ID="btnDismissAccount" runat="server" Text="Dismiss" Enabled="false"
                                                        OnClick="btnDismissAccount_Click" Visible="false" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
