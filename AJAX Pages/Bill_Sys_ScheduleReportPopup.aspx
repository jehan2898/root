<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_ScheduleReportPopup.aspx.cs"
    Inherits="AJAX_Pages_Bill_Sys_ScheduleReportPopup" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function showPateintFrame(caseid) {
            ...
            var r1 = document.getElementById('ASPxPageControl1_rblNoshow_0');
            var r2 = document.getElementById('ASPxPageControl1_rblNoshow_1');
            var r3 = document.getElementById('ASPxPageControl1_rblNoshow_2');
            var r4 = document.getElementById('ASPxPageControl1_rblNoshow_3');
            if (r1.checked) {
                value = "0";
            }
            if (r2.checked) {
        ...
        function SetDate() {
            getWeek();
            var selValue = document.getElementById("ddlDateValues").value;
            if (selValue == 0) {
                ...
                document.getElementById("txtToDate").value = getDate('today');
                document.getElementById("txtFromDate").value = getDate('today');
            }
            else if (selValue == 2) {
                document.getElementById("txtToDate").value = getWeek('endweek');
                document.getElementById("txtFromDate").value = getWeek('startweek');
            }
            else if (selValue == 3) {
                document.getElementById("txtToDate").value = getDate('monthend');
                document.getElementById("txtFromDate").value = getDate('monthstart');
            }
            else if (selValue == 4) {
                document.getElementById("txtToDate").value = getDate('quarterend');
                document.getElementById("txtFromDate").value = getDate('quarterstart');
            }
            else if (selValue == 5) {
                document.getElementById("txtToDate").value = getDate('yearend');
                document.getElementById("txtFromDate").value = getDate('yearstart');
            }
            else if (selValue == 6) {
                document.getElementById("txtToDate").value = getLastWeek('endweek');
                document.getElementById("txtFromDate").value = getLastWeek('startweek');
            } else if (selValue == 7) {
                document.getElementById("txtToDate").value = lastmonth('endmonth');

                document.getElementById("txtFromDate").value = lastmonth('startmonth');
            } else if (selValue == 8) {
                document.getElementById("txtToDate").value = lastyear('endyear');

                document.getElementById("txtFromDate").value = lastyear('startyear');
            } else if (selValue == 9) {
                document.getElementById("txtToDate").value = quarteryear('endquaeter');

                document.getElementById("txtFromDate").value = quarteryear('startquaeter');
            }
        }
        function SetNoShowDate() {
            ...
            getWeek();
            var selValue = document.getElementById('ASPxPageControl1_ddlNoShowDate').value;
            if (selValue == 0) {
                ...
                document.getElementById('ASPxPageControl1_txtToDateRange').value = getDate('today');
                document.getElementById('ASPxPageControl1_txtFromDateRange').value = getDate('today');
            }
            else if (selValue == 2) {
                document.getElementById('ASPxPageControl1_txtToDateRange').value = getWeek('endweek');
                document.getElementById('ASPxPageControl1_txtFromDateRange').value = getWeek('startweek');
            }
            else if (selValue == 3) {
                document.getElementById('ASPxPageControl1_txtToDateRange').value = getDate('monthend');
                document.getElementById('ASPxPageControl1_txtFromDateRange').value = getDate('monthstart');
            }
            else if (selValue == 4) {
                document.getElementById('ASPxPageControl1_txtToDateRange').value = getDate('quarterend');
                document.getElementById('ASPxPageControl1_txtFromDateRange').value = getDate('quarterstart');
            }
            else if (selValue == 5) {
                document.getElementById('ASPxPageControl1_txtToDateRange').value = getDate('yearend');
                document.getElementById('ASPxPageControl1_txtFromDateRange').value = getDate('yearstart');
            }
            else if (selValue == 6) {
                document.getElementById('ASPxPageControl1_txtToDateRange').value = getLastWeek('endweek');
                document.getElementById('ASPxPageControl1_txtFromDateRange').value = getLastWeek('startweek');
            } else if (selValue == 7) {
                document.getElementById('ASPxPageControl1_txtToDateRange').value = lastmonth('endmonth');

                document.getElementById('ASPxPageControl1_txtFromDateRange').value = lastmonth('startmonth');
            } else if (selValue == 8) {
                document.getElementById('ASPxPageControl1_txtToDateRange').value = lastyear('endyear');

                document.getElementById('ASPxPageControl1_txtFromDateRange').value = lastyear('startyear');
            } else if (selValue == 9) {
                document.getElementById('ASPxPageControl1_txtToDateRange').value = quarteryear('endquaeter');

                document.getElementById('ASPxPageControl1_txtFromDateRange').value = quarteryear('startquaeter');
            }
        }
        function SetInitialRevalDate() {
            getWeek();
            var selValue = document.getElementById('ASPxPageControl1_ddlInitialRevalDate').value;
            if (selValue == 0) {
                ...
                document.getElementById('ASPxPageControl1_txtupdateToDate').value = getDate('today');
                document.getElementById('ASPxPageControl1_txtupdateFromDate').value = getDate('today');
            }
            else if (selValue == 2) {
                document.getElementById('ASPxPageControl1_txtupdateToDate').value = getWeek('endweek');
                document.getElementById('ASPxPageControl1_txtupdateFromDate').value = getWeek('startweek');
            }
            else if (selValue == 3) {
                document.getElementById('ASPxPageControl1_txtupdateToDate').value = getDate('monthend');
                document.getElementById('ASPxPageControl1_txtupdateFromDate').value = getDate('monthstart');
            }
            else if (selValue == 4) {
                document.getElementById('ASPxPageControl1_txtupdateToDate').value = getDate('quarterend');
                document.getElementById('ASPxPageControl1_txtupdateFromDate').value = getDate('quarterstart');
            }
            else if (selValue == 5) {
                document.getElementById('ASPxPageControl1_txtupdateToDate').value = getDate('yearend');
                document.getElementById('ASPxPageControl1_txtupdateFromDate').value = getDate('yearstart');
            }
            else if (selValue == 6) {
                document.getElementById('ASPxPageControl1_txtupdateToDate').value = getLastWeek('endweek');
                document.getElementById('ASPxPageControl1_txtupdateFromDate').value = getLastWeek('startweek');
            } else if (selValue == 7) {
                document.getElementById('ASPxPageControl1_txtupdateToDate').value = lastmonth('endmonth');

                document.getElementById('ASPxPageControl1_txtupdateFromDate').value = lastmonth('startmonth');
            } else if (selValue == 8) {
                document.getElementById('ASPxPageControl1_txtupdateToDate').value = lastyear('endyear');

                document.getElementById('ASPxPageControl1_txtupdateFromDate').value = lastyear('startyear');
            } else if (selValue == 9) {
                document.getElementById('ASPxPageControl1_txtupdateToDate').value = quarteryear('endquaeter');

                document.getElementById('ASPxPageControl1_txtupdateFromDate').value = quarteryear('startquaeter');
            }
        }
        ...
        function MissingVisitClear() {
            ...
            document.getElementById('ASPxPageControl1_txtdays').value = '';
            document.getElementById('ASPxPageControl1_txtdate').value = '';
            var f = document.getElementById('ASPxPageControl1_grdSpeciality');
            var str = 1;
            for (var i = 0; i < f.getElementsByTagName("input").length; i++) {
                if (f.getElementsByTagName("input").item(i).type == "checkbox") {
        ...
        function ValidateSearch() {
            if (document.getElementById('ASPxPageControl1_txtdays').value == '') {
                alert('Please select days to proceed');
                return false;
            }
            else
            {
                                ...
                                <ContentCollection>
                                    <dx:ContentControl>
                                        <table border="0" width="100%">
                                            <tr>
                                                <td class="td-widget-bc-search-desc-ch1" style="width: 20%;" align="center">Set Date
                                                </td>
                                                ...
                                                <td class="td-widget-bc-search-desc-ch1" style="width: 20%;" align="center">Speciality
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="td-widget-bc-search-desc-ch3" valign="top">
                                                    ...
                                                    <asp:ImageButton ID="imgbtnDateofAccident" runat="server" ImageUrl="~/Images/cal.gif"></asp:ImageButton>
                                                </td>
                                                <td class="td-widget-bc-search-desc-ch3" valign="top">
                        ...
                        <TabPages>
                                ...
                                <ContentCollection>
                                    <dx:ContentControl>
                                        ...
                                        <table style="border: 1px solid #d3d3d3;" width="650px" border="0">
                                            ...
                                            <tr>
                                                <td class="td-widget-bc-search-desc-ch1" align="left" style="width: 130px">
                                                    <b>Days since 1st Visit :</b>
                                                </td>
                                           ...
                                           <tr>
                                                <td class="td-widget-bc-search-desc-ch1" align="left" valign="top" colspan="1">
                                                    <b>After Date:</b> &nbsp&nbsp
                                                    
                                                </td>
                                                <td valign="top">
                                                    <asp:TextBox ID="txtdate" runat="server" Width="80%">          
                                                    </asp:TextBox>
                                            ...
                                            <tr>
                                                <td align="center" height="40" colspan="3">
                                                    ...
                                                    <asp:Button ID="btn_Unseensearch" runat="server" Text="Search" Width="80px" OnClick="btn_search_Click" />
                                                    &nbsp;
                         ...
                         <img alt="" src="Images/Excel.jpg" style="border:none;"  height="15px" width ="15px" title = "Export TO Excel"/></asp:LinkButton>
                                                    ...
                                                    <xgrid:XGridViewControl ID="grdUnseenReport" runat="server" Height="148px" Width="100%" 
                                                        ...
                                                        AutoGenerateColumns="false" ExportToExcelColumnNames="Case #,Patient Name,Date Of Accident,Date of First Treatment,Phone Number,Speciality,Case Type,Carrier,Aging,Insurance"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left"
                                                                HeaderText="Date of First Treatment" DataField="DT_EVENT_DATE" />

                                                            <asp:BoundField HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left"
                                                                HeaderText="Phone Number" DataField="SZ_PATIENT_PHONE" />

                                                            <asp:BoundField HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left"
                                                                HeaderText="Speciality" DataField="sz_procedure_group" SortExpression="sz_procedure_group" />
                                                            ...
                                                            <asp:BoundField HeaderStyle-HorizontalAlign="left" ItemStyle-HorizontalAlign="left"
                                                                HeaderText="Aging" DataField="Count" />
                                                            ...
                                                            <tr>
                                                                <td class="td-widget-bc-search-desc-ch3">
                                                                 ...
                                                                 <td class="td-widget-bc-search-desc-ch3">
                                                                    ...
                                                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" PopupButtonID="imgbtnFromVisitDate"
                                        ...
                                        <table style="width: 100%">
                                            ...
                                            <tr>
                                                <td style="width: 100%">
                                                    ...
                                                    <asp:DataGrid ID="grdNoShow" runat="server" Width="100%" CellPadding="4" BorderColor="#A0A0A0" BackColor="White" BorderStyle="None" BorderWidth="1px">
                                                                                                                ...
                                                                                                                <div style="height: 160px; background-color: Gray; overflow: scroll;">
                                                                                                                    <dx:ASPxGridView ID="grdInitialRevalSpeciality" runat="server" Width="100%" SettingsBehavior-AllowSort="false"
                                                                                                                        ...
                                                                                                                        <Columns>
                                                                                                                            <dx:GridViewDataColumn Caption="chk1" VisibleIndex="0" Width="30px">
                                                                                                                                <HeaderTemplate>
                                                                                                                                    <asp:CheckBox ID="CheckBox1" runat="server" onclick="javascript:SelectAllSpeciality(this.checked);"
                                                                                                                                        ToolTip="Select All" />
                                                                                                                                </HeaderTemplate>
                                                                                                                                <DataItemTemplate>
                                                                                                                                    <asp:CheckBox ID="CheckBox2" Visible="true" runat="server" />
                                                                                                                                </DataItemTemplate>
                                                                                                                            </dx:GridViewDataColumn>
                                                   ...
                                                   <%-- <div style="width: 100%">
                                                        <table style="height: 9px; background-color: #d3d3d3" width="99%">
                                                            <tr>
                                                                ...
                                                                <td style="width: 9px; font-size: 13px" align="center"><b>Case Type</b></td>
                                                    ...
                                                    <div style="height: 450px; overflow: scroll; visibility: hidden">
                                                        <asp:DataGrid Width="100%" ID="grdExPort" CssClass="mGrid" runat="server" AutoGenerateColumns="False">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundColumn DataField="SPECIALTY" HeaderText="Speciality" ItemStyle-HorizontalAlign="Center"
                                                                    HeaderStyle-HorizontalAlign="Center">
                                                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
