<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_Lien_Patient_Sign.aspx.cs" Inherits="AJAX_Pages_Bill_Sys_Lien_Patient_Sign" %>
...
<!--
        ...
        function OnSave() {
            ...
            if (document.FORM2.SigPlusPatient.NumberOfTabletPoints > 0) {
                ...
                parent.document.getElementById('divPatientSignatureLien').style.visibility = 'hidden';
                parent.document.getElementById('divPatientSignatureLien').style.zIndex = -1;
            }
            else {
...
<body>
    <form id="FORM2" method="post" name="FORM2" action="Bill_Sys_Save_Lien_Sign.aspx?Sign=Patient">
        <h2>
            <center>
