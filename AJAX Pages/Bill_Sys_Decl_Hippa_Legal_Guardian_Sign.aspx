<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_Decl_Hippa_Legal_Guardian_Sign.aspx.cs"
    Inherits="AJAX_Pages_Bill_Sys_Decl_Hippa_Legal_Guardian_Sign" %>
...
function OnSave() {
    ...
    {     
       ...
       document.FORM2.hiddenLegalPatient.value = document.FORM2.SigPlusPatient.SigString;           
       document.FORM2.submit();
       parent.document.getElementById('divLegalGuardianDCHQ').style.visibility='hidden';
       parent.document.getElementById('divLegalGuardianDCHQ').style.zIndex = -1;  
   }
   else
   {
...
<body>
    <form id="FORM2" method="post" name="FORM2" action="Bill_Sys_Save_Dec_Hippa_Patient_Guarantor_Sign.aspx?Sign=LegalGuardian">
        <h2>
            <center>
        ...
        <table align="center" width="70%">
            <tr>
                ...
                <td style="width: 82px">
                    <input id="hiddenLegalPatient" type="hidden" name="hiddenLegalPatient" style="width: 132px">
                </td>
            </tr>
            <tr align="left">
                <td>
