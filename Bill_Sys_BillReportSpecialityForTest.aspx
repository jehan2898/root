<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_BillReportSpecialityForTest.aspx.cs" Inherits="Bill_Sys_BillReportSpecialityForTest" Title="Green Your Bills - Bill Report" %>
                                        ...
                                        <table border="0" cellpadding="3" cellspacing="0" class="ContentTable" style="width: 100%">
                                            <tr>
                                                <td class="ContentLabel" colspan="1" style="height: 25px; text-align: left">
                                                    <strong>Bill Report By Specialty</strong></td>
                                            ...
                                            <tr>
                                            <td colspan="1"></td>
                                                 <td colspan="2" class="ContentLabel" style="width: 15%; height: 18px;" visible="false">
                                            ...
                                            <tr>
                                                <td class="ContentLabel" colspan="2" valign="top">
                                                    User
                                                </td>
                                                <td style="width: 24%">
                                    ...
                                    <td style="width: 100%" class="TDPart">
                                        ...
                                        <asp:DataGrid ID="grdAllReports" runat="server" Width="100%" CssClass="GridTable"
                                            ...
                                            <HeaderStyle CssClass="GridHeader" />
                                                    ...
                                                    <ajaxcontrol:CalendarExtender ID="calExtFromServiceDate" runat="server" TargetControlID="txtFromServiceDate"
                                                        PopupButtonID="ImageButton1" />
                                                    <ajaxcontrol:CalendarExtender ID="calExtToDate" runat="server" TargetControlID="txtToDate"
                                                        PopupButtonID="imgbtnToDate" />
                                                    <ajaxcontrol:CalendarExtender ID="calExtToServiceDate" runat="server" TargetControlID="txtToServiceDate"
