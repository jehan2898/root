...
public partial class TreatingDoctor_Bill : PageBase
{
    ...
    protected void ASPxCallback1_Callback(object sender, CallbackEventArgs e)
    {
        ...
        string sFile = TreatingDoctor.utils.TreatingDoctorUtils.GetExportPhysicalPath(sUserName, TreatingDoctor.utils.ReferringProviderExportTypes.BILL_LIST, out sFileName);
    ...
    public void BindGrid()
    {
        ...
        TreatingDoctor.TreatingDoctor objDocBO = new TreatingDoctor.TreatingDoctor();
        TreatingDoctorBillDAO objBillDao = new TreatingDoctorBillDAO();
