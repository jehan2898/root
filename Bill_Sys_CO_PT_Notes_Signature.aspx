<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_CO_PT_Notes_Signature.aspx.cs" Inherits="Bill_Sys_Doctor_Signature" %>
...
<body>
    <FORM id="FORM1" method="post" name="FORM1" action="Bill_Sys_CO_PT_Notes_Doctor.aspx">
