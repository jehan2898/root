...
public partial class Bill_Sys_LineViewDayCalanderForCompany : PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                Session["CALENDER_STATE"] = "FOR_COMPANYDAY";
                GenerateDayDetail(Convert.ToDateTime(Session["CURRENT_DATE"].ToString()));
            }
            else
            {
                Session["CALENDER_STATE"] = "FOR_COMPANYDAY";
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("Bill_Sys_LineViewDayCalanderForCompany.aspx");
        }
        #endregion
    }
    ...
    private void GenerateDayDetail(DateTime _date)
    {
        ...
        try
        {
            szBillCompanyID = ((Bill_Sys_BillingCompanyObject)Session["BILLING_COMPANY_OBJECT"]).SZ_COMPANY_ID;
            ...
            for (int i = 0; i <= 23; i++)
            {
                ...
                arrayReturn = bill_Sys_Calender.getDayDetails(Convert.ToDateTime(lblDate.Text), i,"", szBillCompanyID, "FOR_COMPANY");
                string str = "<table >";
    ...
    private void GenerateMonthDetail(DateTime _date)
    {
        ...
        try
        {
            ...
            {
                arrayReturn = new ArrayList();
                arrayReturn = bill_Sys_Calender.getMonthDetails(Convert.ToDateTime(lblDate.Text), i,"", szBillCompanyID, "FOR_COMPANY");
                string str = "<table>";
                string firstRowStr = "<tr>";
                string secondRowStr = "<tr>";
                string thirdRowStr = "<tr>";
    ...
    protected void btnMonthView_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Session["CALENDER_STATE"] = "FOR_COMPANYMONTH";
    ...
    protected void btnPrev_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else if (Session["CALENDER_STATE"].ToString() == "FOR_COMPANYMONTH")
            {
    ...
    public void ShowAll(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Session["CALENDER_STATE"] == "FOR_COMPANYDAY")
            {
                string str = lnkTest.CommandArgument.ToString();
              //  Label lblTestFindControl(str)
            ...
            Session["CASE_ID"] = "";
            Response.Redirect("Bill_Sys_ForCompanyDisplayEvents.aspx", false);
        }
        catch (Exception ex)
        {
