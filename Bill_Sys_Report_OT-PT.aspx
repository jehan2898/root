<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_Report_OT-PT.aspx.cs"
    Inherits="Bill_Sys_ReportAndHistory_OT_PT" %>
                                                            ...
                                                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
                                                                ...
                                                                <tr>
                                                                    <td colspan="4" class="lbl">
                                                                        &nbsp;&nbsp;
                                                                        <asp:CheckBox ID="chkOCCUPATIONAL" runat="server" Text="OCCUPATIONAL THERAPIST'S REPORT" />&nbsp;&nbsp;&nbsp;
                                                                        <asp:CheckBox ID="chkPHYSICAL" runat="server" Text="PHYSICAL THERAPIST'S REPORT" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="4" class="lbl">
                                                                        &nbsp;&nbsp;
                                                                        <asp:CheckBox ID="chk48Hour" runat="server" Text="48 Hour Initial" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="4" class="lbl">
                                                                        &nbsp;&nbsp;
                                                                        <asp:CheckBox ID="chk15Day" runat="server" Text="15 Day Initial" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="4" class="lbl">
                                                                        &nbsp;&nbsp;
                                                                        <asp:CheckBox ID="chk90Day" runat="server" Text="90 Day Progress" />
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="width: 1%">
                                                                    ...
                                                                    <td style="height: 24px">
                                                                        <div class="lbl">
                                                                            SERVICES PROVIDED UNDER WCB PREFERRED PROVIDER ORGANIZATION (PPO) PROGRAM?</div>
                                                                    </td>
                                                                    <td style="height: 24px">
                                                                    </td>
                                                                    <td style="height: 24px">
                                                                        <div class="lbl">
                                                                            <asp:RadioButtonList ID="rdlstPPO" runat="server" RepeatDirection="Horizontal">
