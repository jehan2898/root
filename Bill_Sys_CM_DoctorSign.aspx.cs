...
public partial class Bill_Sys_CM_DoctorSign : PageBase
{
     ...
     protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (app_status.Equals("True"))
        {
            ...
            cv.MakeReadOnlyPage("Bill_Sys_CM_DoctorSign.aspx");
        }
        #endregion
    }
    ...
    protected void btnSumbit_Click(object sender, EventArgs e)
    {
        ...
        string sz_EventID = Session["CM_HI_EventID"].ToString();
        ...
        try
        {
            ...
            _objcheckOut.SaveCMINITIALEVALSignPath(sz_EventID, DoctorImagePath, CaseBarcodePath);
