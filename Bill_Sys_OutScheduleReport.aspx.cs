    ...
    private void BindGrid()
    {
        ...
        try
        {
            ...
            if (((Bill_Sys_BillingCompanyObject)Session["BILLING_COMPANY_OBJECT"]).BT_REFERRING_FACILITY == true)
            {
                ...
                ds= _objSR.getCalenderOutScheduleReport(txtStartDate.Text, txtEndDate.Text, txtCompanyID.Text, "", extddlDoctor.Text, ddlStatus.SelectedValue, extddlOffice.Text, txtSort.Text,txtPatientName.Text,txtCaseNo.Text,txtChartNO.Text);
            ...
            else
            {
                ...
                {
                    ds= _objSR.getCalenderOutScheduleReport(txtStartDate.Text, txtEndDate.Text, txtCompanyID.Text, extddlReferringFacility.Text, extddlDoctor.Text, ddlStatus.SelectedValue, extddlOffice.Text, txtSort.Text,txtPatientName.Text,txtCaseNo.Text,txtChartNO.Text);
