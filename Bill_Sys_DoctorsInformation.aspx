<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_DoctorsInformation.aspx.cs"
    Inherits="Bill_Sys_DoctorsInformation" %>
                                                                            ...
                                                                            <table>
                                                                                <tr>
                                                                                    <td colspan="4" width="100%" align="center">
                                                                                     ...
                                                                                     <asp:TextBox ID="txtTaxType" runat="server" Visible="False" Width="10px"></asp:TextBox></td>
                                                                    <asp:TextBox ID ="txtDoctorType" runat ="server" Visible="false" Width="10px"></asp:TextBox>
                                                                                </tr>
                                                                            </table>
                                                                        </div>
                                                                    </td>
