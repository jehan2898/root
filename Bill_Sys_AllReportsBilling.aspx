<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"
    CodeFile="Bill_Sys_AllReports.aspx.cs" Inherits="Bill_Sys_AllReports" %>
                                                ...
                                                <tr>
                                                    <td class="ContentLabel" colspan="4">
                                                        ...
                                                        <asp:Button ID="btnSearch" runat="server" Text="Search" Width="80px" CssClass="Buttons"
                                                            OnClick="btnSearch_Click" />&nbsp;<asp:Button ID="btnExportToExcel" runat="server" CssClass="Buttons" OnClick="btnExportToExcel_Click"
                                        ...
                                        <td style="width: 100%" class="TDPart">
                                            <asp:DataGrid ID="grdAllReports" runat="server" Width="100%" CssClass="GridTable"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="PROCEDURE_DATE" HeaderText="Procedure Date" DataFormatString="{0:MM/dd/yyyy}">
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="PROCEDURE" HeaderText="Procedure"></asp:BoundColumn>
                                                    <asp:BoundColumn DataField="SZ_TYPE" HeaderText="Procedure Type"></asp:BoundColumn>
                                                </Columns>
