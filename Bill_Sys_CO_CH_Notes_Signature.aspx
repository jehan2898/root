<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_CO_CH_Notes_Signature.aspx.cs" Inherits="Bill_Sys_Doctor_Signature_CH" %>
...
<body>
    <FORM id="FORM1" method="post" name="FORM1" action="Bill_Sys_CO_CH_Notes_Doctor.aspx?Sign=Doctor">
