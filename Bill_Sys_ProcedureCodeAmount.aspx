<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bill_Sys_ProcedureCodeAmount.aspx.cs"
    Inherits="Bill_Sys_ProcedureCodeAmount" %>
...
<body>
    <form id="frmProcedureCodeAmount" runat="server">
        <div align="center">
            <table class="maintable" cellpadding="0px" cellspacing="0px">
                ...
                <tr>
                    <td colspan="6" class="usercontrol">
                        <CPA:CheckPageAutharization ID="TestPages1" runat="server"></CPA:CheckPageAutharization>
                    </td>
                </tr>
                <tr>
                    <td colspan="6">
                ...
                <tr>
                    <td class="tablecellLabel">
                        <div class="lbl">Type</div></td>
                    <td class="tablecellSpace">
                    </td>
                    <td class="tablecellControl">
                        <asp:TextBox ID="txtProcedureCodeAmountType" runat="server" Width="250px" MaxLength="50"></asp:TextBox></td>
                    <td class="tablecellLabel">
                        <div class="lbl">Amount</div> </td>
                    <td class="tablecellSpace">
                    </td>
                    <td class="tablecellControl">
                        <asp:TextBox ID="txtProcedureCodeAmount" runat="server" Width="250px" MaxLength="20"></asp:TextBox></td>
                </tr>
             ...
             <!-- End : Data Entry -->
                ...
                <tr>
                    <td colspan="6">
                        <asp:DataGrid ID="grdProcedureCodeAmount" runat="server" OnPageIndexChanged="grdProcedureCodeAmount_PageIndexChanged"
                            OnSelectedIndexChanged="grdProcedureCodeAmount_SelectedIndexChanged">
                            <FooterStyle />
                            <SelectedItemStyle />
                            <PagerStyle />
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="SZ_PROCEDURE_CODE_AMOUNT_ID" HeaderText="PROCEDURE CODE AMOUNT ID" Visible="False">
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="SZ_PROCEDURE_CODE_AMOUNT_TYPE" HeaderText="Type"></asp:BoundColumn>
                                <asp:BoundColumn DataField="SZ_PROCEDURE_CODE_AMOUNT" HeaderText="Amount" DataFormatString="{0:0.00}"></asp:BoundColumn>
                               <%-- <asp:BoundColumn DataField="SZ_CODE_AMOUNT" HeaderText="Amount" DataFormatString="{0:0.00}">
                                </asp:BoundColumn>--%>
