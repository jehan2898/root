<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Bill_Sys_Mandatory_Settings.aspx.cs" Inherits="Bill_Sys_Mandatory_Settings" Title="Untitled Page" %>
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 43%; height: 22px;">
                                                    <%--<extddl:ExtendedDropDownList ID="extCIddlRoleName" runat="server" Connection_Key="Connection_String"
                                                        ...
                                                        <asp:DropDownList ID="extCIddlRoleName" runat="server" Width="100%"  AutoPostBack="True" Visible="False"></asp:DropDownList>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 43%; height: 19px;">
                                                    <%--<extddl:ExtendedDropDownList ID="extCIddlMainMenu" runat="server" Connection_Key="Connection_String"
                                                        ...
                                                        <asp:DropDownList ID="extCIddlMainMenu" runat="server" Width="100%"  AutoPostBack="True" Visible="False"></asp:DropDownList>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 43%;font-size: 12px;font-family: arial;" align="left">
                                                    <b>Select Field from</b></td>
                                                <td class="ContentLabel" style="width: 5%">
                                                </td>
                                                <td colspan="2" align="left" style="font-size: 12px;font-family: arial;">
                                                    <b>Selected Field</b></td>
                                            </tr>
                                            <tr>
                                                <td class="ContentLabel" style="width: 10%">
                                                </td>
                                                <td style="width: 43%">
                                                    <asp:ListBox ID="lstField" runat="server" Width="100%" SelectionMode="Multiple" Height="355px" ></asp:ListBox> </td>
                                                <td class="ContentLabel" style="width: 5%; text-align:center;">
                                               <%-- <input type="button" onclick="move(this.form._ctl0_ContentPlaceHolder1_lstField,this.form._ctl0_ContentPlaceHolder1_lstMadatoryField)" value=">>" style="font-size: 12px;color: #000099;font-family: arial;background-color: #8babe4;border: 1px solid #000099;	padding-top:1px;padding-bottom:1px;padding-left:5px;padding-right:5px;"/>--%>
                                               <asp:Button ID="Button1" Text=">>" runat="server" CssClass="Buttons" OnClick="Button1_Click" Width="32px"/>
                                                   <asp:Button ID="btnMoveLeft" runat="server"  Text=">>" visible="False" Width="29px"/>
                                                <asp:Button ID="btnMoveRight" runat="server" Text="<<" visible="false"/>&nbsp;
                                                ...
                                                <td colspan="2">
                                                    <asp:ListBox ID="lstMadatoryField" runat="server" Width="100%" SelectionMode="Multiple" Height="354px">
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                 <td class="ContentLabel" colspan="5">
                                                     ...
                                                     <asp:Button ID="saveSelectedDoc" Text="Save Mandatory Field" runat="server" CssClass="Buttons" OnClick="saveSelectedDoc_Click"
                                                     ></asp:Button>
                                                          <asp:Button ID="btnRemove" Text="Remove" runat="server" CssClass="Buttons" OnClick="btnRemove_Click"></asp:Button>
                                                        <%-- <input type="button" onclick="Remove(this.form._ctl0_ContentPlaceHolder1_lstMadatoryField);" value="Remove" style="font-size: 12px;color: #000099;font-family: arial;background-color: #8babe4;border: 1px solid #000099;	padding-top:1px;padding-bottom:1px;padding-left:5px;padding-right:5px;"/>--%>
