<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Bill_Sys_DetailBillReportProvider.aspx.cs" Inherits="Bill_Sys_DetailBillReportProvider"
    Title="Untitled Page" %>
                                    ...
                                    <td style="width: 100%;" class="TDPart" valign="top">
                                        ...
                                        <asp:DataGrid ID="grdPayment" runat="Server" AutoGenerateColumns="False" CssClass="GridTable"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundColumn DataField="SZ_CASE_TYPE" HeaderText="Case Type" Visible="false">
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="TOTAL_BILL_AMOUNT" HeaderText="Billed" ItemStyle-HorizontalAlign="Right">
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="TOTAL_PAID_AMOUNT" HeaderText="Received" ItemStyle-HorizontalAlign="Right">
                                                </asp:BoundColumn>
                                                <asp:BoundColumn DataField="TOTAL_OUTSTANDING_AMOUNT" HeaderText="Outstanding" ItemStyle-HorizontalAlign="Right">
                                                </asp:BoundColumn>
